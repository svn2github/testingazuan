		...
		switch (paramType) {
			...
			case IScalarParameterDefn.TYPE_DATE :
				try {
					...
					logger.error(ParameterConverter.class.getName()+ "findReportParams() " +
			...
			case IScalarParameterDefn.TYPE_INTEGER :
				try {
					...
					logger.error(ParameterConverter.class.getName()+ "findReportParams() " +
							"Error parsing the string [" + paramValueString + "] as an integer.", e);
				}
				break;
			...
			case IScalarParameterDefn.TYPE_DECIMAL :
				try {
					...
					logger.error(ParameterConverter.class.getName()+ "findReportParams() " +
							"Error parsing the string [" + paramValueString + "] as a double.", e);
				}
				break;
			...
			case IScalarParameterDefn.TYPE_FLOAT :
				try {
					...
					logger.debug(ParameterConverter.class.getName()+ "findReportParams() " +
							"Error parsing the string [" + paramValueString + "] as a double.", e);
				}
				break;
