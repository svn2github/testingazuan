...
Sbi.formbuilder.GroupingVariablesEditorPanel = function(config) {
	...
	if (Sbi.settings && Sbi.settings.formbuilder && Sbi.settings.formbuilder.groupingVariablesEditorPanel) {
		defaultSettings = Ext.apply(defaultSettings, Sbi.settings.formbuilder.groupingVariablesEditorPanel);
	}
	...
	// constructor
    Sbi.formbuilder.GroupingVariablesEditorPanel.superclass.constructor.call(this, c);
};

Ext.extend(Sbi.formbuilder.GroupingVariablesEditorPanel, Sbi.formbuilder.EditorPanel, {
