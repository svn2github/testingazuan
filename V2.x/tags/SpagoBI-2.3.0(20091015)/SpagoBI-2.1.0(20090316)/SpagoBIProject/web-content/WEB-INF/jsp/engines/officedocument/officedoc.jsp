...
officeDocUrl += "?ACTION_NAME=GET_OFFICE_DOC&NEW_SESSION=TRUE&user_id=" + userUniqueIdentifier + "&documentId=" + biObj.getId().toString() + "&" + LightNavigationManager.LIGHT_NAVIGATOR_DISABLED + "=TRUE";
