qx.Class.define("qooxdoo.ui.custom.FunctionalTree",{

  extend : qooxdoo.ui.Tree,
  
  construct : function()  {//type
 
	  		//this.base(arguments,{root: "Functionalities"}); 
	  		this.tree = qooxdoo.app.data.DataService.loadTreeNodes();
  ...
  members : {
     ...
     /**
	               ...
	               * <p><p>
	               * *Example :- *
	               * <p> var myTree = new qooxdoo.ui.Tree({root: "Root"});
	 ...
	 */
          _createMenu : function(e){
          				...
          				//alert(qooxdoo.commons.CoreUtils.toStr(e._native));
        				...
        				moveDownCmd.addListener("execute", this.moveDownNode,this);
	             		...
	             		var insertButton = new qx.ui.menu.Button("Insert",null,insertCmd); 
	               		...
	               		//alert(qooxdoo.commons.CoreUtils.toStr(ele));//_createDomElement
	               		//alert(ele._element.offsetLeft);
	               		
	               		
	               		
	               		 
	               		//alert(ele._element.left);//qooxdoo.commons.CoreUtils.toStr(ele)
	               		...
	               		//alert(qooxdoo.commons.CoreUtils.toStr(nodeLayputProp));
