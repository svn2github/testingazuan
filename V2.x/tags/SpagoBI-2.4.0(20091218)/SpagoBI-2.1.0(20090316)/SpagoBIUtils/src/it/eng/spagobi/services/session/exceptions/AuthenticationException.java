...
package it.eng.spagobi.services.session.exceptions;
...
public class AuthenticationException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://exceptions.session.services.spagobi.eng.it", "AuthenticationException"));
    }
