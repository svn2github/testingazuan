 ...
 */
public class DownloadLogsAction extends AbstractConsoleEngineAction {
	
	public static final String SERVICE_NAME = "DOWNLOAD_LOGS";
	...
	// logger component
	private static Logger logger = Logger.getLogger(DownloadLogsAction.class);
