...
ALTER TABLE SBI_DOSSIER_BINARY_CONTENTS_TEMP ADD CONSTRAINT FK_SBI_DOSSIER_BINARY_CONTENTS_TEMP_1 FOREIGN KEY FK_SBI_DOSSIER_BINARY_CONTENTS_TEMP_1 ( PART_ID ) REFERENCES SBI_DOSSIER_PARTS_TEMP(PART_ID);
...
ALTER TABLE SBI_DISTRIBUTION_LISTS_OBJECTS ADD CONSTRAINT FK_SBI_DISTRIBUTION_LISTS_OBJECTS_1 FOREIGN KEY FK_SBI_DISTRIBUTION_LISTS_OBJECTS_1 ( DOC_ID ) REFERENCES SBI_OBJECTS(BIOBJ_ID);
ALTER TABLE SBI_DISTRIBUTION_LISTS_OBJECTS ADD CONSTRAINT FK_SBI_DISTRIBUTION_LISTS_OBJECTS_2 FOREIGN KEY FK_SBI_DISTRIBUTION_LISTS_OBJECTS_2 ( DL_ID ) REFERENCES SBI_DISTRIBUTION_LIST(DL_ID)ON DELETE CASCADE;ALTER TABLE SBI_DOSSIER_BINARY_CONTENTS_TEMP ADD CONSTRAINT FK_SBI_DOSSIER_BINARY_CONTENTS_TEMP_1 FOREIGN KEY FK_SBI_DOSSIER_BINARY_CONTENTS_TEMP_1 ( PART_ID ) REFERENCES SBI_DOSSIER_PARTS_TEMP(PART_ID) ON DELETE CASCADE;