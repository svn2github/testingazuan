...
CREATE UNIQUE INDEX XAK1SBI_SBI_DISTRIBUTION_LIST ON SBI_DISTRIBUTION_LIST
(
       DL_ID						ASC
);

CREATE UNIQUE INDEX XAK1SBI_SBI_DISTRIBUTION_LIST_USER ON SBI_DISTRIBUTION_LIST_USER
(
       DLU_ID						ASC
);

CREATE UNIQUE INDEX XAK1SBI_SBI_DISTRIBUTION_LISTS_OBJECTS ON SBI_DISTRIBUTION_LISTS_OBJECTS
(
       REL_ID						ASC
);
...
ALTER TABLE SBI_ROLE_TYPE_USER_FUNCTIONALITY ADD CONSTRAINT FK_SBI_ROLE_TYPE_USER_FUNCTIONALITY_1 FOREIGN KEY FK_SBI_ROLE_TYPE_USER_FUNCTIONALITY_1 ( ROLE_TYPE_ID ) REFERENCES SBI_DOMAINS(VALUE_ID);
ALTER TABLE SBI_ROLE_TYPE_USER_FUNCTIONALITY ADD CONSTRAINT FK_SBI_ROLE_TYPE_USER_FUNCTIONALITY_2 FOREIGN KEY FK_SBI_ROLE_TYPE_USER_FUNCTIONALITY_2 ( USER_FUNCT_ID ) REFERENCES SBI_USER_FUNCTIONALITY(USER_FUNCT_ID);
...
ALTER TABLE SBI_DOSSIER_PRESENTATIONS ADD CONSTRAINT FK_SBI_DOSSIER_PRESENTATIONS_1 FOREIGN KEY FK_SBI_DOSSIER_PRESENTATIONS_1 ( BIN_ID ) REFERENCES SBI_BINARY_CONTENTS(BIN_ID);
ALTER TABLE SBI_DOSSIER_PRESENTATIONS ADD CONSTRAINT FK_SBI_DOSSIER_PRESENTATIONS_2 FOREIGN KEY FK_SBI_DOSSIER_PRESENTATIONS_2 ( BIOBJ_ID ) REFERENCES SBI_OBJECTS(BIOBJ_ID);

ALTER TABLE SBI_DOSSIER_PARTS_TEMP ADD CONSTRAINT FK_SBI_DOSSIER_PARTS_TEMP_1 FOREIGN KEY FK_SBI_DOSSIER_PARTS_TEMP_1 ( BIOBJ_ID ) REFERENCES SBI_OBJECTS(BIOBJ_ID);

ALTER TABLE SBI_DOSSIER_BINARY_CONTENTS_TEMP ADD CONSTRAINT FK_SBI_DOSSIER_BINARY_CONTENTS_TEMP_1 FOREIGN KEY FK_SBI_DOSSIER_BINARY_CONTENTS_TEMP_1 ( PART_ID ) REFERENCES SBI_DOSSIER_PARTS_TEMP(PART_ID) ON DELETE CASCADE;

ALTER TABLE SBI_DISTRIBUTION_LIST_USER ADD CONSTRAINT FK_SBI_DISTRIBUTION_LIST_USER_1 FOREIGN KEY FK_SBI_DISTRIBUTION_LIST_USER_1 ( LIST_ID ) REFERENCES SBI_DISTRIBUTION_LIST(DL_ID)ON DELETE CASCADE;
ALTER TABLE SBI_DISTRIBUTION_LISTS_OBJECTS ADD CONSTRAINT FK_SBI_DISTRIBUTION_LISTS_OBJECTS_1 FOREIGN KEY FK_SBI_DISTRIBUTION_LISTS_OBJECTS_1 ( DOC_ID ) REFERENCES SBI_OBJECTS(BIOBJ_ID)ON DELETE CASCADE;
ALTER TABLE SBI_DISTRIBUTION_LISTS_OBJECTS ADD CONSTRAINT FK_SBI_DISTRIBUTION_LISTS_OBJECTS_2 FOREIGN KEY FK_SBI_DISTRIBUTION_LISTS_OBJECTS_2 ( DL_ID ) REFERENCES SBI_DISTRIBUTION_LIST(DL_ID)ON DELETE CASCADE;
...
ALTER TABLE SBI_MENU_ROLE ADD CONSTRAINT FK_SBI_MENU_ROLE1 FOREIGN KEY FK_SBI_MENU_ROLE1 (MENU_ID) REFERENCES SBI_MENU (MENU_ID); 
ALTER TABLE SBI_MENU_ROLE ADD CONSTRAINT FK_SBI_MENU_ROLE2 FOREIGN KEY FK_SBI_MENU_ROLE2 (EXT_ROLE_ID) REFERENCES SBI_EXT_ROLES (EXT_ROLE_ID);