...
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) VALUES ('DocumentDevelopment','DocumentDevelopment');
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) VALUES ('DocumentTest','DocumentTest');
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) VALUES ('DocumentExecution','DocumentExecution');
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) VALUES ('ImportExport','ImportExport');
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) VALUES ('Scheduler','Scheduler');
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) VALUES ('Events','Events');
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) VALUES ('WorkspaceExec','WorkspaceExec');
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) VALUES ('Worklist','Worklist');
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) VALUES ('MapCatalogue','MapCatalogue');
...
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY VALUES((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN'),(SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='DocumentDevelopment' ));
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY VALUES((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN'),(SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='DocumentTest' ));
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY VALUES((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN'),(SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='DocumentExecution' ));
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY VALUES((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN'),(SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='ImportExport' ));
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY VALUES((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN'),(SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='Scheduler' ));
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY VALUES((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN'),(SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='Events' ));
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY VALUES((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN'),(SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='WorkspaceExec' ));
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY VALUES((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN'),(SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='Worklist' ));
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY VALUES((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN'),(SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='MapCatalogue' ));
