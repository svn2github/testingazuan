...
ALTER TABLE SBI_ALARM ADD UNIQUE INDEX label_unique(LABEL);

ALTER TABLE SBI_ALARM_CONTACT ADD UNIQUE INDEX name_unique(NAME);

ALTER TABLE SBI_KPI ADD UNIQUE INDEX code_unique(code);

ALTER TABLE SBI_KPI_MODEL ADD UNIQUE INDEX unique_kpi_model_cd(KPI_MODEL_CD);

ALTER TABLE SBI_KPI_PERIODICITY ADD UNIQUE INDEX name_unique(name);

ALTER TABLE SBI_THRESHOLD MODIFY COLUMN code VARCHAR(45) NOT NULL;
ALTER TABLE SBI_THRESHOLD ADD UNIQUE INDEX code_unique(code);

ALTER TABLE SBI_THRESHOLD_VALUE MODIFY COLUMN label VARCHAR(20) NOT NULL;
ALTER TABLE SBI_THRESHOLD_VALUE ADD UNIQUE INDEX label_thId_unique(label, THRESHOLD_ID);

ALTER TABLE SBI_RESOURCES ADD UNIQUE INDEX unique_resource_name(RESOURCE_NAME);
