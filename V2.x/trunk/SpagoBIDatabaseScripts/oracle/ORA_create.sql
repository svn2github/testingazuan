...
/
-- UNIQUE INDEX FOR OBJECT METADATA
CREATE UNIQUE INDEX XAK1SBI_OBJ_METACONTENTS ON SBI_OBJ_METACONTENTS(OBJMETA_ID,  BIOBJ_ID)
/
CREATE UNIQUE INDEX XAK2SBI_OBJ_METACONTENTS ON SBI_OBJ_METACONTENTS(OBJMETA_ID,BIOBJ_ID,SUBOBJ_ID)
/
...
/
CREATE UNIQUE INDEX resource_name_unique ON SBI_RESOURCES (RESOURCE_NAME)
/
