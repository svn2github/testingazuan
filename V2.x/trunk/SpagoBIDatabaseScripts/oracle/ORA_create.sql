...
CREATE UNIQUE INDEX anarm_name_unique
  ON SBI_ALARM_CONTACT (NAME)

CREATE UNIQUE INDEX kpi_code_unique
  ON SBI_KPI (code)

CREATE UNIQUE INDEX model_cd_unique
  ON SBI_KPI_MODEL (KPI_MODEL_CD)

CREATE UNIQUE INDEX period_name_unique
  ON SBI_KPI_PERIODICITY (name)

CREATE UNIQUE INDEX threshold_code_unique
