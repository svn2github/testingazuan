...
Create table SBI_KPI_INSTANCE (
	ID_KPI_INSTANCE Number(38,0) Constraint "SYS_C0021728" NOT NULL ,
...
Alter table SBI_THRESHOLD_VALUE add Foreign Key (THRESHOLD_ID) references SBI_THRESHOLD (THRESHOLD_ID) ;
...
Alter table SBI_KPI_MODEL_INST add Foreign Key (KPI_MODEL_INST_PARENT) references SBI_KPI_MODEL_INST (KPI_MODEL_INST) ON DELETE CASCADE;
Alter table SBI_KPI_INSTANCE add Foreign Key (CHART_TYPE_ID) references SBI_DOMAINS (value_id) ON DELETE CASCADE;
...
/
CREATE SEQUENCE "SPAGOBI"."SBI_KPI_SEQ" INCREMENT BY 1 START WITH 1 MAXVALUE 999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER
/
CREATE SEQUENCE "SPAGOBI"."SBI_KPI_INST_PERIOD_SEQ" INCREMENT BY 1 START WITH 1 MAXVALUE 999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER
/
CREATE SEQUENCE "SPAGOBI"."SBI_KPI_MODEL_ATTR_VAL_SEQ" INCREMENT BY 1 START WITH 1 MAXVALUE 999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER
/
CREATE SEQUENCE "SPAGOBI"."SBI_KPI_MODEL_RESOURCES_SEQ" INCREMENT BY 1 START WITH 1 MAXVALUE 999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER
/
CREATE SEQUENCE "SPAGOBI"."RESOURCES_SEQ" INCREMENT BY 1 START WITH 1 MAXVALUE 999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER
/
CREATE SEQUENCE "SPAGOBI"."SBI_THRESHOLD_SEQ" INCREMENT BY 1 START WITH 1 MAXVALUE 999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER
/
CREATE SEQUENCE "SPAGOBI"."SBI_THRESHOLD_VAULE_SEQ" INCREMENT BY 1 START WITH 1 MAXVALUE 999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER
/
