...
CREATE SEQUENCE SBI_USER_FUNCTIONALITY_SEQ
INCREMENT BY 1 
START WITH 1 
NOMAXVALUE 
NOMINVALUE 
...
CREATE SEQUENCE SBI_DOSSIER_PRESENTATIONS_SEQ
INCREMENT BY 1 
START WITH 1 
NOMAXVALUE 
NOMINVALUE 
...
CREATE SEQUENCE SBI_DOSSIER_PARTS_TEMP_SEQ
INCREMENT BY 1 
START WITH 1 
NOMAXVALUE 
NOMINVALUE 
...
CREATE SEQUENCE SBI_DOSSIER_BINARY_CONTENTS_TEMP_SEQ
INCREMENT BY 1 
START WITH 1 
NOMAXVALUE 
NOMINVALUE 
...
CREATE TABLE SBI_EXT_ROLES (
       ...
       ISABLETO_SEE_SUBOBJECTS				BOOLEAN DEFAULT TRUE,
       ISABLETO_SEE_VIEWPOINTS				BOOLEAN DEFAULT TRUE,
       ISABLETO_SEE_SNAPSHOTS				BOOLEAN DEFAULT TRUE,
       ISABLETO_SEE_NOTES					BOOLEAN DEFAULT TRUE,
       ISABLETO_SEND_MAIL					BOOLEAN DEFAULT TRUE,
       ISABLETO_SAVE_INTO_PERSONAL_FOLDER	BOOLEAN DEFAULT TRUE,
       ISABLETO_SAVE_REMEMBER_ME			BOOLEAN DEFAULT TRUE,
       ISABLETO_SEE_METADATA 				BOOLEAN DEFAULT TRUE,
...
CREATE TABLE SBI_DOSSIER_PRESENTATIONS (
        ...
        WORKFLOW_PROCESS_ID 		NUMBER NOT NULL,
        BIOBJ_ID 					INTEGER NOT NULL,
        ...
        CONSTRAINT XPKSBI_DOSSIER_PRESENTATIONS
        	PRIMARY KEY (PRESENTATION_ID)
);

CREATE UNIQUE INDEX XAK1SBI_DOSSIER_PRESENTATIONS ON SBI_DOSSIER_PRESENTATIONS
(
       PRESENTATION_ID				ASC
);
...
CREATE TABLE SBI_DOSSIER_PARTS_TEMP (
        ...
        WORKFLOW_PROCESS_ID 		NUMBER(20) NOT NULL,
        BIOBJ_ID 					INTEGER NOT NULL,
        PAGE_ID 					INTEGER NOT NULL,
        CONSTRAINT XPKSBI_DOSSIER_PARTS_TEMP
        	PRIMARY KEY (PART_ID)
);

CREATE UNIQUE INDEX XAK1SBI_DOSSIER_PARTS_TEMP ON SBI_DOSSIER_PARTS_TEMP
(
       PART_ID						ASC
);
...
CREATE TABLE SBI_DOSSIER_BINARY_CONTENTS_TEMP (
        ...
        PART_ID 					INTEGER NOT NULL,
        NAME 						VARCHAR(20),
        BIN_CONTENT 				LONGRAW NOT NULL,
        TYPE 						VARCHAR(20) NOT NULL,
        CREATION_DATE 				TIMESTAMP,
        CONSTRAINT XPKSBI_DOSSIER_BINARY_CONTENTS_TEMP
        	PRIMARY KEY (BIN_ID)
);

CREATE UNIQUE INDEX XAK1SBI_DOSSIER_BINARY_CONTENTS_TEMP ON SBI_DOSSIER_BINARY_CONTENTS_TEMP
(
       BIN_ID						ASC
);
...
ALTER TABLE SBI_AUDIT
       ADD ( CONSTRAINT FK_sbi_audit_3 
              FOREIGN KEY (SUBOBJ_REF)
                             REFERENCES SBI_SUBOBJECTS ON DELETE SET NULL ) ;
...
ALTER TABLE SBI_VIEWPOINTS
       ADD ( CONSTRAINT FK_sbi_object_1 
              FOREIGN KEY (BIOBJ_ID)
                             REFERENCES SBI_OBJECTS);
...
ALTER TABLE SBI_DOSSIER_PRESENTATIONS 
	ADD (CONSTRAINT FK_SBI_DOSSIER_PRESENTATIONS_1 
			FOREIGN KEY ( BIN_ID ) 
				REFERENCES SBI_BINARY_CONTENTS);
				
ALTER TABLE SBI_DOSSIER_PRESENTATIONS 
	ADD (CONSTRAINT FK_SBI_DOSSIER_PRESENTATIONS_2 
			FOREIGN KEY ( BIOBJ_ID ) 
				REFERENCES SBI_OBJECTS);

ALTER TABLE SBI_DOSSIER_PARTS_TEMP 
	ADD (CONSTRAINT FK_SBI_DOSSIER_PARTS_TEMP_1 
			FOREIGN KEY ( BIOBJ_ID ) 
				REFERENCES SBI_OBJECTS);

ALTER TABLE SBI_DOSSIER_BINARY_CONTENTS_TEMP 
	ADD (CONSTRAINT FK_SBI_DOSSIER_BINARY_CONTENTS_TEMP_1 
			FOREIGN KEY ( PART_ID ) 
				REFERENCES SBI_DOSSIER_PARTS_TEMP ON DELETE CASCADE);
				
ALTER TABLE SBI_REMEMBER_ME 
	ADD (CONSTRAINT FK_SBI_REMEMBER_ME_1 
      FOREIGN KEY ( BIOBJ_ID ) 
        REFERENCES SBI_OBJECTS ON DELETE CASCADE);
        
ALTER TABLE SBI_REMEMBER_ME 
	ADD (CONSTRAINT FK_SBI_REMEMBER_ME_2 
      FOREIGN KEY ( SUBOBJ_ID ) 
        REFERENCES SBI_SUBOBJECTS ON DELETE CASCADE);
...
create trigger TRG_SBI_DOSSIER_PRESENTATIONS
  BEFORE INSERT
  on SBI_DOSSIER_PRESENTATIONS
  REFERENCING OLD AS old NEW AS new
  for each row
  declare nuovo_id number;
begin
IF :new.ID IS NULL THEN
     select SBI_DOSSIER_PRESENTATIONS_SEQ.nextval into nuovo_id from dual;
     :new.ID:=nuovo_id;
END IF;
end;
/

create trigger TRG_SBI_DOSSIER_PARTS_TEMP
  BEFORE INSERT
  on SBI_DOSSIER_PARTS_TEMP
  REFERENCING OLD AS old NEW AS new
  for each row
  declare nuovo_id number;
begin
IF :new.ID IS NULL THEN
     select SBI_DOSSIER_PARTS_TEMP_SEQ.nextval into nuovo_id from dual;
     :new.ID:=nuovo_id;
END IF;
end;
/

create trigger TRG_SBI_DOSSIER_BINARY_CONTENTS_TEMP
  BEFORE INSERT
  on SBI_DOSSIER_BINARY_CONTENTS_TEMP
  REFERENCING OLD AS old NEW AS new
  for each row
  declare nuovo_id number;
begin
IF :new.ID IS NULL THEN
     select SBI_DOSSIER_BINARY_CONTENTS_TEMP_SEQ.nextval into nuovo_id from dual;
     :new.ID:=nuovo_id;
END IF;
end;
/
