...
CREATE UNIQUE INDEX label_unique
  ON SBI_ALARM (LABEL)

CREATE UNIQUE INDEX name_unique
  ON SBI_ALARM_CONTACT (NAME)

CREATE UNIQUE INDEX code_unique
  ON SBI_KPI (code)

CREATE UNIQUE INDEX model_cd_unique
  ON SBI_KPI_MODEL (KPI_MODEL_CD)

CREATE UNIQUE INDEX name_unique
  ON SBI_KPI_PERIODICITY (name)

CREATE UNIQUE INDEX code_unique
  ON SBI_THRESHOLD (code)

CREATE UNIQUE INDEX label_thId_unique
  ON SBI_THRESHOLD_VALUE (label,THRESHOLD_ID)

CREATE UNIQUE INDEX resource_name_unique
  ON SBI_RESOURCES (RESOURCE_NAME)
...
/
CREATE SEQUENCE "SPAGOBI"."SBI_KPI_PERIODICITY_SEQ" INCREMENT BY 1 START WITH 1 MAXVALUE 999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER
/
CREATE SEQUENCE "SPAGOBI"."SBI_MEASURE_UNIT_SEQ" INCREMENT BY 1 START WITH 1 MAXVALUE 999999999999999 MINVALUE 1 NOCYCLE CACHE 20 NOORDER
/
