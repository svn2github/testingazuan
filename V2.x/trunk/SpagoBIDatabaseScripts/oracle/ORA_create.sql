...
Create table SPAGOBI.SBI_DATA_SET (
...
Create table SPAGOBI.SBI_EXT_ROLES (
...
ALTER TABLE SBI_DATA_SET ADD FOREIGN KEY (TRANSFORMER_ID) REFERENCES SBI_DOMAINS(VALUE_ID) ON DELETE CASCADE
/
