...
DROP TABLE SBI_DOSSIER_PRESENTATIONS CASCADE CONSTRAINTS;
DROP TABLE SBI_DOSSIER_BINARY_CONTENTS_TEMP CASCADE CONSTRAINTS;
DROP TABLE SBI_DOSSIER_PARTS_TEMP CASCADE CONSTRAINTS;
