...
ALTER TABLE SBI_KPI_MODEL ADD COLUMN KPI_MODEL_LBL VARCHAR2(100) NOT NULL;
...
ALTER TABLE SBI_THRESHOLD_VALUE ADD COLUMN th_value NUMBER(38,0);

/* Modifies SBI_KPI_MODEL_INST to specify a KPI INSTANCE or a MODEL INSTANCE LABEL */
ALTER TABLE SBI_KPI_MODEL_INST ADD COLUMN modelUUID VARCHAR2(400);
