...
ALTER TABLE SBI_OBJ_METACONTENTS ADD CONSTRAINT XAK1SBI_OBJ_METACONTENTS UNIQUE (OBJMETA_ID, BIOBJ_ID);
ALTER TABLE SBI_OBJ_METACONTENTS ADD CONSTRAINT XAK2SBI_OBJ_METACONTENTS UNIQUE ( OBJMETA_ID,BIOBJ_ID,SUBOBJ_ID);
