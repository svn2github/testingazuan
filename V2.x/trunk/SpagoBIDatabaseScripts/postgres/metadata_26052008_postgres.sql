...
CREATE SEQUENCE SBI_DISTRIBUTION_LIST_SEQ INCREMENT 1 START 1 ;
CREATE SEQUENCE SBI_DISTRIBUTION_LIST_USER_SEQ INCREMENT 1 START 1 ;
CREATE SEQUENCE SBI_DISTRIBUTION_LISTS_OBJECTS_SEQ INCREMENT 1 START 1 ;
CREATE SEQUENCE SBI_DOSSIER_BINARY_CONTENTS_TEMP_SEQ INCREMENT 1 START 1 ;
CREATE SEQUENCE SBI_DOSSIER_PARTS_TEMP_SEQ INCREMENT 1 START 1 ;
CREATE SEQUENCE SBI_DOSSIER_PRESENTATIONS_SEQ INCREMENT 1 START 1 ;
...
CREATE TABLE SBI_DISTRIBUTION_LIST
(
	DL_ID INTEGER DEFAULT nextval('SBI_DISTRIBUTION_LIST_SEQ') NOT NULL,
	NAME VARCHAR(40) NOT NULL,
	DESCR VARCHAR(160),
	    CONSTRAINT XPKSBI_DISTRIBUTION_LIST 
          PRIMARY KEY (DL_ID)
) WITHOUT OIDS;


CREATE TABLE SBI_DISTRIBUTION_LIST_USER
(
	DLU_ID INTEGER DEFAULT nextval('SBI_DISTRIBUTION_LIST_USER_SEQ') NOT NULL,
	LIST_ID INTEGER NOT NULL,
	USER_ID VARCHAR(40) NOT NULL,
	E_MAIL VARCHAR(70) NOT NULL,
	    CONSTRAINT XPKSBI_DISTRIBUTION_LIST_USER 
          PRIMARY KEY (DLU_ID)
) WITHOUT OIDS;

CREATE UNIQUE INDEX XAK1SBI_DISTRIBUTION_LIST_USER ON SBI_DISTRIBUTION_LIST_USER
(
       LIST_ID,
       USER_ID           
);

CREATE TABLE SBI_DISTRIBUTION_LISTS_OBJECTS
(
	REL_ID INTEGER DEFAULT nextval('SBI_DISTRIBUTION_LISTS_OBJECTS_SEQ') NOT NULL,
	DOC_ID INTEGER NOT NULL,
	DL_ID INTEGER NOT NULL,
	XML VARCHAR(5000) NOT NULL,
	    CONSTRAINT XPKSBI_DISTRIBUTION_LISTS_OBJECTS 
          PRIMARY KEY (REL_ID)
) WITHOUT OIDS;

CREATE UNIQUE INDEX XAK1SBI_DISTRIBUTION_LISTS_OBJECTS ON SBI_DISTRIBUTION_LISTS_OBJECTS
(
       DOC_ID,
       DL_ID           
);
...
(
	BIN_ID INTEGER DEFAULT nextval('SBI_DOSSIER_BINARY_CONTENTS_TEMP_SEQ') NOT NULL,
...
(
	PART_ID INTEGER DEFAULT nextval('SBI_DOSSIER_PARTS_TEMP_SEQ') NOT NULL,
...
(
	PRESENTATION_ID INTEGER DEFAULT nextval('SBI_DOSSIER_PRESENTATIONS_SEQ') NOT NULL,
	WORKFLOW_PROCESS_ID BIGINT NOT NULL,
	BIOBJ_ID INTEGER NOT NULL,
...
ALTER TABLE SBI_BINARY_CONTENTS ADD CONSTRAINT AK_FK_SBI_DOSSIER_PRESENTATIONS_1 UNIQUE (BIN_ID);
...
ALTER TABLE SBI_DISTRIBUTION_LIST ADD CONSTRAINT AK_FK_SBI_DISTRIBUTION_LIST_USER_1 UNIQUE (DL_ID);
ALTER TABLE SBI_DISTRIBUTION_LIST ADD CONSTRAINT AK_FK_SBI_DISTRIBUTION_LISTS_OBJECTS_2 UNIQUE (DL_ID);
...
ALTER TABLE SBI_DOMAINS ADD CONSTRAINT AK_FK_SBI_ROLE_TYPE_USER_FUNCTIONALITY_1 UNIQUE (VALUE_ID);
ALTER TABLE SBI_DOSSIER_PARTS_TEMP ADD CONSTRAINT AK_FK_SBI_DOSSIER_BINARY_CONTENTS_TEMP_1 UNIQUE (PART_ID);
...
ALTER TABLE SBI_OBJECTS ADD CONSTRAINT AK_FK_SBI_DISTRIBUTION_LISTS_OBJECTS_1 UNIQUE (BIOBJ_ID);
ALTER TABLE SBI_OBJECTS ADD CONSTRAINT AK_FK_SBI_DOSSIER_PARTS_TEMP_1 UNIQUE (BIOBJ_ID);
ALTER TABLE SBI_OBJECTS ADD CONSTRAINT AK_FK_SBI_DOSSIER_PRESENTATIONS_2 UNIQUE (BIOBJ_ID);
...
ALTER TABLE SBI_USER_FUNCTIONALITY ADD CONSTRAINT AK_FK_SBI_ROLE_TYPE_USER_FUNCTIONALITY_2 UNIQUE (USER_FUNCT_ID);

/* CREATE FOREIGN KEYS */

ALTER TABLE SBI_DOSSIER_PRESENTATIONS ADD  FOREIGN KEY (BIN_ID) REFERENCES SBI_BINARY_CONTENTS (BIN_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE SBI_DISTRIBUTION_LIST_USER ADD  FOREIGN KEY (LIST_ID) REFERENCES SBI_DISTRIBUTION_LIST (DL_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SBI_DISTRIBUTION_LISTS_OBJECTS ADD  FOREIGN KEY (DL_ID) REFERENCES SBI_DISTRIBUTION_LIST (DL_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE SBI_ROLE_TYPE_USER_FUNCTIONALITY ADD  FOREIGN KEY (ROLE_TYPE_ID) REFERENCES SBI_DOMAINS (VALUE_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SBI_DOSSIER_BINARY_CONTENTS_TEMP ADD  FOREIGN KEY (PART_ID) REFERENCES SBI_DOSSIER_PARTS_TEMP (PART_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE SBI_DISTRIBUTION_LISTS_OBJECTS ADD  FOREIGN KEY (DOC_ID) REFERENCES SBI_OBJECTS (BIOBJ_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SBI_DOSSIER_PARTS_TEMP ADD  FOREIGN KEY (BIOBJ_ID) REFERENCES SBI_OBJECTS (BIOBJ_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;

ALTER TABLE SBI_DOSSIER_PRESENTATIONS ADD  FOREIGN KEY (BIOBJ_ID) REFERENCES SBI_OBJECTS (BIOBJ_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE SBI_ROLE_TYPE_USER_FUNCTIONALITY ADD  FOREIGN KEY (USER_FUNCT_ID) REFERENCES SBI_USER_FUNCTIONALITY (USER_FUNCT_ID) ON UPDATE RESTRICT ON DELETE RESTRICT;
