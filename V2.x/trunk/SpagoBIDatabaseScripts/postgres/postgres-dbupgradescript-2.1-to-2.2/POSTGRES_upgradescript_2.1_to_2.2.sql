...
Create UNIQUE Index name_unique  ON SBI_ALARM_CONTACT (NAME );

Create UNIQUE Index code_unique  ON SBI_KPI (code );
...
Create UNIQUE Index unique_resource_name  ON SBI_RESOURCES (RESOURCE_NAME );
