...
INSERT INTO SBI_USER_FUNCTIONALITY (NAME, DESCRIPTION) SELECT 'MapFeaturesManagement','MapFeaturesManagement'
...
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='ADMIN',SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='MapFeaturesManagement'))
...
INSERT INTO SBI_ROLE_TYPE_USER_FUNCTIONALITY SELECT((SELECT VALUE_ID FROM SBI_DOMAINS WHERE DOMAIN_CD='ROLE_TYPE' AND VALUE_CD='DEV_ROLE',SELECT USER_FUNCT_ID FROM SBI_USER_FUNCTIONALITY WHERE NAME='MapFeaturesManagement' ))
