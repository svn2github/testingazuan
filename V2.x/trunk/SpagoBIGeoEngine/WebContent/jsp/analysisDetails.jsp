...
<%@ page import="it.eng.spagobi.engines.geo.service.*,it.eng.spagobi.engines.geo.service.initializer.*" %>
...
<% 
	...
	GeoEngineStartAction.SubObjectDetails subObjectDetails = (GeoEngineStartAction.SubObjectDetails)sessionContainer.getAttribute(GeoEngineStartAction.SPAGOBI_SUBOBJECT_DETAILS);
