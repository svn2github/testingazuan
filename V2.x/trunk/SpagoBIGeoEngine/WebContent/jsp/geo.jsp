<%@ page language="java"
         ...
         import="it.eng.spago.base.*,
                 ...
                 java.util.ArrayList,it.eng.spagobi.engines.geo.configuration.*,it.eng.spagobi.engines.geo.map.utils.*,
                 it.eng.spagobi.utilities.callbacks.mapcatalogue.MapCatalogueAccessUtils,
                 it.eng.spago.tracing.TracerSingleton,it.eng.spagobi.engines.geo.service.*,it.eng.spagobi.engines.geo.service.initializer.*,it.eng.spagobi.engines.geo.commons.service.*" %>
<%
	...
	SpagoBIRequest spagoBIRequest = null;
	...
	mapConfiguration = (MapConfiguration)sessionContainer.getAttribute(GeoEngineStartAction.MAP_CONFIGURATION);
	spagoBIRequest = (SpagoBIRequest)sessionContainer.getAttribute(GeoEngineStartAction.SPAGOBI_REQUEST);
	//template = sessionContainer.getAttribute("template").toString();
