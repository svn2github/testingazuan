...
public class DatabaseBrowserTreeModel extends FilterTreeModel {
	...
	protected class NodeFilter implements IObjectAcceptor {
		...
		public boolean accept(Object object) {
			boolean result = true;
			if(result && !isShowCubeDimensions())
				result = !(object instanceof CubeDimensionsFolderNode);
			if(result && !isShowDatabaseDimensions())
				result = !(object instanceof DimensionsFolderNode);
