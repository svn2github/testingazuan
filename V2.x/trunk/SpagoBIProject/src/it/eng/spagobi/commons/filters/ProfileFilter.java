 ...
 * 
 * This filter tries to build the user profile object, using the user identifier returned by 
			...
			if (request instanceof HttpServletRequest) {
				...
				if (userId == null || userId.trim().equals("")) {
					...
					if (requestContainer == null) {
						// RequestContainer does not exists yet (maybe it is the first call to Spago)
						// initializing Spago objects (user profile object must be put into PermanentContainer)
