...
**/
package it.eng.spagobi.engines.documentcomposition.presentation;
...
public class DocumentCompositionExecutionPublisher extends GenericPublisher {
	...
	public String getPublisherName(RequestContainer requestContainer, ResponseContainer responseContainer) {
		...
		SourceBean moduleResponse = (SourceBean) serviceResp.getAttribute("DocumentCompositionExecutionModule");
