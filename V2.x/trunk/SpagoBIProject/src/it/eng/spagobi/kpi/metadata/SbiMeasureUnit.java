...
public class SbiMeasureUnit  implements java.io.Serializable {
    ...
    /** full constructor */
    public SbiMeasureUnit(Integer idMeasureUnit, SbiDomains sbiDomains, String name, String scaleCd, String scaleNm, Set sbiKpiInstanceHistories, Set sbiKpis, Set sbiKpiInstances) {
        this.idMeasureUnit = idMeasureUnit;
        this.sbiDomains = sbiDomains;
        this.name = name;
