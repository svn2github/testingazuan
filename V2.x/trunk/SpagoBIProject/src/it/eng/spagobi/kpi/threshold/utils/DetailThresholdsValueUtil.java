...
public class DetailThresholdsValueUtil {
	...
	public static void selectThresholdValue(Integer id, SourceBean serviceResponse)
			throws SourceBeanException, EMFUserError {
		ThresholdValue toReturn = DAOFactory.getThresholdValueDAO().loadThresholdValueById(id);
	...
	private static ThresholdValue getThresholdValueFromRequest(
		...
		String sThresholdId = (String) serviceRequest.getAttribute("threshold_id");
		...
		String sSeverityId = (String) serviceRequest.getAttribute("severity_id");
	...
	public static void newThresholdValue(SourceBean serviceRequest,
			SourceBean serviceResponse) throws EMFUserError, SourceBeanException {
		ThresholdValue toCreate = getThresholdValueFromRequest(serviceRequest);
		
		Integer thresholdValueId = DAOFactory.getThresholdValueDAO().insertThresholdValue(toCreate);
