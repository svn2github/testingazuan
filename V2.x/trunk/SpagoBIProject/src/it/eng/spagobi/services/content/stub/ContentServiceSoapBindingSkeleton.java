...
public class ContentServiceSoapBindingSkeleton implements it.eng.spagobi.services.content.stub.ContentService, org.apache.axis.wsdl.Skeleton {
    ...
    */
    ...
    {
        java.lang.String ret = impl.saveSubObject(in0, in1, in2, in3, in4, in5);
        return ret;
    }
    ...
    {
        java.lang.String ret = impl.saveObjectTemplate(in0, in1, in2, in3);
        return ret;
    }
    ...
    {
        java.lang.String ret = impl.publishTemplate(in0, in1, in2, in3, in4, in5, in6, in7, in8, in9);
        return ret;
    }
    ...
    {
        java.lang.String ret = impl.mapCatalogue(in0, in1, in2);
        return ret;
    }
