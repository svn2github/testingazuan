...
public class SessionServiceProxy implements it.eng.spagobi.services.session.stub.SessionService {
  ...
  private void _initSessionServiceProxy() {
    try {
      sessionService = (new it.eng.spagobi.services.session.stub.SessionServiceServiceLocator()).getWSSessionService();
      if (sessionService != null) {
        if (_endpoint != null)
          ((javax.xml.rpc.Stub)sessionService)._setProperty("javax.xml.rpc.service.endpoint.address", _endpoint);
        else
          _endpoint = (String)((javax.xml.rpc.Stub)sessionService)._getProperty("javax.xml.rpc.service.endpoint.address");
      }
  ...
  public void openSession(java.lang.String in0, java.lang.String in1) throws java.rmi.RemoteException, it.eng.spagobi.services.session.exceptions.AuthenticationException{
    ...
    if (this.sessionId != null){
    	((WSSessionServiceSoapBindingStub)sessionService).setSessionId(this.sessionId);
    }
    sessionService.openSession(in0, in1);
    this.sessionId = ((WSSessionServiceSoapBindingStub)sessionService).getSessionId();
  }
