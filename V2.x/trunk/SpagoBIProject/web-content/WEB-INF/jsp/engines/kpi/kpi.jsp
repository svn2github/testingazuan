...
<%@ include file="/WEB-INF/jsp/engines/kpi/kpiinclusions/kpiDefaultHeaderForSpagoBI.jsp"%>
...
<%	//START ADDING TITLE AND SUBTITLE
	...
	<%@ include file="/WEB-INF/jsp/engines/kpi/kpiinclusions/kpiScriptsForTree.jsp"%>	
	<%@ include file="/WEB-INF/jsp/engines/kpi/kpiinclusions/kpiAddItemForTree.jsp"%>		
	...
	if(!kpiRBlocks.isEmpty()){
		...
		<%while(blocksIt.hasNext()){%>
			<%@ include file="/WEB-INF/jsp/engines/kpi/kpiinclusions/kpiAddBlockForTree.jsp"%>		
		<%}			
...
%>		
<%@ include file="/WEB-INF/jsp/engines/kpi/kpiinclusions/kpiDefaultFooterForSpagoBI.jsp"%>
