...
public StringBuffer addItemForTree(String lineTagId,ExecutionInstance execInstance,String userId,int recursionLevel, 
		...
		KpiLineVisibilityOptions options, String currTheme, HashMap parametersMap, Resource r, Date d) {
	...
	_htmlStream = addMetadataIconColumn(_htmlStream, recursionLevel, requestIdentity, kpiVal, options.getWeighted_values(), line.getModelInstanceNodeId(), userId,infoImgSrc);	
	...
	_htmlStream = addTrendColumn( _htmlStream,recursionLevel, requestIdentity,userId,kpiVal,r,timeRangeTo,timeRangeFrom,d, trendTitle,trendImgSrc);
   ...
   if (children!=null && !children.isEmpty()){
	   ...
	   while (childIt.hasNext()){
		   ...
		   if (isEvenLine){			   
			   addItemForTree(idTemp,execInstance,userId,recursionLevel,false,httpReq, l,_htmlStream,options,currTheme,parametersMap,r,d);
		   }else{
			   addItemForTree(idTemp,execInstance,userId,recursionLevel,true,httpReq, l,_htmlStream,options,currTheme,parametersMap,r,d);
		   }  
	   }
   } 
...
private StringBuffer addMetadataIconColumn(StringBuffer _htmlStream,int recursionLevel,String requestIdentity,KpiValue kpiVal, Boolean isWeightedValue,Integer modelInstanceNodeId, String userId,String infoImgSrc){
	String valueDescr = "";
	if(kpiVal !=null && kpiVal.getKpiInstanceId()!=null){
		if(kpiVal.getValueDescr()!=null){
			valueDescr = kpiVal.getValueDescr();		
		}
		HashMap execUrlParMap = createParMapForMetadataWindow(kpiVal,modelInstanceNodeId,isWeightedValue);
...
private StringBuffer addTrendColumn(StringBuffer _htmlStream,int recursionLevel,String requestIdentity,String userId, KpiValue kpiVal,Resource r,String timeRangeTo, String timeRangeFrom, Date d, String trendTitle, String trendImgSrc){
	
	if(kpiVal!=null && kpiVal.getValue()!= null){		
		HashMap execUrlParMap = createParMapForTrendWindow(r,d,timeRangeFrom,timeRangeTo,kpiVal);
...
private HashMap createParMapForMetadataWindow(KpiValue kpiVal,Integer modelInstanceNodeId,boolean isWeightedValue){
...
private HashMap createParMapForTrendWindow(Resource r,Date d,String timeRangeFrom, String timeRangeTo, KpiValue kpiVal){
