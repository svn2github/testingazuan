...
Sbi.execution.RatingWindow = function(config) {
	...
	// constructor
    Sbi.execution.RatingWindow.superclass.constructor.call(this, c);
...
Ext.extend(Sbi.execution.RatingWindow, Ext.Window, {});