qx.Class.define("qooxdoo.ui.custom.FunctionalityTreeSubClass", {
  ...
  members : 
  {
  		 ...
  		 _table 	 : undefined,
	  	  ...
	  	  createToolbar : function(){
			  ...
			  var NB = new qx.ui.tooltip.ToolTip("New");
			  ...
			  var SB = new qx.ui.tooltip.ToolTip("Save");
			  ...
			  var SD = new qx.ui.tooltip.ToolTip("Delete");
			  ...
			  var moveUpToolTip = new qx.ui.tooltip.ToolTip("Move up");
			  ...
			  var moveDownToolTip = new qx.ui.tooltip.ToolTip("Move Down");
			  ...
			  var clearAllToolTip = new qx.ui.tooltip.ToolTip("Clear all Data");
  		  ...
  		  createTextField : function(config){
     		  var textfield = qooxdoo.commons.WidgetUtils.createInputTextField(config);
     		  		//textfield.setTop(20);
     		  this._add(textfield);
   	 	  ...
   	 	  createDummyLabel: function(){
     		  var space = qooxdoo.commons.WidgetUtils.createLabel(" ");
     		  	//textfield.setTop(20);
     		  this._add(space);
   	 	  },
   	 	  ...
   	 	  CreateTableWithCheckbox : function (){
	   	 	  ...
	   	 	  var tableData = qooxdoo.app.data.DataService.loadFunctionalitiesRecords();
	   	 	  var config = {};
	 	 	  config.dataset = tableData;
	 	 		  
	 	 	  var newTable = new qooxdoo.ui.table.Table(this, config);
	   	 	  		//newTable.setTop(20);
	   	 	  		//this.add( newTable );
			   	 	  /*
