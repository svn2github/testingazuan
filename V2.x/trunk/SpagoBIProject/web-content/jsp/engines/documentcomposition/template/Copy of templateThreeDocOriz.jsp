...
<%
	String execUrlDoc1 = (String)lstUrl.get("DOC_1");
	String execUrlDoc2 = (String)lstUrl.get("DOC_2");
	String execUrlDoc3 = (String)lstUrl.get("DOC_3");
...
<div id="divIframe<%=requestIdentity%>" style="width:98%;float:left;padding-left:2%;" onclick="alert( 'yeah' ); " >   
            <iframe
