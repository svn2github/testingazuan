...
<%@ page import="java.net.URLEncoder,
                 ...
                 it.eng.spagobi.analiticalmodel.document.service.ExecuteBIObjectModule,it.eng.spagobi.commit.eng.spagobi.commons.utilitieslities,java.util.List,org.safehaus.uuid.UUID,org.safehaus.uuid.UUIDGenerator,java.util.ArrayList,java.util.HashMap" %>

<%@page import="it.eng.spagobi.commons.utilities.ChannelUtilities"%>
<script src="<%=urlBuilder.getResourceLink(request, it.eng.spagobi.commons.utilitiess/vbembed.js")%>" language="JavaScript1.1" type="text/javascript"></script>
