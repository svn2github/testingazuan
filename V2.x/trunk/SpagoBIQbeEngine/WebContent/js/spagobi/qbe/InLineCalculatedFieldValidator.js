/*
	...
	The LALR grammar:
			...
			/~ Non-associative tokens ~/
			    ...
			    '\'[A-Za-z0-9_]+\''								String
			    '[A-Za-z0-9_]+|[A-Za-z0-9_]+ [A-Za-z0-9_]+'		Identifier
			    ;
...
switch( state )
{
    case 0:
        ...
        else if( info.src.charCodeAt( pos ) == 66 || ( info.src.charCodeAt( pos ) >= 68 && info.src.charCodeAt( pos ) <= 76 ) || ( info.src.charCodeAt( pos ) >= 78 && info.src.charCodeAt( pos ) <= 82 ) || ( info.src.charCodeAt( pos ) >= 84 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || info.src.charCodeAt( pos ) == 98 || ( info.src.charCodeAt( pos ) >= 100 && info.src.charCodeAt( pos ) <= 108 ) || ( info.src.charCodeAt( pos ) >= 110 && info.src.charCodeAt( pos ) <= 114 ) || ( info.src.charCodeAt( pos ) >= 116 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else if( info.src.charCodeAt( pos ) == 67 || info.src.charCodeAt( pos ) == 99 ) state = 32;
        else if( info.src.charCodeAt( pos ) == 77 || info.src.charCodeAt( pos ) == 109 ) state = 33;
    ...
    case 8:
        ...
        else if( ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 10;
        match_pos = pos;
        break;
    ...
    case 9:
        if( info.src.charCodeAt( pos ) == 86 || info.src.charCodeAt( pos ) == 118 ) state = 19;
        else if( info.src.charCodeAt( pos ) == 32 ) state = 26;
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 85 ) || ( info.src.charCodeAt( pos ) >= 87 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 117 ) || ( info.src.charCodeAt( pos ) >= 119 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 13;
        match_pos = pos;
        break;
    ...
    case 13:
        if( info.src.charCodeAt( pos ) == 32 ) state = 26;
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 4;
        match_pos = pos;
        break;
    ...
    case 19:
        ...
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 70 ) || ( info.src.charCodeAt( pos ) >= 72 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 102 ) || ( info.src.charCodeAt( pos ) >= 104 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 13;
        match_pos = pos;
        break;
    ...
    case 21:
        if( info.src.charCodeAt( pos ) == 32 ) state = 26;
        else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 29;
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 84 ) || ( info.src.charCodeAt( pos ) >= 86 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 116 ) || ( info.src.charCodeAt( pos ) >= 118 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 13;
        match_pos = pos;
        break;
    ...
    case 23:
        ...
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 87 ) || ( info.src.charCodeAt( pos ) >= 89 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 119 ) || ( info.src.charCodeAt( pos ) >= 121 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 13;
        match_pos = pos;
        break;
    ...
    case 24:
        ...
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 122 ) ) state = 24;
        else state = -1;
        break;
    ...
    case 25:
        ...
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 77 ) || ( info.src.charCodeAt( pos ) >= 79 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 109 ) || ( info.src.charCodeAt( pos ) >= 111 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 13;
        match_pos = pos;
        break;
    ...
    case 26:
        if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 122 ) ) state = 28;
        else state = -1;
        break;
    ...
    case 27:
        ...
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 76 ) || ( info.src.charCodeAt( pos ) >= 78 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 108 ) || ( info.src.charCodeAt( pos ) >= 110 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 13;
        match_pos = pos;
        break;
    ...
    case 30:
        ...
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 83 ) || ( info.src.charCodeAt( pos ) >= 85 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 115 ) || ( info.src.charCodeAt( pos ) >= 117 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 13;
        match_pos = pos;
        break;
    ...
    case 33:
        if( info.src.charCodeAt( pos ) == 65 || info.src.charCodeAt( pos ) == 97 ) state = 23;
        else if( info.src.charCodeAt( pos ) == 73 || info.src.charCodeAt( pos ) == 105 ) state = 25;
        else if( info.src.charCodeAt( pos ) == 32 ) state = 26;
    ...
    case 34:
        if( info.src.charCodeAt( pos ) == 32 ) state = 26;
        else if( info.src.charCodeAt( pos ) == 85 || info.src.charCodeAt( pos ) == 117 ) state = 27;
        else if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 84 ) || ( info.src.charCodeAt( pos ) >= 86 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 116 ) || ( info.src.charCodeAt( pos ) >= 118 && info.src.charCodeAt( pos ) <= 122 ) ) state = 31;
        else state = -1;
        match = 13;
        match_pos = pos;
...
var pop_tab = new Array(
    ...
    new Array( 20/* p */, 1 ),
    new Array( 20/* p */, 1 ),
    new Array( 18/* numberexpression */, 3 ),
    new Array( 18/* numberexpression */, 3 ),
    new Array( 18/* numberexpression */, 3 ),
    new Array( 18/* numberexpression */, 3 ),
    new Array( 18/* numberexpression */, 2 ),
    new Array( 18/* numberexpression */, 4 ),
    new Array( 18/* numberexpression */, 4 ),
    new Array( 18/* numberexpression */, 4 ),
    new Array( 18/* numberexpression */, 4 ),
    new Array( 18/* numberexpression */, 4 ),
    new Array( 18/* numberexpression */, 3 ),
    new Array( 18/* numberexpression */, 1 ),
    new Array( 18/* numberexpression */, 1 ),
    new Array( 18/* numberexpression */, 1 ),
...
var goto_tab = new Array(
    /* State 0 */ new Array( 20/* p */,1 , 18/* numberexpression */,2 , 19/* stringexpression */,3 ),
    /* State 1 */ new Array( ),
    /* State 2 */ new Array( ),
    /* State 3 */ new Array( ),
    /* State 4 */ new Array( 18/* numberexpression */,20 ),
    /* State 5 */ new Array( ),
    /* State 6 */ new Array( ),
    /* State 7 */ new Array( ),
    /* State 8 */ new Array( ),
    /* State 9 */ new Array( ),
    /* State 10 */ new Array( 19/* stringexpression */,28 , 18/* numberexpression */,29 ),
    /* State 11 */ new Array( ),
    /* State 12 */ new Array( ),
    /* State 13 */ new Array( ),
    /* State 14 */ new Array( ),
    /* State 15 */ new Array( 18/* numberexpression */,30 ),
    /* State 16 */ new Array( 18/* numberexpression */,31 ),
    /* State 17 */ new Array( 18/* numberexpression */,32 ),
    /* State 18 */ new Array( 18/* numberexpression */,33 ),
    /* State 19 */ new Array( 19/* stringexpression */,34 ),
    /* State 20 */ new Array( ),
    /* State 21 */ new Array( 18/* numberexpression */,29 ),
    /* State 22 */ new Array( ),
    /* State 23 */ new Array( 18/* numberexpression */,37 ),
    /* State 24 */ new Array( 18/* numberexpression */,38 ),
    /* State 25 */ new Array( 18/* numberexpression */,39 ),
    /* State 26 */ new Array( 18/* numberexpression */,40 ),
    /* State 27 */ new Array( 18/* numberexpression */,41 ),
    /* State 28 */ new Array( ),
    /* State 29 */ new Array( ),
    /* State 30 */ new Array( ),
    /* State 31 */ new Array( ),
