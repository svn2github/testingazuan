...
<%@ page language="java"
		 import="it.eng.spago.error.*,java.util.*,it.eng.spagobi.qbe.commons.exception.*"
...
<%
	...
	List hints = null;
	if(exception instanceof QbeEngineException) {
		QbeEngineException geoException = (QbeEngineException)exception;
