...
public class ReportServlet extends HttpServlet{
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
		...
		try{
			...
			dbConn.setName(jndiDataSourceName);
			dbConn.setDialect(dialect);
			dbConn.setJndiName(jndiDataSourceName);
			dataSource = (IHibernateDataSource) QbeDataSourceManager.getInstance().getDataSource(datamartNames, dbConn);
			...
			if(lang.equalsIgnoreCase("SQL"))
				buildTemplateFromSQLQuery(templateFile,query, pagination, connection, orderedfldList, extractedEntitiesList, dataSource.getFormula(), savedQueryObjectId);
			else if(lang.equalsIgnoreCase("HQL"))
				buildTemplateFromHQLQuery(templateFile,query, pagination, session, connection, orderedfldList, extractedEntitiesList, dataSource.getFormula(), savedQueryObjectId);
			else
