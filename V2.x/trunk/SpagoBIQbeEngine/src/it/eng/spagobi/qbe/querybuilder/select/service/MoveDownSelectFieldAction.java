...
/**
 * 
 * This action move down of one position the field identified in request with FIELD_ID in the Select Clause  
 * of the object ISingleDataMartWizardObject in session
 */
public class MoveDownSelectFieldAction extends AbstractQbeEngineAction {
	...
	public void service(SourceBean request, SourceBean response) {
		...
		getMainQuery().moveDownSelectField(fieldId);
