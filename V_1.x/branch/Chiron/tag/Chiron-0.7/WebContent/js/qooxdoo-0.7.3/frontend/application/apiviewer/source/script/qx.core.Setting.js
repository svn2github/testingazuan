{type:"class",attributes:{"isStatic":"true","name":"Setting","packageName":"qx.core","fullName":"qx.core.Setting","type":"class"},children:[
  ...
  {type:"methods-static",children:[
    ...
    {type:"method",attributes:{"access":"private","isStatic":"true","name":"__loadUrlSettings"},children:[
      {type:"desc",attributes:{"text":"<p>Load settings from <span class=\"caps\">URL</span> parameters if the setting <code>&#8220;qx.allowUrlSettings&#8221;</code>\nis set to true.</p>"}}
      ]},
    {type:"method",attributes:{"isStatic":"true","name":"define"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"key"},children:[
          {type:"desc",attributes:{"text":"<p>The key to store the value under</p>"}},
          {type:"types",children:[
            {type:"entry",attributes:{"type":"String"}}
            ]}
          ]},
        {type:"param",attributes:{"name":"defaultValue"},children:[
          {type:"desc",attributes:{"text":"<p>Primitive default value for the new setting</p>"}},
          {type:"types",children:[
            {type:"entry",attributes:{"type":"String"}},
      ...
      {type:"desc",attributes:{"text":"<p>Define a new setting</p>"}},
      {type:"return",children:[
        {type:"types",children:[
          {type:"entry",attributes:{"type":"void"}}
          ]}
    ...
    {type:"method",attributes:{"isStatic":"true","name":"get"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"key"},children:[
          {type:"desc",attributes:{"text":"<p>The key where the data is stored under</p>"}},
          {type:"types",children:[
            {type:"entry",attributes:{"type":"String"}}
            ]}
          ]}
        ]},
      {type:"desc",attributes:{"text":"<p>Get the value of a previously defined setting</p>"}},
      {type:"return",children:[
        {type:"desc",attributes:{"text":"<p>The primitive value stored for the given setting</p>"}},
        {type:"types",children:[
          {type:"entry",attributes:{"type":"String"}},
          {type:"entry",attributes:{"type":"Boolean"}},
          {type:"entry",attributes:{"type":"Number"}}
