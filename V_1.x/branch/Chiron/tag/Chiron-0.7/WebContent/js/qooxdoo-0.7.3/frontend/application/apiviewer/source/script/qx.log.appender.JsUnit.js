{type:"class",attributes:{"name":"JsUnit","packageName":"qx.log.appender","superClass":"qx.log.appender.Abstract","fullName":"qx.log.appender.JsUnit","type":"class"},children:[
  {type:"desc",attributes:{"text":"<p>An appender that writes all messages to the JsUnit console, a unit testing framework\nfor JavaScript (<a href=\"http://www.jsunit.net\">http://www.jsunit.net</a>).</p>\n\n<p>This class does not depend on qooxdoo widgets, so it also works when there\nare problems with widgets or when the widgets are not yet initialized.</p>"}},
