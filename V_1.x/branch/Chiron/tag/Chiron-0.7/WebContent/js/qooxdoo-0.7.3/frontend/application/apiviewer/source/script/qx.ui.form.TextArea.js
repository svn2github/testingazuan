{type:"class",attributes:{"name":"TextArea","hasWarning":"true","packageName":"qx.ui.form","superClass":"qx.ui.form.TextField","fullName":"qx.ui.form.TextArea","type":"class"},children:[
  {type:"appearances",children:[
    {type:"appearance",attributes:{"type":"qx.ui.form.TextArea","name":"text-area"}}
    ]},
  {type:"methods",children:[
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.core.Widget#element","overriddenFrom":"qx.ui.form.TextField","name":"_applyElement"},children:[
    ...
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.form.TextArea#wrap","name":"_applyWrap"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"value"},children:[
          {type:"desc",attributes:{"text":"<p>new value of the property</p>"}},
          {type:"types",children:[
    ...
    {type:"method",attributes:{"access":"protected","hasError":"true","overriddenFrom":"qx.ui.form.TextField","name":"_computePreferredInnerHeight"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"36","line":"155"}}
        ]}
      ]},
  ...
  {type:"properties",children:[
    {type:"property",attributes:{"name":"allowStretchY","docFrom":"qx.ui.core.Widget","defaultValue":"true","refine":"true","propertyType":"new","overriddenFrom":"qx.ui.form.TextField"}},
    {type:"property",attributes:{"name":"appearance","docFrom":"qx.ui.core.Widget","defaultValue":"\"text-area\"","refine":"true","propertyType":"new","overriddenFrom":"qx.ui.form.TextField"}},
    {type:"property",attributes:{"name":"spellCheck","docFrom":"qx.ui.form.TextField","defaultValue":"true","refine":"true","propertyType":"new","overriddenFrom":"qx.ui.form.TextField"}},
    {type:"property",attributes:{"apply":"_applyWrap","defaultValue":"true","propertyType":"new","name":"wrap","check":"Boolean"},children:[
      {type:"desc",attributes:{"text":"<p>Controls whether text wrap is activated or not.\nThis property uses the style property &#8220;wrap&#8221; (IE) respectively &#8220;whiteSpace&#8221;</p>"}}
      ]}
    ]}
  ]}