{type:"class",attributes:{"name":"VerticalBoxLayoutImpl","hasWarning":"true","packageName":"qx.ui.layout.impl","superClass":"qx.ui.layout.impl.LayoutImpl","childClasses":"qx.ui.menu.MenuLayoutImpl","fullName":"qx.ui.layout.impl.VerticalBoxLayoutImpl","type":"class"},children:[
  {type:"methods",children:[
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"computeChildBoxHeight"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"29","line":"105"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"computeChildBoxWidth"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"28","line":"88"}}
        ]}
      ]},
    {type:"method",attributes:{"name":"computeChildrenFlexHeight"},children:[
      {type:"desc",attributes:{"text":"<p>Computes the height of all flexible children.</p>"}},
      {type:"return",children:[
        {type:"types",children:[
    ...
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"flushChildrenQueue"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChildrenQueue</code> is not documented.","column":"26","line":"636"}}
        ]}
      ]},
    ...
    {type:"method",attributes:{"hasError":"true","name":"invalidateChildrenFlexHeight"},children:[
      {type:"return",children:[
        {type:"types",children:[
          {type:"entry",attributes:{"type":"void"}}
          ]}
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"36","line":"344"}}
        ]}
      ]},
    ...
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"layoutChild"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"19","line":"727"}},
        {type:"error",attributes:{"msg":"Parameter <code>vJobs</code> is not documented.","column":"19","line":"727"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","name":"layoutChild_locationX"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"29","line":"900"}},
        {type:"error",attributes:{"msg":"Parameter <code>vJobs</code> is not documented.","column":"29","line":"900"}},
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"29","line":"900"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","name":"layoutChild_locationY"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"29","line":"825"}},
        {type:"error",attributes:{"msg":"Parameter <code>vJobs</code> is not documented.","column":"29","line":"825"}},
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"29","line":"825"}}
        ]}
      ]},
    ...
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"updateChildOnInnerHeightChange"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"38","line":"434"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"updateChildOnInnerWidthChange"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"37","line":"410"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"updateChildrenOnJobQueueFlush"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vQueue</code> is not documented.","column":"37","line":"487"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"updateChildrenOnMoveChild"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"33","line":"606"}},
        {type:"error",attributes:{"msg":"Parameter <code>vIndex</code> is not documented.","column":"33","line":"606"}},
        {type:"error",attributes:{"msg":"Parameter <code>vOldIndex</code> is not documented.","column":"33","line":"606"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"updateChildrenOnRemoveChild"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"35","line":"545"}},
        {type:"error",attributes:{"msg":"Parameter <code>vIndex</code> is not documented.","column":"35","line":"545"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"updateSelfOnChildOuterHeightChange"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"vChild"},children:[
          {type:"types",children:[
            {type:"entry",attributes:{"type":"var"}}
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vChild</code> is not documented.","column":"42","line":"386"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","overriddenFrom":"qx.ui.layout.impl.LayoutImpl","name":"updateSelfOnJobQueueFlush"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vJobQueue</code> is not documented.","column":"33","line":"464"}}
        ]}
      ]}
    ]},
  {type:"properties",children:[
    {type:"property",attributes:{"defaultValue":"true","propertyType":"new","hasError":"true","name":"enableFlexSupport","check":"Boolean"},children:[
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"3","line":"42"}}
        ]}
      ]}
    ]}
  ]}