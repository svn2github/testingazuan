{type:"class",attributes:{"name":"Manager","packageName":"qx.ui.menu","superClass":"qx.util.manager.Object","isSingleton":"true","fullName":"qx.ui.menu.Manager","type":"class"},children:[
  {type:"desc",attributes:{"text":"<p>This singleton manages multiple instances of qx.ui.menu.Menu and their state.</p>"}},
    ...
    {type:"method",attributes:{"name":"update"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"vTarget"},children:[
          {type:"desc",attributes:{"text":"<p>target of the processed event</p>"}},
          {type:"types",children:[
            {type:"entry",attributes:{"type":"Object"}}
            ]}
          ]},
        {type:"param",attributes:{"name":"vEventName"},children:[
          {type:"desc",attributes:{"text":"<p>processed event as string</p>"}},
          {type:"types",children:[
            {type:"entry",attributes:{"type":"String"}}
            ]}
          ]}
        ]},
      {type:"desc",attributes:{"text":"<p>Updates all registered menus</p>"}},
  ...
  {type:"methods-static",children:[
    {type:"method",attributes:{"isStatic":"true","name":"getInstance"},children:[
      ...
      {type:"return",children:[
        ...
        {type:"types",children:[
          {type:"entry",attributes:{"type":"qx.ui.menu.Manager"}}
          ]}
        ]}
      ]}
    ]}
