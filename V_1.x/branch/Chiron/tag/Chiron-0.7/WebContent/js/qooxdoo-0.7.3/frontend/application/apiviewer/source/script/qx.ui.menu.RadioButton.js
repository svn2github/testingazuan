{type:"class",attributes:{"name":"RadioButton","packageName":"qx.ui.menu","superClass":"qx.ui.menu.CheckBox","fullName":"qx.ui.menu.RadioButton","type":"class"},children:[
  {type:"appearances",children:[
    {type:"appearance",attributes:{"type":"qx.ui.menu.RadioButton","name":"menu-radio-button"}}
    ]},
  {type:"methods",children:[
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.menu.CheckBox#checked","overriddenFrom":"qx.ui.menu.CheckBox","name":"_applyChecked"},children:[
    ...
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.menu.RadioButton#manager","name":"_applyManager"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"value"},children:[
          {type:"desc",attributes:{"text":"<p>Current value</p>"}},
          {type:"types",children:[
    ...
    {type:"method",attributes:{"access":"protected","name":"_applyName"},children:[
      ...
      {type:"desc",attributes:{"text":"<p>Applies the name by delegating it to the\nmanager instance (if available)</p>"}}
      ]},
    {type:"method",attributes:{"access":"protected","overriddenFrom":"qx.ui.menu.CheckBox","name":"_processExecute"},children:[
      {type:"desc",attributes:{"text":"<p>Processes the execute action in calling the {@link #setChecked} method</p>"}},
  ...
  {type:"properties",children:[
    {type:"property",attributes:{"name":"appearance","docFrom":"qx.ui.core.Widget","defaultValue":"\"menu-radio-button\"","refine":"true","propertyType":"new","overriddenFrom":"qx.ui.menu.CheckBox"}},
