{type:"class",attributes:{"isAbstract":"true","name":"AbstractButton","hasWarning":"true","packageName":"qx.ui.pageview","superClass":"qx.ui.basic.Atom","childClasses":"qx.ui.pageview.buttonview.Button,qx.ui.pageview.radioview.Button,qx.ui.pageview.tabview.Button","fullName":"qx.ui.pageview.AbstractButton","type":"class"},children:[
  ...
  {type:"methods",children:[
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.pageview.AbstractButton#checked","name":"_applyChecked"},children:[
      {type:"params",children:[
    ...
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.pageview.AbstractButton#manager","name":"_applyManager"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"value"},children:[
          {type:"desc",attributes:{"text":"<p>Current value</p>"}},
          {type:"types",children:[
    ...
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.pageview.AbstractButton#name","name":"_applyName"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"value"},children:[
          {type:"desc",attributes:{"text":"<p>Current value</p>"}},
          {type:"types",children:[
    ...
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.pageview.AbstractButton#page","name":"_applyPage"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"value"},children:[
          {type:"desc",attributes:{"text":"<p>Current value</p>"}},
          {type:"types",children:[
    ...
    {type:"method",attributes:{"access":"protected","hasError":"true","name":"_onkeydown"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>e</code> is not documented.","column":"18","line":"305"}},
    ...
    {type:"method",attributes:{"access":"protected","hasError":"true","name":"_onmouseout"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>e</code> is not documented.","column":"19","line":"293"}},
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"19","line":"293"}}
        ]}
      ]},
    {type:"method",attributes:{"access":"protected","hasError":"true","name":"_onmouseover"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>e</code> is not documented.","column":"20","line":"281"}},
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"20","line":"281"}}
        ]}
      ]},
    ...
    {type:"method",attributes:{"name":"getPage","fromProperty":"page"},children:[
      {type:"desc",attributes:{"text":"<p>Returns the (computed) value of the property <code>page</code>.</p>\n\n<p>For further details take a look at the property definition: {@link #page}.</p>"}},
      {type:"return",children:[
        {type:"desc",attributes:{"text":"<p>(Computed) value of <code>page</code>.</p>"}},
        {type:"types",children:[
          {type:"entry",attributes:{"type":"var"}}
          ]}
        ]}
    ...
    {type:"method",attributes:{"hasError":"true","name":"getView"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"15","line":"134"}}
        ]}
      ]},
    ...
    {type:"method",attributes:{"access":"protected","name":"initPage","fromProperty":"page"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"value"},children:[
          {type:"desc",attributes:{"text":"<p>Initial value for property <code>page</code>.</p>"}},
          {type:"types",children:[
            {type:"entry",attributes:{"type":"var"}}
            ]}
          ]}
        ]},
      {type:"desc",attributes:{"text":"<p>Calls the apply method and dispatches the change event of the property <code>page</code>\nwith the default value defined by the class developer. This function can\nonly be called from the constructor of a class.</p>\n\n<p>For further details take a look at the property definition: {@link #page}.</p>"}},
      {type:"return",children:[
        {type:"desc",attributes:{"text":"<p>the default value</p>"}},
        {type:"types",children:[
          {type:"entry",attributes:{"type":"var"}}
    ...
    {type:"method",attributes:{"name":"resetPage","fromProperty":"page"},children:[
      {type:"desc",attributes:{"text":"<p>Resets the user value of the property <code>page</code>.</p>\n\n<p>The computed value falls back to the next available value e.g. appearance, init or\ninheritance value depeneding on the property configuration and value availability.</p>\n\n<p>For further details take a look at the property definition: {@link #page}.</p>"}},
      {type:"return",children:[
        {type:"types",children:[
          {type:"entry",attributes:{"type":"void"}}
          ]}
    ...
    {type:"method",attributes:{"name":"setPage","fromProperty":"page"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"value"},children:[
          {type:"desc",attributes:{"text":"<p>New value for property <code>page</code>.</p>"}},
          {type:"types",children:[
            {type:"entry",attributes:{"type":"var"}}
            ]}
          ]}
        ]},
      {type:"desc",attributes:{"text":"<p>Sets the user value of the property <code>page</code>.</p>\n\n<p>For further details take a look at the property definition: {@link #page}.</p>"}},
      {type:"return",children:[
        {type:"desc",attributes:{"text":"<p>The unmodified incoming value.</p>"}},
        {type:"types",children:[
          {type:"entry",attributes:{"type":"var"}}
  ...
  {type:"properties",children:[
    {type:"property",attributes:{"name":"checked","defaultValue":"false","event":"changeChecked","propertyType":"new","apply":"_applyChecked","check":"Boolean"},children:[
      {type:"desc",attributes:{"text":"<p>If this tab is the currently selected/active one</p>"}}
      ]},
    ...
    {type:"property",attributes:{"apply":"_applyName","propertyType":"new","name":"name","check":"String"},children:[
    ...
    {type:"property",attributes:{"check":"qx.ui.pageview.AbstractPage","allowNull":"true","propertyType":"new","name":"page","apply":"_applyPage"},children:[
      {type:"desc",attributes:{"text":"<p>The attached page of this tab</p>"}}
      ]},
