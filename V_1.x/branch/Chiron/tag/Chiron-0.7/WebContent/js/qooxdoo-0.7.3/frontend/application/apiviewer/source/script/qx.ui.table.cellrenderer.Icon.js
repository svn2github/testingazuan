{type:"class",attributes:{"name":"Icon","packageName":"qx.ui.table.cellrenderer","superClass":"qx.ui.table.cellrenderer.Abstract","childClasses":"qx.ui.table.cellrenderer.Boolean,qx.ui.table.cellrenderer.Image","fullName":"qx.ui.table.cellrenderer.Icon","type":"class"},children:[
  {type:"desc",attributes:{"text":"<p>A template class for cell renderers, which display images. Concrete\nimplementations must implement the method @{link #_identifyImage}.</p>"}},
  ...
  {type:"methods",children:[
    ...
    {type:"method",attributes:{"access":"protected","name":"_getImageInfos"},children:[
      {type:"params",children:[
      ...
      {type:"desc",attributes:{"text":"<p>Retrieves the image infos.</p>"}},
      {type:"return",children:[
        {type:"desc",attributes:{"text":"<p>Map with an &#8220;url&#8221; attribute (type string)\n                holding the <span class=\"caps\">URL</span> of the image to show\n                and a &#8220;tooltip&#8221; attribute\n                (type string) being the tooltip text (or null if none was specified)</p>"}},
        {type:"types",children:[
          {type:"entry",attributes:{"type":"Map"}}
          ]}
        ]}
      ]},
    {type:"method",attributes:{"access":"protected","name":"_identifyImage"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"cellInfo"},children:[
          {type:"desc",attributes:{"text":"<p>The information about the cell.\n         See {@link #createDataCellHtml}.</p>"}},
          {type:"types",children:[
