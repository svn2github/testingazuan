{type:"class",attributes:{"name":"Default","interfaces":"qx.ui.table.IHeaderRenderer","superClass":"qx.core.Object","childClasses":"qx.ui.table.headerrenderer.Icon","fullName":"qx.ui.table.headerrenderer.Default","type":"class","packageName":"qx.ui.table.headerrenderer"},children:[
  {type:"desc",attributes:{"text":"<p>The default header cell renderer.</p>"}},
  {type:"appearances",children:[
    {type:"appearance",attributes:{"type":"qx.ui.basic.Atom","name":"table-header-cell"},children:[
      {type:"states",children:[
        {type:"state",attributes:{"name":"mouseover"}}
        ]}
      ]}
    ]},
  {type:"constants",children:[
    {type:"constant",attributes:{"type":"String","name":"STATE_SORTED_ASCENDING","value":"sortedAscending"},children:[
      {type:"desc",attributes:{"text":"<p>The state which will be set when sorting is ascending.</p>"}},
      {type:"types",children:[
        {type:"entry",attributes:{"type":"String"}}
        ]}
      ]},
    {type:"constant",attributes:{"type":"String","name":"STATE_SORTED","value":"sorted"},children:[
      {type:"desc",attributes:{"text":"<p>The state which will be set for header cells of sorted columns.</p>"}},
      {type:"types",children:[
        {type:"entry",attributes:{"type":"String"}}
        ]}
      ]}
  ...
  {type:"methods",children:[
    {type:"method",attributes:{"docFrom":"qx.ui.table.IHeaderRenderer","name":"createHeaderCell"},children:[
    ...
    {type:"method",attributes:{"docFrom":"qx.ui.table.IHeaderRenderer","name":"updateHeaderCell"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"cellInfo"}},
  ...
  {type:"properties",children:[
    {type:"property",attributes:{"allowNull":"true","defaultValue":"null","propertyType":"new","name":"toolTip","check":"String"},children:[
      {type:"desc",attributes:{"text":"<p>ToolTip to show if the mouse hovers of the icon</p>"}}
      ]}
    ]}
  ]}