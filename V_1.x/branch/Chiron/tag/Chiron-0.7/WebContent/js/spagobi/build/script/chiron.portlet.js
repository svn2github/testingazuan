...
if(qxsettings["qx.resourceUri"]==undefined)qxsettings["qx.resourceUri"]="/Chiron/js/spagobi/build/resource/qx";
if(qxsettings["spagobi.resourceUri"]==undefined)qxsettings["spagobi.resourceUri"]="/Chiron/";
...
if($0!='funcManagement'){this.listPage=new spagobi.ui.PagedTable(this,
this.records);
...
$4,
$6);
var $a=new qx.ui.pageview.buttonview.Page($4);
$a.setDisplay(false);
$1.getPane().add($a);
$a.addEventListener("appear",
this.ShowDetails,
this);
this._form=$3;
...
if($0=='funcManagement'){var $b=new qx.ui.layout.VerticalBoxLayout();
var $c=new qx.ui.basic.Label("Functionalities Tree");
with($c){width=200;
height=300;
}var $d=new spagobi.ui.Tree({root:"Functionalities"});
var $e=$d.addNode({name:"Report",
parent:$d,
id:"node1"});
var $f=$d.addNode({name:"OLAP",
parent:$d,
id:"node2"});
var $g=$d.addNode({name:"myOLAP",
parent:$f,
id:"node3",
file:true});
var $h=$d.addNode({name:"DashBoard",
parent:$d,
id:"node4",
init_icon:"icon/16/places/user-trash.png",
click_icon:"",
checkBox:true});
var $i=$d.addNode({name:"myDashBoardFolder",
parent:$h,
id:"node5",
checkBox:true});
var $j=$d.addNode({name:"myDashBoard",
parent:$h,
id:"node6",
checkBox:true,
...
show:function(){if(this.detailBody!=undefined){this.detailBody.remove(this._form);
...
}else if(this._type==='featuremgmt'){this._form=new spagobi.ui.custom.FeatureDetailsForm();
}else if(this._type==='lov'){this._form=new spagobi.ui.custom.LOVDetailsForm();
}else if(this._type==='constraints'){this._form=new spagobi.ui.custom.ConstraintDetailsForm();
}else if(this._type==='parameters'){this._form=new spagobi.ui.custom.AnalyticalDriverDetailsForm();
}else if(this._type==='link1'){this._form=new spagobi.ui.custom.Link1DummyForm();
}else if(this._type==='link2'){this._form=new spagobi.ui.custom.Link2DummyForm();
}else if(this._type==='link3'){this._form=new spagobi.ui.custom.Link3DummyForm();
}else if(this._type=='configuration'){this._form=new spagobi.ui.custom.DocumentConfigurationForm();
}else if(this._type==='roles'){this._form=new spagobi.ui.custom.RolesDummyForm();
}else if(this._type==='distributionList'){this._form=new spagobi.ui.custom.DatasourceDetailsForm();
}else if(this._type==='distributionListConfig'){this._form=new spagobi.ui.custom.DatasourceDetailsForm();
}else if(this._type==='func'){this._form=new spagobi.ui.custom.DatasourceDetailsForm();
}else if(this._type==='workflow'){this._form=new spagobi.ui.custom.DatasourceDetailsForm();
}else if(this._type==='event'){this._form=new spagobi.ui.custom.DatasourceDetailsForm();
}else if(this._type==='tool'){this._form=new spagobi.ui.custom.DatasourceDetailsForm();
}else if(this._type==='schedule'){this._form=new spagobi.ui.custom.DatasourceDetailsForm();
}if(this.detailBody!=undefined){this.detailBody.add(this._form);
}
if(!this.isVisibility()){this.setVisibility(true);
}},
...
ShowDetails:function(){if(this.records.ID!=undefined){if(this.records.ID=="ROLES"){alert(this.listPage._table.getUpdatedData());
}}else{var $0=this.getForm().getData();
alert(this.printObject($0));
}}}});
...
loadFunctinalitiesMeta:function(){return [{dataIndex:'name',
name:'Name'},
{dataIndex:'description',
name:'Description'}];
},
...
members:{_documentTypeChangeValueHandler:function($0){if(this&&this.getInputField('type')){if($0.getValue()=="With Jndi Name"){this.getInputField('jndiname').setDisplay(true);
...
members:{_documentTypeChangeValueHandler:function($0){if($0.getValue()==null){this.getInputField('datevalueformat').setDisplay(false);
...
}else if($0.getValue()=="Choose..."){if(this.getInputField('datevalueformat')){this.getInputField('datevalueformat').setDisplay(false);
this.getInputField('regularexpression').setDisplay(false);
this.getInputField('maxlengthvalue').setDisplay(false);
this.getInputField('lrv').setDisplay(false);
this.getInputField('higherrangevalue').setDisplay(false);
...
_documentTypeChangeValueHandler:function($0){if(this&&this.getInputField('type')){if($0.getValue()=="Report"){this.getInputField('engine').setDisplay(true);
...
$4.setDataCellRenderer(2,
$6);
$4.setCellEditorFactory(2,
$7);
$4.setDataCellRenderer(3,
$6);
$4.setCellEditorFactory(3,
$7);
$4.setDataCellRenderer(4,
$6);
$4.setCellEditorFactory(4,
$7);
$4.setDataCellRenderer(5,
$6);
$4.setCellEditorFactory(5,
$7);
$4.setDataCellRenderer(6,
$6);
$4.setCellEditorFactory(6,
$7);
$4.setDataCellRenderer(7,
$6);
$4.setCellEditorFactory(7,
$7);
$4.setDataCellRenderer(8,
$6);
$4.setCellEditorFactory(8,
$7);
$4.setDataCellRenderer(9,
$6);
$4.setCellEditorFactory(9,
$7);
$4.setDataCellRenderer(10,
$6);
$4.setCellEditorFactory(10,
$7);
this.addEventListener("cellClick",
this._onCellCilck,
this);
}}var $8=(92*screen.width)/100;
this.setWidth($8);
this.setHeight("85%");
...
_onCellCilck:function($0){if(!$0 instanceof qx.event.type.DataEvent){return;
}var $1=$0.getColumn();
var $2=$0.getRow();
...
atom:undefined,
insertWin:undefined,
onClickMenu:function($0){var $1=new qx.client.Command();
$1.addEventListener("execute",
this._insertCmd,
this);
...
if($a.getPreviousSibling($b)==undefined){$5.add($6,
$7,
$9);
