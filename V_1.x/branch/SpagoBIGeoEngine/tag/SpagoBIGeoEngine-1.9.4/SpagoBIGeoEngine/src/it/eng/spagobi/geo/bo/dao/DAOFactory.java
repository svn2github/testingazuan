...
public class DAOFactory {
	...
	private static Object createDAOInstance(String daoName) throws EMFUserError {
		TracerSingleton.log(Constants.LOG_NAME, TracerSingleton.DEBUG, "Begin Istantiation of DAO ["+daoName+"]");
		...
		try{
			...
			TracerSingleton.log(Constants.LOG_NAME, TracerSingleton.DEBUG, "DAO ["+daoName+"] Implementation class ["+daoClassName+"]");			
			daoObject = Class.forName(daoClassName).newInstance();
			TracerSingleton.log(Constants.LOG_NAME, TracerSingleton.DEBUG, "DAO ["+daoName+"] Instatiate successfully");	
		}catch(Exception e){
			TracerSingleton.log(Constants.LOG_NAME, TracerSingleton.CRITICAL, "Error occurred"+ e.getLocalizedMessage());
	...
	public static ISbiGeoMapsDAO getSbiGeoMapsDAO() throws EMFUserError {
		return (ISbiGeoMapsDAO)createDAOInstance("SbiGeoMapsDAO");
	}
	...
	public static ISbiGeoFeaturesDAO getSbiGeoFeaturesDAO() throws EMFUserError {
		return (ISbiGeoFeaturesDAO)createDAOInstance("SbiGeoFeaturesDAO");
	}
	/**
	 * Creates a DAO instance for a BI object
	 * 
	...
	public static ISbiGeoMapFeaturesDAO getSbiGeoMapFeaturesDAO() throws EMFUserError {
		return (ISbiGeoMapFeaturesDAO)createDAOInstance("SbiGeoMapFeaturesDAO");
	}
