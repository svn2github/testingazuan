...
public class DetailModalitiesPublisherJUnitTest extends TestCase {
	...
	private DetailModalitiesPublisher detailModalitiesPublisher = null;
	...
	protected void setUp() throws Exception {
		...
		detailModalitiesPublisher = new DetailModalitiesPublisher();
		super.setUp();
	}
	
	/**
	 * Test method for 'it.eng.spagobi.presentation.publishers.DetailModalitiesPublisher.getPublisherName(RequestContainer, ResponseContainer)'.
	 * Verifies that the correct Publisher name is returned.
	 */
	public void testGetPublisherName() {
		String publisherName = null;
		SourceBean moduleResponse = null;
		String moduleName = "DetailModalitiesModule";
		try {
			moduleResponse = new SourceBean(moduleName);
			moduleResponse.setAttribute("loopback","");
			response.setAttribute(moduleResponse);
			publisherName = detailModalitiesPublisher.getPublisherName(reqContainer,resContainer);
			assertEquals("detailModalitiesLoop",publisherName);
			
			moduleResponse.delAttribute("loopback");
			publisherName = detailModalitiesPublisher.getPublisherName(reqContainer,resContainer);
			assertEquals("detailModalities",publisherName);
