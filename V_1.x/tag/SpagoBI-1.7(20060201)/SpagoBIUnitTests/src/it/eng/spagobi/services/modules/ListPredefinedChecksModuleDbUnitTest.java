...
public class ListPredefinedChecksModuleDbUnitTest extends DBConnectionTestCase {

	private SourceBean request = null, response = null, config = null;

	private ListPredefinedChecksModule listPredefinedChecksModule = null;

	private String className="it.eng.spagobi.services.modules.ListPredefinedChecksModule";
	...
	protected void setUp() throws Exception {
		...
		listPredefinedChecksModule = new ListPredefinedChecksModule();
		listPredefinedChecksModule.setRequestContext(defaultRequestContext);
		super.setUp();
		...
		listPredefinedChecksModule.init(config);
	}

	
	/**
	 * Test method for 'it.eng.spagobi.services.modules.ListChecksModule.getList(SourceBean, SourceBean)'.
	 * Verifies that the correct list of predefined Checks is returned.
	 */
	public void testGetList() {
		ListIFace list=null;
		try {
			list=listPredefinedChecksModule.getList(request,response);
		} catch (Exception e) {
			e.printStackTrace();
