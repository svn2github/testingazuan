...
<%
  ...
  String[] users = { "exo", "anonymous", "admin" } ;
  ...
  <table width="100%" border="1">
    ...
    <%for(int i= 0; i < users.length; i++) { %>
      <tr>
        ...
        <td><a href="<%=contextPath%>/faces/private/<%=users[i]%>"><%=users[i]%></a></td>
    ...
    <%  }%>
      <tr>
        <td><a href="<%=contextPath%>/faces/public/exo?portletName=<%=portletApp%><%=styleParam%>"><%=portletTitle%></a></td>
        <td><a href="<%=contextPath%>/faces/private/exo?portletName=<%=portletApp%><%=styleParam%>"><%=portletTitle%></a></td>
