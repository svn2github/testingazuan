				...
				<TABLE ID="tabs" CELLSPACING="0" CELLPADDING="2">
					<TR HEIGHT="20px">
						<TD CLASS="birtviewer_dialog_tab_selected" NOWRAP>
							<%= Resources.getString( "birt.viewer.dialog.exportdata.tab.field" )%>
						</TD>
						<TD CLASS="birtviewer_dialog_tab_normal">
							<%= Resources.getString( "birt.viewer.dialog.exportdata.tab.filter" )%>
						</TD>
					</TR>
				</TABLE>
			</TD>
			...
			<TD>
				<DIV ID="aaacontent">
					...
					<DIV STYLE="display:none">
						<IMG NAME="add" SRC="images/iv/AddFilter.gif" TITLE="add" CLASS="birtviewer_clickable">
