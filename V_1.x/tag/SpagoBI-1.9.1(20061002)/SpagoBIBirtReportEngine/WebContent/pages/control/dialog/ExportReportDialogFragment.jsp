...
<TABLE CELLSPACING="2" CELLPADDING="2" CLASS="birtviewer_dialog_body">
	...
	<TR>
		...
		<TD><%= Resources.getString( "birt.viewer.dialog.export.all" )%></TD>
	</TR>
	<TR>
		<TD></TD>
		<TD><%= Resources.getString( "birt.viewer.dialog.export.all.detail" )%></TD>
	</TR>
	<TR>
		<TD><INPUT TYPE='radio' NAME="exportoption" VALUE="printoption2"></TD>
		<TD><%= Resources.getString( "birt.viewer.dialog.export.modified" )%></TD>
	</TR>
	<TR>
		<TD></TD>
		<TD><%= Resources.getString( "birt.viewer.dialog.export.modified.detail" )%></TD>
	</TR>
	<TR HEIGHT="5px"><TD></TD></TR>
	<TR>
		<TD></TD>
		<TD>
			<%= Resources.getString( "birt.viewer.dialog.export.format" )%>
			<SELECT NAME='format' STYLE='width:150px;height:25px;font-size:8pt'>
				<OPTION><%= Resources.getString( "birt.viewer.dialog.export.format.pdf" )%>
				<OPTION><%= Resources.getString( "birt.viewer.dialog.export.format.excel" )%>
			</SELECT>
		</TD>
	</TR>
	<TR HEIGHT="5px"><TD></TD></TR>
