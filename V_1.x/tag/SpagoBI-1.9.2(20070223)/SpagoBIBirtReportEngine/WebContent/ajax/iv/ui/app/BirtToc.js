...
BirtToc.prototype = Object.extend( new BirtAppUIComponentBase( ),
{
	...
	*/
	...
	{
		var srcLoc = "images/iv/Expand.gif";
		if( plusMinus == '+' )
		{
			srcLoc = "images/iv/Collapse.gif";
		}
		else if( plusMinus == '-' )
		{
			srcLoc = "images/iv/Expand.gif";
		}
