...
**/
package it.eng.spagobi.scheduler.profile;
...
/**
 * Controls the Anonymous Scheduler User Profile.
 * 
 * @author Zerbetto
 *
 */

public class AnonymousSchedulerProfile implements IEngUserProfile {

	private static String SCHEDULER_USER_NAME = "[SYSTEM - SCHEDULER]";
	
	private String userUniqueIdentifier = SCHEDULER_USER_NAME;
	private Collection roles = null;
	private Map userAttributes = new HashMap();
	
	public AnonymousSchedulerProfile(){
		this.roles = new ArrayList();
		this.userAttributes.put("password", SCHEDULER_USER_NAME);
	}
