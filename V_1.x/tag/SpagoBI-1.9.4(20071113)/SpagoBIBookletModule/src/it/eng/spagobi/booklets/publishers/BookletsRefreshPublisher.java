...
**/
package it.eng.spagobi.booklets.publishers;
 ...
 *
 */
public class BookletsRefreshPublisher implements PublisherDispatcherIFace {
	/**
	...
	public String getPublisherName(RequestContainer requestContainer, ResponseContainer responseContainer) {
		...
		SourceBean moduleResponse = (SourceBean)serviceResp.getAttribute(BookletsConstants.BOOKLET_REFRESH_MODULE);
