/*
 * $Id: Packager.java 1708 2007-01-13 18:31:26Z jponge $
 ...
 */
public class SpagoBIPackager implements IPackager
{
    ...
    public SpagoBIPackager() throws CompilerException
    {
        this("default");
    }
     ...
     * @throws CompilerException
     */
    public SpagoBIPackager(String compr_format) throws CompilerException
    {
        this( compr_format, -1);
    }
     ...
     * @throws CompilerException
     */
    public SpagoBIPackager(String compr_format, int compr_level) throws CompilerException
    {
    ...
    private void writePacks() throws Exception
    {
        ...
        while (packIter.hasNext())
        {
            ...
            if (remoteFile != null && !remoteFile.trim().equals("")) {
            	String bytes = pack.bytes;
            	pack.nbytes = new Long(bytes).longValue(); 
            }
            //****************************END MODIFICATIONS BY DAVIDE ZERBETTO
