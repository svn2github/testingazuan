		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PhysicalModel_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PhysicalModel_name_feature", "_UI_PhysicalModel_type"),
				 PhysicalModelPackage.Literals.PHYSICAL_MODEL__NAME,
				 true,
				 false,
				 false,
