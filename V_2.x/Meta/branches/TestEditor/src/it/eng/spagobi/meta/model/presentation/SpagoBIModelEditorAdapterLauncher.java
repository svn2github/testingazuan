...
public class SpagoBIModelEditorAdapterLauncher implements IEditorLauncher {
	...
	public void open(IPath path) {
		...
		try {
			...
			TestEditorPlugin.INSTANCE.log(e);
		}
		...
		if(it.hasNext()) {
			...
			try {
				...
				MessageDialog.openError(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(), TestEditorPlugin.INSTANCE.getString("_UI_OpenEditorError_label"), exception.getMessage());
			}
		}
