 ...
 */
public interface CwmFeature extends it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmModelElement {
    /**
     ...
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.ScopeKind getOwnerScope();
    /**
     * Sets the value of ownerScope attribute. See {@link #getOwnerScope} for 
     * description on the attribute.
     * @param newValue New value to be set.
     */
    public void setOwnerScope(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.ScopeKind newValue);
    /**
     * Returns the value of reference owner.
     * @return Value of reference owner.
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmClassifier getOwner();
    /**
     * Sets the value of reference owner. See {@link #getOwner} for description 
     * on the reference.
     * @param newValue New value to be set.
     */
    public void setOwner(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmClassifier newValue);
}
