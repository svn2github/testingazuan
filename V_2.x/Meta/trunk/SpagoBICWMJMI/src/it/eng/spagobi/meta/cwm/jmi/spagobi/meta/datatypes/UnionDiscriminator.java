...
public interface UnionDiscriminator extends javax.jmi.reflect.RefAssociation {
     ...
     */
    public boolean exists(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmStructuralFeature discriminator, it.eng.spagobi.meta.cwm.jmi.spagobi.meta.datatypes.CwmUnion discriminatedUnion);
    /**
     ...
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmStructuralFeature getDiscriminator(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.datatypes.CwmUnion discriminatedUnion);
    /**
     ...
     */
    public java.util.Collection getDiscriminatedUnion(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmStructuralFeature discriminator);
    /**
     ...
     * @param discriminatedUnion Value of the second association end.
     */
    public boolean add(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmStructuralFeature discriminator, it.eng.spagobi.meta.cwm.jmi.spagobi.meta.datatypes.CwmUnion discriminatedUnion);
    /**
     ...
     * @param discriminatedUnion Value of the second association end.
     */
    public boolean remove(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmStructuralFeature discriminator, it.eng.spagobi.meta.cwm.jmi.spagobi.meta.datatypes.CwmUnion discriminatedUnion);
}
