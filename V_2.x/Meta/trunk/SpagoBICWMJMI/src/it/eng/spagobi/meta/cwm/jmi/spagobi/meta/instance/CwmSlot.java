 ...
 */
public interface CwmSlot extends it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmModelElement {
    /**
     * Returns the value of reference object.
     * @return Value of reference object.
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.instance.CwmObject getObject();
    /**
     * Sets the value of reference object. See {@link #getObject} for description 
     * on the reference.
     * @param newValue New value to be set.
     */
    public void setObject(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.instance.CwmObject newValue);
    /**
     * Returns the value of reference value.
     * @return Value of reference value.
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.instance.CwmInstance getValue();
    /**
     * Sets the value of reference value. See {@link #getValue} for description 
     * on the reference.
     * @param newValue New value to be set.
     */
    public void setValue(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.instance.CwmInstance newValue);
    /**
     * Returns the value of reference feature.
     * @return Value of reference feature.
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmStructuralFeature getFeature();
    /**
     * Sets the value of reference feature. See {@link #getFeature} for description 
     * on the reference.
     * @param newValue New value to be set.
     */
    public void setFeature(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmStructuralFeature newValue);
}
