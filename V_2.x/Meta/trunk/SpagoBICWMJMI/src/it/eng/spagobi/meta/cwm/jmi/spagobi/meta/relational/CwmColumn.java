 ...
 */
public interface CwmColumn extends it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmAttribute {
    /**
     ...
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.enumerations.NullableType getIsNullable();
    /**
     * Sets the value of isNullable attribute. See {@link #getIsNullable} for 
     * description on the attribute.
     * @param newValue New value to be set.
     */
    public void setIsNullable(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.enumerations.NullableType newValue);
    /**
     ...
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.CwmNamedColumnSet getOptionScopeColumnSet();
    /**
     * Sets the value of reference optionScopeColumnSet. See {@link #getOptionScopeColumnSet} 
     * for description on the reference.
     * @param newValue New value to be set.
     */
    public void setOptionScopeColumnSet(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.CwmNamedColumnSet newValue);
    /**
     * Returns the value of reference referencedTableType.
     * @return Value of reference referencedTableType.
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.CwmSqlstructuredType getReferencedTableType();
    /**
     * Sets the value of reference referencedTableType. See {@link #getReferencedTableType} 
     * for description on the reference.
     * @param newValue New value to be set.
     */
    public void setReferencedTableType(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.CwmSqlstructuredType newValue);
}
