 ...
 */
public interface CwmNamedColumnSet extends it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.CwmColumnSet {
    /**
     * Returns the value of reference optionScopeColumn.
     * @return Value of reference optionScopeColumn. Element type: {@link it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.CwmColumn}
     */
     ...
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.CwmSqlstructuredType getType();
    /**
     * Sets the value of reference type. See {@link #getType} for description 
     * on the reference.
     * @param newValue New value to be set.
     */
    public void setType(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.CwmSqlstructuredType newValue);
    /**
     * Returns the value of reference usingTrigger.
     * @return Value of reference usingTrigger. Element type: {@link it.eng.spagobi.meta.cwm.jmi.spagobi.meta.relational.CwmTrigger}
     */
