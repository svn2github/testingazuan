 ...
 */
public interface CwmMachine extends it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmNamespace {
    /**
     ...
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.softwaredeployment.CwmSite getSite();
    /**
     * Sets the value of reference site. See {@link #getSite} for description 
     * on the reference.
     * @param newValue New value to be set.
     */
    public void setSite(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.softwaredeployment.CwmSite newValue);
    /**
     * Returns the value of reference deployedComponent.
     * @return Value of reference deployedComponent. Element type: {@link it.eng.spagobi.meta.cwm.jmi.spagobi.meta.softwaredeployment.CwmDeployedComponent}
     */
