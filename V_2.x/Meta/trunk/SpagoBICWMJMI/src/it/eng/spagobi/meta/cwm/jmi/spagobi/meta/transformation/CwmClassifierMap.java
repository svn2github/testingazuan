 ...
 */
public interface CwmClassifierMap extends it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmNamespace {
    /**
     ...
     * @return Value of reference source. Element type: {@link it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmClassifier}
     */
     ...
     * @return Value of reference target. Element type: {@link it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmClassifier}
     */
     ...
     */
    public it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmNamespace getTransformationMap();
    /**
     * Sets the value of reference transformationMap. See {@link #getTransformationMap} 
     * for description on the reference.
     * @param newValue New value to be set.
     */
    public void setTransformationMap(it.eng.spagobi.meta.cwm.jmi.spagobi.meta.core.CwmNamespace newValue);
    /**
     * Returns the value of reference featureMap.
     * @return Value of reference featureMap. Element type: {@link it.eng.spagobi.meta.cwm.jmi.spagobi.meta.transformation.CwmFeatureMap}
     */
     ...
     * @return Value of reference cfMap. Element type: {@link it.eng.spagobi.meta.cwm.jmi.spagobi.meta.transformation.CwmClassifierFeatureMap}
     */
