 ...
 * <ul>
 *   <li>{@link it.eng.spagobi.meta.model.physical.emf.impl.PhysicalForeignKeyImpl#getFkName <em>Fk Name</em>}</li>
 *   <li>{@link it.eng.spagobi.meta.model.physical.emf.impl.PhysicalForeignKeyImpl#getPkName <em>Pk Name</em>}</li>
 *   <li>{@link it.eng.spagobi.meta.model.physical.emf.impl.PhysicalForeignKeyImpl#getFkColumns <em>Fk Columns</em>}</li>
 *   <li>{@link it.eng.spagobi.meta.model.physical.emf.impl.PhysicalForeignKeyImpl#getPkColumns <em>Pk Columns</em>}</li>
 *   <li>{@link it.eng.spagobi.meta.model.physical.emf.impl.PhysicalForeignKeyImpl#getPkTable <em>Pk Table</em>}</li>
 *   <li>{@link it.eng.spagobi.meta.model.physical.emf.impl.PhysicalForeignKeyImpl#getFkTable <em>Fk Table</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PhysicalForeignKeyImpl extends EObjectImpl implements PhysicalForeignKey {
	...
	protected EClass eStaticClass() {
		return EmfPackage.Literals.PHYSICAL_FOREIGN_KEY;
	}
	...
	public void setFkName(String newFkName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfPackage.PHYSICAL_FOREIGN_KEY__FK_NAME, oldFkName, fkName));
	}
	...
	public void setPkName(String newPkName) {
		...
		pkName = newPkName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfPackage.PHYSICAL_FOREIGN_KEY__PK_NAME, oldPkName, pkName));
	}
	...
	public EList<PhysicalColumn> getFkColumns() {
		if (fkColumns == null) {
			fkColumns = new EObjectResolvingEList<PhysicalColumn>(PhysicalColumn.class, this, EmfPackage.PHYSICAL_FOREIGN_KEY__FK_COLUMNS);
		}
		return fkColumns;
	}
	...
	public EList<PhysicalColumn> getPkColumns() {
		if (pkColumns == null) {
			pkColumns = new EObjectResolvingEList<PhysicalColumn>(PhysicalColumn.class, this, EmfPackage.PHYSICAL_FOREIGN_KEY__PK_COLUMNS);
		}
		return pkColumns;
	}
	...
	public PhysicalTable getPkTable() {
		if (pkTable != null && pkTable.eIsProxy()) {
			...
			if (pkTable != oldPkTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EmfPackage.PHYSICAL_FOREIGN_KEY__PK_TABLE, oldPkTable, pkTable));
			}
		}
		return pkTable;
	}
	...
	public void setPkTable(PhysicalTable newPkTable) {
		...
		pkTable = newPkTable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfPackage.PHYSICAL_FOREIGN_KEY__PK_TABLE, oldPkTable, pkTable));
	}
	...
	public PhysicalTable getFkTable() {
		if (fkTable != null && fkTable.eIsProxy()) {
			...
			if (fkTable != oldFkTable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EmfPackage.PHYSICAL_FOREIGN_KEY__FK_TABLE, oldFkTable, fkTable));
			}
		}
		return fkTable;
	}
	...
	public void setFkTable(PhysicalTable newFkTable) {
		...
		fkTable = newFkTable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfPackage.PHYSICAL_FOREIGN_KEY__FK_TABLE, oldFkTable, fkTable));
	}
	 ...
	 * @generated
	 */
	public void setFkColumns(EList<PhysicalColumn> fkColumns) {
	 ...
	 * @generated
	 */
	public void setPkColumns(EList<PhysicalColumn> pkColumns) {
		// TODO: implement this method
		// Ensure that you remove @generated or mark it @generated NOT
		throw new UnsupportedOperationException();
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfPackage.PHYSICAL_FOREIGN_KEY__FK_NAME:
				return getFkName();
			case EmfPackage.PHYSICAL_FOREIGN_KEY__PK_NAME:
				return getPkName();
			case EmfPackage.PHYSICAL_FOREIGN_KEY__FK_COLUMNS:
				return getFkColumns();
			case EmfPackage.PHYSICAL_FOREIGN_KEY__PK_COLUMNS:
				return getPkColumns();
			case EmfPackage.PHYSICAL_FOREIGN_KEY__PK_TABLE:
				if (resolve) return getPkTable();
				return basicGetPkTable();
			case EmfPackage.PHYSICAL_FOREIGN_KEY__FK_TABLE:
