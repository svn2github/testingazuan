		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BusinessView_columns_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BusinessView_columns_feature", "_UI_BusinessView_type"),
				 BusinessModelPackage.Literals.BUSINESS_VIEW__COLUMNS,
				 true,
				 false,
				 true,
				 null,
