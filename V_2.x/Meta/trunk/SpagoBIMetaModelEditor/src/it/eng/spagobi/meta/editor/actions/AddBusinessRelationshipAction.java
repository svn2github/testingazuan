 ...
 *
 */
public class AddBusinessRelationshipAction extends BusinessModelAction {

	public AddBusinessRelationshipAction(BusinessModelView businessModelView) {
		super(businessModelView);
		setText("Add Business Relationship");
		setToolTipText("Add Business Relationship");
