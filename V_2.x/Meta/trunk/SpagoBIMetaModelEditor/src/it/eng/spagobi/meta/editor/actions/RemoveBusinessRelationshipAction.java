 ...
 *
 */
public class RemoveBusinessRelationshipAction extends BusinessModelAction {

	public RemoveBusinessRelationshipAction(BusinessModelView businessModelView) {
	...
	public void run() {
		CoreSingleton.getInstance().getBusinessModel().getTables().remove(getTargetObject());
