...
/**
 * This is the primary key class for the sales_fact_dec_1998 table.
 * 
 */
@Embeddable
public class SalesFactDec1998PK implements Serializable {
...
public void setUnitSales (String unitSales) {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SalesFactDec1998PK)) {
			return false;
		}
		SalesFactDec1998PK castOther = (SalesFactDec1998PK)other;
		return 
