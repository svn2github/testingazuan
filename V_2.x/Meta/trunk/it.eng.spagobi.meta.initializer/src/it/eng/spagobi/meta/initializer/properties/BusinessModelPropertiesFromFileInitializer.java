 ...
 *
 */
public class BusinessModelPropertiesFromFileInitializer implements
		IPropertiesInitializer {
	...
	private void initModelProperties(BusinessModel o) {
		...
		try {
			...
			nodes = readXMLNodes(doc, "/properties/model/categories/category");
			...
			nodes = readXMLNodes(doc, "/properties/model/types/type");
			nodesLength = nodes.getLength();
	...
	private void initColumnProperties(BusinessColumn o) {
		...
		try {
			...
			nodes = readXMLNodes(doc, "/properties/column/categories/category");
			nodesLength = nodes.getLength();
	        for (int i = 0; i < nodesLength; i++) {
	        	NamedNodeMap nodeAttributes = nodes.item(i).getAttributes();
	        	if (nodeAttributes != null) {
			...
			nodes = readXMLNodes(doc, "/properties/column/types/type");
			nodesLength = nodes.getLength();
	        for (int i = 0; i < nodesLength; i++) {
	        	NamedNodeMap nodeAttributes = nodes.item(i).getAttributes();
	        	if (nodeAttributes != null) {
	        ...
	        nodes = readXMLNodes(doc, "/properties/column/typesValues/admissibleValuesOf");
			nodesLength = nodes.getLength();
	        for (int j = 0; j < nodesLength; j++) {
	        	NamedNodeMap nodeAttributes = nodes.item(j).getAttributes();
	        	if (nodeAttributes != null) {
