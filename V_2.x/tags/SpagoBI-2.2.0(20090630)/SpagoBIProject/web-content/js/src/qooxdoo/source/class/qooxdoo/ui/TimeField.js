 ...
 * </pre>
 */
qx.Class.define("qooxdoo.ui.TimeField",
{
  ...
  */
  ...
  construct : function()
  {
    ...
    //alert(qx.locale.Date.getDateFormat("short").toString() + ", "+currentDateFormat);
    this.setTimeFormat(new qx.util.format.DateFormat(currentTimeFormat));
  },
  ...
  members :
  {
    ...
    */
    ...
    setDate : function(date)
    {
      ...
      textField.setValue(this.getTimeFormat().format(date));
    ...
    getDate : function()
    {
      ...
      try {
        return this.getTimeFormat().parse(textfieldValue);
      } catch (e) {
        return null;
      }
    },
    ...
    setValue : function(value)
    {
      ...
      try
      {
        var date = this.getTimeFormat().parse(value);
    ...
    */
    ...
    _createChildControlImpl : function(id)
    {
      ...
      {
        case "list":
          control = new qooxdoo.ui.TimeChooser();
   ...
   */
    ...
    */
    _onChangeDate : function(e)
    {
      ...
      textField.setValue(this.getTimeFormat().format(selectedDate));
      this.close();
    },
    ...
    _onPopupChangeVisibility : function(e)
    {
      ...
      if (popup.isVisible())
      {
        ...
        chooser.setTime(this._getChildControl("textfield").getValue());
      }
    },
