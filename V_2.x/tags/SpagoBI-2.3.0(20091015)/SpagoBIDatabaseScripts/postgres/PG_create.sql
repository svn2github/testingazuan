...
Create table SBI_KPI (
	...
	ID_MEASURE_UNIT NUMERIC(38,0),
	DS_ID INTEGER,
	ID_KPI_PARENT NUMERIC(38,0),
	THRESHOLD_ID NUMERIC(38,0),
	...
	KPI_TYPE INTEGER,
	METRIC_SCALE_TYPE NUMERIC(38,0),
	MEASURE_TYPE NUMERIC(38,0),
...
Create table SBI_MEASURE_UNIT (
	...
	NAME VARCHAR (20),
	SCALE_TYPE_ID NUMERIC(38,0)  NOT NULL ,
	SCALE_CD VARCHAR (40),
...
Create table SBI_THRESHOLD (
	...
	THRESHOLD_TYPE_ID NUMERIC(38,0)  NOT NULL ,
...
Create table SBI_THRESHOLD_VALUE (
	...
	THRESHOLD_ID NUMERIC(38,0)  NOT NULL ,
	SEVERITY_ID NUMERIC(38,0),
	MIN_VALUE NUMERIC,
	MAX_VALUE NUMERIC,
	LABEL VARCHAR (20) NOT NULL,
	COLOUR VARCHAR (20),
...
Create table SBI_KPI_MODEL (
	...
	KPI_ID NUMERIC(38,0),
	KPI_MODEL_TYPE_ID NUMERIC(38,0)  NOT NULL ,
	KPI_PARENT_MODEL_ID NUMERIC(38,0),
...
Create table SBI_KPI_MODEL_ATTR (
	...
	KPI_MODEL_ATTR_TYPE_ID NUMERIC(38,0)  NOT NULL ,
...
Create table SBI_KPI_MODEL_ATTR_VAL (
	...
	KPI_MODEL_ATTR_ID NUMERIC(38,0)  NOT NULL ,
	KPI_MODEL_ID NUMERIC(38,0)  NOT NULL ,
	VALUE VARCHAR (2048),
...
Create table SBI_KPI_INST_PERIOD (
  ...
  KPI_INSTANCE_ID NUMERIC(38,0) NOT NULL,
  PERIODICITY_ID NUMERIC(38,0) NOT NULL,
...
Create table SBI_KPI_MODEL_INST (
	...
	KPI_MODEL_INST_PARENT NUMERIC(38,0),
	ID_KPI_INSTANCE NUMERIC(38,0),
	NAME VARCHAR (400),
...
Create table SBI_RESOURCES (
	...
	RESOURCE_TYPE_ID NUMERIC(38,0)  NOT NULL ,
...
Create table SBI_ALARM (
	...
	ID_KPI_INSTANCE NUMERIC(38,0)  NOT NULL ,
	MODALITY_ID NUMERIC(38,0)  NOT NULL ,
...
ALTER TABLE SBI_KPI_MODEL ADD CONSTRAINT AK_FK_SBI_KPI_MODEL_TEMPLATES_1 UNIQUE (KPI_MODEL_CD);
