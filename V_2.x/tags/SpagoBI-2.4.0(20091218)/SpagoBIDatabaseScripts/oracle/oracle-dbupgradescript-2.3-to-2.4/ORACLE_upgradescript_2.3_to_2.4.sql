...
ALTER TABLE SBI_OBJECTS DROP  DESCR_EXT
/
ALTER TABLE SBI_OBJECTS DROP  OBJECTIVE
/
ALTER TABLE SBI_OBJECTS DROP  LANGUAGE
/
ALTER TABLE SBI_OBJECTS DROP  KEYWORDS
/
