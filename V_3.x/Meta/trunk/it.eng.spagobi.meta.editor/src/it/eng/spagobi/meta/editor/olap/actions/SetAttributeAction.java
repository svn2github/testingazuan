 ...
 *
 */
public class SetAttributeAction extends AbstractSpagoBIModelAction {
	 ...
	 * @param selection
	 */
	public SetAttributeAction(IWorkbenchPart workbenchPart,
			ISelection selection) {
		super(RemoveMeasureCommand.class, workbenchPart, selection);
