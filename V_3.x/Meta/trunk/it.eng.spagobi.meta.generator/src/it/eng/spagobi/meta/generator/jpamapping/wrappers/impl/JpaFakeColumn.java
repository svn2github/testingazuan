...
/**
 * Used to generate mapping also for columns that does not exist as business 
 * column in the real model. Useful to add behind the scenes some columns 
 * that are required in the mapping for technical reasons. For example columns
 * used in JpaViewInnerRelationship but not added by the user to the BusinessView
 * itself.
 * 
 * @see 
 * 
