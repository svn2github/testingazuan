...
public final class ArtifactServiceProxy extends AbstractServiceProxy{
    ...
    private it.eng.spagobi.services.artifact.stub.ArtifactService lookUp() throws SecurityException {
	try {
	...
	try {
	    return lookUp().getArtifactContentByNameAndType(readTicket(), userId, name, type);
	} catch (Exception e) {
