...
public class MondrianMeasure implements IMondrianMeasure {
	...
	/* (non-Javadoc)
	 * @see it.eng.spagobi.meta.generator.mondrianschema.wrappers.IMondrianMeasure#getName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see it.eng.spagobi.meta.generator.mondrianschema.wrappers.IMondrianMeasure#getColumn()
	 */
	@Override
