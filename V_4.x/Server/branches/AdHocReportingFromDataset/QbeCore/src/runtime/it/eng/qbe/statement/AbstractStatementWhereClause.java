...
public abstract class AbstractStatementWhereClause extends AbstractStatementFilteringClause {
	 ...
	 * 
	 * @return a string representing the where clause part of the statement. 
	...
	private String buildUserProvidedCondition(WhereField whereField, Query query, Map entityAliasesMaps) {
		...
		try {
			...
			conditionalOperator =  getOperator(whereField.getOperator() );
	...
	public String fixWhereClause(String whereClause, Query query, Map entityAliasesMaps) {
		StringBuffer buffer;
