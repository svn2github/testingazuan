...
CREATE TABLE SBI_DATA_SET_DEPENDENCIES (
       SOURCE_DS_ID         INTEGER NOT NULL,
       TARGET_DS_ID         INTEGER NOT NULL,  
       PRIMARY KEY (SOURCE_DS_ID, TARGET_DS_ID)
) ;\p\g
...
ALTER TABLE SBI_DATA_SET_DEPENDENCIES ADD CONSTRAINT FK_SBI_DATA_SET_DEPENDENCIES_1 FOREIGN KEY ( SOURCE_DS_ID ) REFERENCES SBI_DATA_SET ( DS_ID ) ON DELETE RESTRICT;\p\g
ALTER TABLE SBI_DATA_SET_DEPENDENCIES ADD CONSTRAINT FK_SBI_DATA_SET_DEPENDENCIES_2 FOREIGN KEY ( TARGET_DS_ID ) REFERENCES SBI_DATA_SET ( DS_ID ) ON DELETE CASCADE;\p\g
