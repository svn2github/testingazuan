...
ALTER TABLE SBI_OBJECTS MODIFY COLUMN LABEL VARCHAR(100) NOT NULL;\p\g
ALTER TABLE SBI_AUDIT MODIFY COLUMN DOC_LABEL VARCHAR(100) NOT NULL;\p\g

ALTER TABLE SBI_DATA_SET_HISTORY ADD COLUMN PERSIST_TABLE_NAME VARCHAR(50) NULL;\p\g