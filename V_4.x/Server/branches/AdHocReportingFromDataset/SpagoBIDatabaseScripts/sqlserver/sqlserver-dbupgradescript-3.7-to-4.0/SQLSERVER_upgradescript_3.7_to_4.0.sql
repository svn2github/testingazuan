...
ALTER TABLE SBI_DATA_SET_HISTORY ADD IS_PERSISTED BIT DEFAULT 0;
ALTER TABLE SBI_DATA_SET_HISTORY ADD DATA_SOURCE_PERSIST_ID INTEGER NULL;
ALTER TABLE SBI_DATA_SET_HISTORY ADD IS_FLAT_DATASET BIT DEFAULT 0;
ALTER TABLE SBI_DATA_SET_HISTORY ADD FLAT_TABLE_NAME VARCHAR(50) NULL;
...
ALTER TABLE SBI_OBJECTS ALTER COLUMN LABEL VARCHAR(100) NOT NULL;
ALTER TABLE SBI_AUDIT ALTER COLUMN DOC_LABEL VARCHAR(100) NOT NULL;

ALTER TABLE SBI_DATA_SET_HISTORY ADD PERSIST_TABLE_NAME VARCHAR(50) NULL;