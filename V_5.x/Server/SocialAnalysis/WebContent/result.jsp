...
%>
	...
	<div id="tabs">
		<ul>
	    	...
	    	<li><a href="#tabs-topics">Topics</a></li>
	    	<li><a href="#tabs-network">Network</a></li>
	    	<li><a href="#tabs-distribution">Distribution</a></li>
	
	  	</ul>

		<div id="container">
   			<div class="content">
        		<a name="tabs-summary" id="tabs-summary"></a>
        	...
        	<div class="content">
        		<a name="tabs-topics" id="tabs-topics"></a>
        	...
        	<div class="content">
        		<a name="tabs-network" id="tabs-network"></a>
        	...
        	<div class="content">
        		<a name="tabs-distribution" id="tabs-distribution"></a>
