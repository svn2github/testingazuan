{type:"class",attributes:{"name":"IconHtmlEmbed","hasWarning":"true","packageName":"qx.ui.embed","superClass":"qx.ui.embed.HtmlEmbed","childClasses":"qx.ui.listview.ContentCellIconHtml","fullName":"qx.ui.embed.IconHtmlEmbed","type":"class"},children:[
  ...
  {type:"properties",children:[
    {type:"property",attributes:{"apply":"_applyHtml","defaultValue":"\"\"","propertyType":"new","name":"icon","check":"String"},children:[
      {type:"desc",attributes:{"text":"<p>Any <span class=\"caps\">URI</span> String supported by qx.ui.basic.Image to display a icon</p>"}}
      ]},
    {type:"property",attributes:{"apply":"_applyHtml","defaultValue":"0","propertyType":"new","name":"iconHeight","check":"Integer"},children:[
      {type:"desc",attributes:{"text":"<p>The height of the icon\n If configured, this makes qx.ui.embed.IconHtmlEmbed a little bit faster as it does not need to wait until the image loading is finished.</p>"}}
      ]},
    {type:"property",attributes:{"apply":"_applyHtml","defaultValue":"0","propertyType":"new","name":"iconWidth","check":"Number"},children:[
      {type:"desc",attributes:{"text":"<p>The width of the icon.\n If configured, this makes qx.ui.embed.IconHtmlEmbed a little bit faster as it does not need to wait until the image loading is finished.</p>"}}
      ]},
    {type:"property",attributes:{"apply":"_applyHtml","defaultValue":"4","propertyType":"new","name":"spacing","check":"Number"},children:[
      {type:"desc",attributes:{"text":"<p>Space in pixels between the icon and the <span class=\"caps\">HTML</span>.</p>"}}
      ]}
    ]}
  ]}