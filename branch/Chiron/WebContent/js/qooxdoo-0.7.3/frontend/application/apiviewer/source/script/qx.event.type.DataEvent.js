{type:"class",attributes:{"name":"DataEvent","hasWarning":"true","packageName":"qx.event.type","superClass":"qx.event.type.Event","fullName":"qx.event.type.DataEvent","type":"class"},children:[
  {type:"desc",attributes:{"text":"<p>Event object for data transfers.</p>"}},
    ...
    {type:"method",attributes:{"isCtor":"true","name":"ctor"},children:[
      {type:"params",children:[
        ...
        {type:"param",attributes:{"name":"vData"},children:[
          {type:"desc",attributes:{"text":"<p>additional data which should be passed to the event listener</p>"}},
          {type:"types",children:[
  ...
  {type:"properties",children:[
    {type:"property",attributes:{"hasError":"true","oldProperty":"true","name":"data","propertyType":"fast"},children:[
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"5","line":"69"}}
        ]}
      ]},
