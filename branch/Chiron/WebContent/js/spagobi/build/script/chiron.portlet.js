...
$2.setEdge(0);
var $6=new qx.ui.pageview.buttonview.Button("Save",
"spagobi/img/spagobi/test/save.png");
var $7=new qx.ui.pageview.buttonview.Button("Delete",
"spagobi/img/spagobi/test/delete.png");
var $8=new qx.ui.pageview.buttonview.Button("New",
"spagobi/img/spagobi/test/create.png");
$2.getBar().add($8,
$6,
$7);
this._form=$5;
$3=new qx.ui.pageview.buttonview.Button("",
"");
$3.setDisplay(false);
$3.setChecked(true);
this.detailBody=new qx.ui.pageview.buttonview.Page($3);
this.detailBody.add(this._form);
$2.getPane().add(this.detailBody);
this.addBottom($2);
},
...
var $2=[];
var $3={};
for(var $4=0;$4<$1.meta.length;$4++){$2[$4]=$1.meta[$4].dataIndex;
$3[$1.meta[$4].dataIndex]=$1.meta[$4].name;
...
members:{setData:function($0){var $1=[];
var $2={};
for(var $3=0;$3<$0.meta.length;$3++){$1[$3]=$0.meta[$3].dataIndex;
