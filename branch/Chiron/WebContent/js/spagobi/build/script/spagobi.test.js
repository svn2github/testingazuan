...
this._tableView.getTableModel().setDataAsMapArray(this._dataObjects,
true);
this._tableView.getSelectionModel().setSelectionInterval(0,
0);
},
...
var $1=new qx.ui.splitpane.HorizontalSplitPane(100,
"1*");
$0.add($1);
var $2=new qx.ui.splitpane.VerticalSplitPane("1*",
"2*");
$2.setEdge(0);
$2.setBorder("line-left");
$1.addRight($2);
...
var $3=new qx.ui.pageview.buttonview.Button("Save",
"spagobi/img/spagobi/test/save.png");
var $4=new qx.ui.pageview.buttonview.Button("Delete",
"spagobi/img/spagobi/test/delete.png");
var $5=new qx.ui.pageview.buttonview.Button("New",
"spagobi/img/spagobi/test/create.png");
this._buttonView.getBar().add($5,
$3,
$4);
...
$2.addBottom(this._buttonView);
var $6=new qx.ui.layout.VerticalBoxLayout();
$6.setSpacing(5);
var $7=new qx.ui.form.Button("",
"spagobi/img/spagobi/test/save.png");
var $8=new qx.ui.form.Button("",
"spagobi/img/spagobi/test/delete.png");
var $9=new qx.ui.form.Button("",
"spagobi/img/spagobi/test/create.png");
$6.add($7);
$6.add($8);
$6.add($9);
...
saveData:function(){var $0=this.form.getData();
var $1='';
for(prop in $0){$1+=prop+': '+$0[prop]+";\n";
}alert($1);
},
createSaveButton:function(){saveButton.addEventListener("execute",
this.saveData,
this);
return saveButton;
},
createDeleteButton:function(){backButton.addEventListener("execute",
function(){alert('go back');
});
return backButton;
},
_loadDataObject:function(){this._dataObjects=[{id:'135',
"label":'JASPER',
...
getDataObjects:function(){return this._dataObjects;
},
selectDataObject:function($0){this._form.setData($0);
},
reload:function(){alert('reload');
},
showAbout:function(){alert('showAbout');
},
showPreferences:function(){alert('showPreferences');
},
showAddFeed:function(){alert('showAddFeed');
},
showRemoveFeed:function(){alert('showRemoveFeed');
},
...
this._controller);
var $6=new qx.ui.toolbar.Button(this.tr("Add feed"),
"icon/16/actions/dialog-ok.png");
$6.setCommand($4);
this.add($6);
var $7=new qx.ui.toolbar.Button(this.tr("Remove feed"),
"icon/16/actions/dialog-cancel.png");
$7.setCommand($5);
this.add($7);
this.add(new qx.ui.toolbar.Separator());
var $8=new qx.ui.toolbar.Button(this.tr("Reload"),
...
this.add($8);
this.add(new qx.ui.toolbar.Separator());
var $9=new qx.ui.toolbar.Button(this.tr("Preferences"),
"icon/16/apps/preferences.png");
$9.setCommand($3);
$9.setToolTip(new qx.ui.popup.ToolTip(this.tr("Open preferences window.")));
this.add($9);
...
this._tableModel.setColumnIds(["description",
"name",
"id"]);
this._tableModel.setColumnNamesById({description:this.tr("Description"),
name:this.tr("Name"),
id:this.tr("ID")});
arguments.callee.base.call(this,
this._tableModel,
...
var $2=this._controller.getDataObjects();
if($1>=0){var $3=this.getTableModel().getRowData($1);
if($3){this._controller.selectDataObject($3);
}}}}});
