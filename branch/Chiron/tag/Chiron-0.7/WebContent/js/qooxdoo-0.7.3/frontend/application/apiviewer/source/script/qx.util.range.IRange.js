{type:"class",attributes:{"name":"IRange","packageName":"qx.util.range","implementations":"qx.util.range.Range","fullName":"qx.util.range.IRange","type":"interface"},children:[
  {type:"desc",attributes:{"text":"<p>The interface for a range manager</p>"}},
  ...
  {type:"properties",children:[
    {type:"property",attributes:{"name":"max","propertyType":"new"},children:[
      {type:"desc",attributes:{"text":"<p>maximal value of the Range object</p>"}}
      ]},
    {type:"property",attributes:{"name":"min","propertyType":"new"},children:[
      {type:"desc",attributes:{"text":"<p>minimal value of the Range object</p>"}}
      ]},
    {type:"property",attributes:{"name":"value","propertyType":"new"},children:[
      {type:"desc",attributes:{"text":"<p>current value of the Range object</p>"}}
      ]},
    {type:"property",attributes:{"name":"wrap","propertyType":"new"},children:[
