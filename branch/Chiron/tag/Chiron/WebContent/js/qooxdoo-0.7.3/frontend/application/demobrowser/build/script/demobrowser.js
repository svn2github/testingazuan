$=["","qx.client","Boolean","auto","qx.event.type.Event","solid","undefined","Integer","String","left","string","100%","right","border-dark-shadow","none","mousedown","top","Number",';',"bottom","completed",",","mouseup","mshtml","hidden","singleton","failed","horizontal","gecko","execute","width","set",".","middle","vertical","height","qx.event.type.DataEvent","scroll","=","object","aborted","timeout","1*","border-light","sending","keydown","0","pressed",'computed=this.',"abstract","0px","function","px","receiving"," ","default","/","(\\d\\d?)","number","center","abandoned","style","white",":","&",")","mousemove",'=value;',"over","selected","keypress","load","other","on","absolute",'this.',"Function","boolean","div","_","minWidth","maxWidth","outset","active","background","Left","mouseover","overflow","Right","inset","Enter","click",";","borderTopWidth","maximized","configured",'</span>',"effect","borderLeftWidth","interval","-","maxHeight","minHeight","position","init",'"',"frame","qx.event.type.MouseEvent","]","?","qx.ui.core.Widget","Color","Object","CSS1Compat","(","checked","error","off","qx.io.remote.Response","no","icon","scrollY","Space",'if(this.',"yes","locationX",'}',"shorthand","dblclick","*","reset","treeview.full","wide","Up","abbreviated","\n","|","test","opera","toolbar.playall","scrollX","locationY","get","inherit",'delete this.',"mouseout","Down","unstyle","Theme","border-light-shadow","fixed","short","body","border-dark","created","unload","both",'!==undefined)',"treeview","PageUp","keyup","input","appear","dark-shadow","qx.ui.table.pane.CellEvent","label","translucent","ie4+","changeSelection","button","text-field","filter","text","</span>","'","refresh","webkit","fontSize","gray","$","Home","groove","NumLock","qx.ui.popup.ToolTipManager","barBottom","qx.ui.menu.Manager","marginTop","narrow","A","khtml","display","marginLeft","barTop","dragging","qx.ui.menu.Menu","disappear",'</div>',"PageDown","iframe","1px","End","+","qx.event.type.DragEvent","modelLink","qx.ui.popup.PopupManager","dotted","qx.event.type.FocusEvent","list","changeValue","double","_applyIcon","%","overflowX","overflowY","contextmenu","Escape",'return this.','else if(this.',"long","}","qx.event.type.KeyEvent","dashed","normal","qx.resourceUri","static/image/blank.gif","outset-thin","black","inset-thin","text-selected","lineHeight","ridge","queued","resize","outputviews.bar","hand","sym","_applyResizable","field",'!==undefined){',"ms","marginBottom","outputviews.demopage.page","50%","Control","Unidentified","hour","Delete","paddingTop","9","widget","barLeft","left-reversed","cellClick","wildcard","this.","id","paddingLeft","barRight","transparent","Tahoma","mousewheel","bold","literal","_pane","top-reversed","Meta","_timer","Liberation Sans","depth","marginRight","minimized",'=true;',"middle-reversed","qx.event.type.ChangeEvent","center-reversed",'old=this.',"changeEnabled","Lucida Grande","paddingBottom","Tab","Alt",')',"text-disabled","color","Bitstream Vera Sans",": ","button-abandoned","focus","PrintScreen","full",'modelLink',"opaque","qx.ui.popup.ToolTip","border-box","null","_applyClip","textAlign","paddingRight","window-captionbar-button","Shift","treeview.flat","blur","safari2","Verdana","Pause","_labelObject","a","_applyText","beforeunload","border","_applyChecked","_table","menu.appearance","Insert","col-resize","date-chooser-title","_element","100px","F2","focusin","qx.io.remote.ScriptTransport","_applyLabel","parent","medium","toolbar.runbutton","down","list-view-content-cell-text","dragover","visibilityChanged","date-chooser","dragenter","_applyName","qx.ui.embed.IframeManager","justify","Scroll","F5","qx.ui.selection.RadioManager","px;","outputviews","HHmmss","toolbar.profile","static","qx.ui.table.selection.Model","Ready","changeShow","focusout","widthChanged","HH:mm:ss",'","',"#","qx.io.remote.XmlHttpTransport","only_plus","-moz-scrollbars-vertical","toolbar.nextbutt","  ","Array",">","filled","table-header-border","Apps","Label","(\\d\\d?\\d?)","-moz-scrollbars-horizontal","changeLocale","visibility","n-resize","textarea","toolbar","Win","_applyTextAlign","{","menu-button","g","changeState",'typeof value === "number" && isFinite(value)',"pointer","button-view-pane","qx.io.remote.IframeTransport","_iconObject","atom","CheckBox","lastChild","Backspace"," }","row-resize","only_minus","_applyEnabled","qx.ui.form.Button","underline","qx.event.handler.DragAndDropHandler","</div>","Z","qx.ui.core.Parent","_frame","tree-folder","menu.profile",'\n',"=''","^","outputviews.demopage.button","[",'",value);','',"widgets","_applyState","<","html","qx.client.NativeWindow","Classic","Profile","e-resize","zIndex","Connection dropped","Separator","s","monospace","_childrenQueue","MozOutline","_compute"," Demo Browser ","F1","addAtEnd","treeClose","appearances","removeAll","cursor","tab-view-pane","_paneScroller","indexOf","_applyShowCellFocusIndicator","cldr_day_","qx.application.Gui","table-header","Content-Type","addAfter","Button","win","1px dotted invert","qqstr","nw-resize","ellipsis","character","columnVisibilityMenuCreateEnd","__states","__init$","complete","qx.ui.table.columnmodel.Basic","tab-view-button","_applyOpen","fontStyle","&lt;","value","styleTop","plus","F12","dragleave","log","borderBottomWidth","onscroll","_applyValue","Type","qx.ui.table.columnmodel.resizebehavior.Abstract","list-view-content-cell","_layout","visibilityChangedPre","ident",'">',"mshtml|webkit","F3","tab-view-border","8",":content-box;","6","up","meta","./resource","gecko|opera|webkit","outputviews.sourcepage.page","keyword","padding","nocache","tabIndex","_manager","changeSelected","F11","opacity","qx.ui.embed.Flash","lead","cldr_month_","_applyPosition","styleRight","KhtmlOpacity","_resizeColumnData","outline","styleLeft","~","Windows","F4","7","windowresize","_applySource",":border-box;","no-cache","barVertical","MozUserSelect","line","F10","backgroundRepeat","clipHeight","changeScrollY","italic","_invalidate","treeview.bsb1",'  </div>',"colorRight","Assertion Failure","_applySelected","Pragma","fontWeight",'if(old===computed)return value;',"KhtmlUserSelect","noComputed","4","]);","remove","dragstart",'else ',"end",'<span class="objectBox-number">',"removeChild","treeOpenWhileEmpty","button-view-bar","colors","changeSource","alignLeft","tree-element-label","fullcomment",'tree',"treeOpenWithContent",'";',"colorBottom","changeChecked","5","fri","F6","tree-folder-icon","spinner-button","modelChanged","DOMMouseScroll","widthBottom","addAt","changeOpen","changeFocused",'undefined',"CapsLock","_statusBar","#FCE1D8","drag","qx.allowUrlSettings","cross","whiteSpace","first","qx.io.image.Preloader","toggle","colorTop","nl","qx.jsonDebugging","disabled","2","F7","changeCapture","-khtml-box-sizing","add","]\n","borderRightWidth","MozOpacity","header","0 none","qx.theme.ClassicRoyale","popup","qx.enableAspect","Cache-Control","ne-resize","static/image/dotted_white.gif","Object Summary","margin","z","request","_recompute","focused","table-pane","dragdrop","3","F8","&#","sec","_applyManager","(a[","backgroundImage","qx.io.remote.AbstractRemoteTransport","text/css","qx.allowUrlVariants","file:","alignRight",'px;',"day","F9","quoted_literal","hasComputed","tableWidthChanged",'Z',"minus","min","styleBottom","widthRight","before","_applyMenu","verticalScrollBarChanged","dragexit","toString","clipTop","qx.ui.pageview.AbstractPage","tree","lazyopaque"," messages removed)",'" ',"boxSizing","anchor",'.$$properties.',"qx.log.appender.Native","button-view","Full Tree","addBefore","fonts",'if(computed===undefined)computed=null;',"textDecoration","_applyElement","qx.ui.pageview.AbstractButton","draggesture","fontFamily","'>",'a',"widthTop","Margin","v","&amp;","wed",":constructor","__font","sat","event","qooxdoo ","1","Padding","<br>","demobrowser/image/package18.gif","icons","addAtBegin","backgroundColor","qxkey",'z',"editing","theme","qx.client.Command","_blocker","cellDblclick","tooltip-text","innerText","barHorizontal","concat","tooltip","qx.core.Object",'!(',"textContent","resizer","orderChanged","_objects","node","menu","ignore",'(',"__user$","mon","readonly","return this.","qx.ui.window.Window","head","()","qstr","qx.ui.window.Manager","cellContextmenu","ss","thu","tree-folder-label","slice","tree-element-icon","qx.io.remote.Exchange","table-header-cell","qx.event.handler.FocusHandler","WebkitUserSelect","qx.ui.table.IRowRenderer","qx.io.remote.Request","removeAt",".html","clipLeft",'@import "',"Element","borders","linecomment","userSelect","tue","();","widthLeft","sun","clipWidth",'if(old===undefined)old=null;',"widget/arrows/down.gif","All","qx.ui.table.ITableModel","_applyOrientation","colorLeft","-1000px","lastIndexOf","list-view-header-border","_applyDimension","table-focus-indicator","tree-element","qx.ui.table.pane.Model"," [",'example/Atom_1.html','~',"\r\n","qooxdoo-table-cell","Run the next sample","menu-button-arrow","_focusHandler","_applyTablePaneModel",'m',"Border",'    * { box-sizing: border-box; -moz-box-sizing: border-box; -webkit-box-sizing: border-box }',"_applyActive","_valueOriginalTarget","demobrowser.DemoBrowser","pre","_applyMaxColumnCount","h","javascript:void(0)","qx.util.Normalization","Linux","_applyTimeoutInterval","borderBottomStyle","Run the previous sample","Font","icon/16/apps/graphics-snapshot.png","font-size: 11px;","qx.ui.menu.CheckBox","resizableEast","_applyCursor","qx.Interface","__storage","qx.ui.tree.TreeFolder","qx.ui.table.model.Abstract","f1",'value !== null && window.document',"icon/16/places/www.png","GMT","?qxvariant:qx.aspects:off&qx.enableAspect:false",'    <input id="marker" type="button" value="Add divider"/> &#160; &#160; Filter: <input name="filter" id="filter" type="text" value="',"_colToXPosMap","qx.ui.form.TextField",')a[i].',"_applyFocusRoot","_applySplitterSize","<div class='version'>qooxdoo ","qx.ui.table.ICellRenderer","_applyAllowClose","Not implemented","localeCompare","status",'{0,1}[0-9]{3}){0,})','    html, body, input, pre{ font-size: 11px; font-family: Tahoma, sans-serif; line-height : 1 }','var inherit=prop.$$inherit;',"Not modified","_applyLocale","styleFloat","_image","Next Sample","_ScriptTransport_data","button-view-button",'_cmdSampleInOwnWindow',"pixelBottom","menu-layout"," (nightly)","cldr_time_format_","_cachedVisibleChildren","_selectionManager","table-editor-textfield","nowrap",'_indentObject',"qx.html.Dimension","_applyFont","Use getValue() instead!","_applySpacing","Macintosh","_hideTimer"," - ","progress","yy","list-view-header","_sortMethods","Gray() Alpha(Opacity=30)","toolbar.sampbutts","__inherit$","yyyy","Alpha(Opacity=0)","changeBorderTheme",'_cmdNextSample','&gt;',"Use removeHtmlProperty instead",'\\\\',"_applySize","icon/16/actions/go-right.png","resizableNorth","_box","qx.core.Aspect.__calibrateHelper","qx.core.Log.debug","this.removeStyleProperty('padding","unkown","Partial content","qx.application.IApplication","MacPPC","quote","key_short_CapsLock","qx.ui.table.columnmodel.resizebehavior.Default","changeTableModel","Print","qx.application","_applyColorBottom"," &nbsp;","qx.ui.splitpane.SplitPane","__onload","  padding : 0px 6px;","qx.Class","columnVisibilityMenuCreateStart","qx.logAppender","qx.event.handler.EventHandler","Win32","qx.iconTheme","forEach","button-view-page","1.0","qx.ui.menu.Separator",'  <div id="control">',"autoComplete","_iframe",' is not (yet) ready!");',"changeElement","key_full_Meta","(measure start) ","progid:DXImageTransform.Microsoft.AlphaImageLoader(src='","_horizontalLayout","Height","qx.version","treeview.bsb2","qx.log.appender.Window",'y',"modal","(\\d\\d(\\d\\d)?)","_layoutChanges","changeParent","px; width:","_applyMarginBottom","_applySelectable","_applyPreloader","Flat tree view (only one level of containers)","radio-view-button-checked","qx.bom.element.Dimension","tab-view-button-checked","_captionTitle","_colors","cursor:","line-left","key_short_Delete","extend","Pixel","_applyBackgroundImage","demobrowser.Application","((\\+|\\-)\\d\\d:?\\d\\d)","f2","SS","qx.ui.menu.MenuLayoutImpl","n","logger",'M',"changeTextColor","borderBottom",'computed=value;',"qx.boxModelCorrection","scrollbars"," WARN:  ",'Does not allow any arguments!','return value;','\\f'," DEBUG: ","change","_columnVisibilityBt","changeAnonymous","key_short_NumLock","qx.locale.Manager",'_cmdObjectSummary',"key_short_Left","Demo","_scrollerParent","toolbar-button","qx.io.image.Manager","OmniWeb","<pre>","kk","_applyMinHeight","[^\\.0-9]","key_short_Right","qx.ui.table.ICellEditorFactory","See other",'!',"-webkit-box-sizing",'_treeRowStructureFields',"ws","tree-icon","_data_","_showTimer","qx.ui.basic.Inline","line-through","table-row-background-selected","..","_list",";position:relative;height:",'if(!clazz.$$propertiesAttached)qx.core.Property.attach(clazz);',"changeActiveChild","_columnIndexMap","cldr_number_group_separator","U",']._autoCloseWindow()}catch(e){}">',"_applyShowInterval","var a=arguments[0] instanceof Array?arguments[0]:arguments;","qx.theme.classic.color.Royale","SSS","C","Bad gateway",':','value !== null && value.$$type === "Mixin"',"Global Namespace Pollution","_applyBoundToWidget","icon/16/places/folder.png","NaN","&nbsp;","split","_applyBackgroundRepeat","Log window message: Starting error recording, any errors below this line will prevent the log window from closing",'=computed;',"qx.ui.popup.Popup","qx.locale.Key","qx.util.format.NumberFormat","list-view","qx.ui.menubar.MenuBar","qx.ui.table.rowrenderer.Default","qx.io.Alias","_captionBar","<hr/>","_applyBottom","qx_NativeWindow","menubar","Ctrl-O","changeResizeMethod",":constructor wrapper","_closeTimer","_applyRootOpenClose","HTTP version not supported",'value !== null && value.$$type === "Interface"',"qx.Mixin","_applyBorder","beforeAppear","font-family: 'Segoe UI', Corbel, Calibri, Tahoma, 'Lucida Sans Unicode', sans-serif;","_applyFirstColumnX","changeText","_applyRight","Use qx.Class.define instead","__cache","_check","window-inactive-caption-text","o","_indentObject","_applyMetaColumnCounts","<img style=\"position:absolute;top:0px;left:","qx.ui.layout.BoxLayout","_applyMaxHeight","Galeon","force","after","  position: absolute;","userFocus","widget/splitpane/knob-horizontal.png","widget/arrows/up.gif","parentPaddingBottom","qx.lang.Generics","qx.ui.basic.ScrollBar","key_short_End","warn","window-captionbar",'D',"changeLeadItem",'  <div id="lines">',"client-document-blocker","changeBehavior","push","qx.core.Log.error","qx.log.DefaultFilter","hh","list-view-border","key_full_Win","Log window message: Stopping error recording, discarding ","key_full_Up","key_full_PrintScreen","_selectedItems","hasOwnProperty","qx.ui.basic.Image","_applyFrameName","qx.ui.table.pane.Scroller","list-view-header-cell-hover","_atom","_icons","Play All","Request-URL too large","_spacer","ttree","demobrowser","Not acceptable","toolbar-part-handle-line","radio-view-bar",'typeof value === "number" && isFinite(value) && value%1 === 0',"Infinity","_knob",'!(value instanceof ','value !== null && qx.theme.manager.Font.getInstance().isDynamic(value)',"qx.html.Scroll","changeIcon","html,body { margin:0;border:0;padding:0; } ","Log","icon/16/actions/view-pane-tree.png","_applyMaxCacheLines","_applyStretchChildrenOrthogonalAxis","_openTimer","Show last results","qx.ui.pageview.AbstractBar"," !important","-Infinity","_lastMouseDownDispatchTarget","key_full_Control",'(backup);',"_applyFirstSize","[Mixin ","Tabulator","__all","parseerror","_applyFocused","lines","qx.ui.tree.Tree",'if(computed===inherit){',"<div class='script'>The sample source will be displayed here.</div>","qx.log.Filter","_scrollBar","key_full_Down","Connection closed by server","native","key_full_Alt","PgDn","demobrowser/css/sourceview.css","tab","_applyScrolling","borderTop",'<body onload="qx = opener.qx;" onunload="try{qx.log.WindowAppender._registeredAppenders[',"sort","verticalAlign","qx.dev.Tokenizer",'  </style>',"safari","scrollbar-blocker","this.length = 0;","_applyPaddingTop","_tableModel","qx.ui.core.Font","qx.ui.layout.impl.LayoutImpl","qx.locale.Number",';}',"qooxdoo Demo Browser","qx.deprecationWarnings","qx.fontTheme","Server error","\\\"","unshift","Ins","menu-check-box","Dispose Demo","tab-view-bar",'!==undefined&&',"iconSelected","getFirstActiveChild","qx.core.Log.info","Null","changeFont","_applyOverflow","<span>","radio-view-pane",'<iframe name="','value instanceof Date',"/static","qx.ui.table.IHeaderRenderer","static/html/blank.html","borderLeftStyle",'_cmdRunSample',"__convertBoolean","window-captionbar-restore-button","qx.aspects","widgetLinkFlat",'if((computed===undefined||computed===inherit)&&','character',":00","_applyHideInterval","_applyReadOnly","BODY","Bitstream Vera Sans Mono",'(value);',"Value",'left:',"<span class='ident'>","changeHtml",' <span class="keyword">',"qx.OO","changeColorTheme"," errors have been recorded, keeping log window open.</b>","a=qx.lang.Array.fromShortHand(qx.lang.Array.fromArguments(a));","(passed time: ",">>> ",'_labelObject','<span class="objectBox-function">',"last","_resetRuntime",'\\u00',"_handle","qooxdoo","splitpane-knob","Moved temporarily","one of one row","_paneClipper","_applyButton","qx.ui.table.Table","_columnDataArr",'    hr { border: 0 none; border-bottom: 1px solid #ccc; margin: 8px 0; padding: 0; height: 1px }',"Del",'\\r',"scrolling","key_full_Space","substring","_history","qx.ui.pageview.tabview.TabView","#D6D5D9","[object Error]","qx.ui.pageview.buttonview.ButtonView","match",'#',"https://",'width:',"Ctrl-Right","icon/16/status/folder-open.png","S",'value !== null && value.$$type === "Class"',"qx.util.format.DateFormat","_applyAutoSync","other webkit","  at ",'typeof value === "string" && qx.util.ColorUtil.isValid(value)',"key_short_Backspace","Sample Global Pollution","__",'var a=this.getChildren();if(a)for(var i=0,l=a.length;i<l;i++){',"qx.ui.layout.impl.VerticalBoxLayoutImpl","qx.log.appender.HtmlElement"," qooxdoo-table-cell-bold",'h',"debug","_applyAppearance","_blockerNode","_styleProperties","_applyOpacity","qx.html.Offset","widget/window/restore.gif","reverseChildrenOrder",",height=","qxvariant",'if(mixins[i].$$constructor){mixins[i].$$constructor.apply(this,arguments);}}}',"Alpha(Opacity=","check-box-group-box-legend","viewer","<div style='float:left;width:","([a-zA-Z]+)","charAt","m","_applyBorderTheme","line-bottom","qx.ui.table.cellrenderer.Default","qx.ui.pageview.buttonview.Button","\\$1","parentPaddingRight","_applyZIndex","')","tab-view-button-hover","_format","_aliases","check-box","_applyOpenInterval","This method call is no longer needed.","window","px\" src=\"",'var backup=computed;',"_applyPaddingLeft",".gif","qx.core.LegacyProperty","true","_lastUpDownType",'for(var i=0,l=mixins.length;i<l;i++){',"_applyFontTheme","Please use getKeyIdentifier() instead.","_applyTabIndex",'if(this.classname===',"start_plus","changeAppearance","qx.debug","resizable",'if(value!==inherit)',"key_short_Scroll","qx.net.Http",'if(a[i].',"_width","(!this.",';-moz-user-select:none;',"font-size:","MSXML2.XMLHTTP.4.0","qx.locale.LocalizedString","Tests","qx.ui.menubar.Button","changeBackgroundColor","changeRight","[Interface ","_applyTableColumnModel","please use getText() instead.","_translationCatalog","one row","static/stringbuilder/helper.html","qx.theme.manager.Color","_restoreButton","splitpane-slider","_captionFlex","borderTopStyle","stylesheet","__useinit$","changeModal",'Undefined value is not allowed!',"Interface","window-statusbar","changeDataRowRenderer","qx.bom.element.Style","qx.ui.table.selection.Manager",'\\b','Is invalid!',"colorInnerBottom","items","netnewswire","qx.ui.layout.HorizontalBoxLayout","qx.theme.classic.Widget","': ","&gt;","client-document","borderRightStyle","changeMoveMethod","X-Qooxdoo-Response-Type","key_short_Space","widget/cursors/copy.gif","Ranges:",'</span></td>',"widget/menu/checkbox.gif","_markerBtn","ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=","_applyMaxLength","toolbar.prevbutt","Firefox","-moz-box-sizing","img","_showTimeStamp","  text-overflow:ellipsis;","table-menubar-button","qx.lang.Core","_htmlAttributes",'" style="','){',"qx.minLogLevel","anonymous: ","Previous Demo","MozBoxSizing"," (#","changeScrollX","Use getUseDoubleClick instead","_closeButtonImage","_columnIdArr","MMMM","_applyAllowMaximize","width: ","0.0","info","__convertNumber","  white-space:nowrap;","__onmouseevent","table-row-background-focused-selected","Profiling Data","key_full_Scroll","=((v==null)?0:v)+'px'","_valueDomEvent","qx.io.remote.RequestQueue","__modifier","_applyColorInnerBottom","qx.ui.table.pane.FocusIndicator","_applyVerticalScrollBarVisible","qx.ui.toolbar.CheckBox","_applyLeft","Next Demo","tests","_applyAnchorItem",'style="',"_borderElement","tool-tip","[object ","_maximizeButton","qx.appearanceTheme","Server timeout","__onwindowblur","clip","Mozilla","Log window message: <b>Note: ","_applyCloseInterval",'</span></td></tr>',"javascript:/","/widget/Windows",'var prop=qx.core.Property;',"changeBottom","/html/","width=500,height=250,dependent=yes,resizable=yes,status=no,location=no,menubar=no,toolbar=no,scrollbars=no",'<table>',"widget/table/selectColumnOrder.png","bold-large","icon/16/actions/view-refresh.png","_applyCloseButtonImage","qx.ui.resizer.IResizable","beforeDisappear","cldr_number_percent_format",'if(clazz.$$includes){var mixins=clazz.$$flatIncludes;',"_layoutImpl","_applyShowCloseButton","_cached",'<span class="selectorId">#',')prop.error(this,5,"',"qx.theme.manager.Icon","Spin out Sample",'<div class="',"_applyLeadItem","Windows Royale","qx.core.Version","Num","toLocaleUpperCase","return this.join('');",'\", "','<span class="html-tag-name">',"&nbsp;&nbsp;","Width","qx.theme.manager.Border","widget/window/minimize.gif","pixelWidth","_applyVerticalChildrenAlign","qx.log.Logger","__convertObject","key_full_PageDown","_applyWrap","pixelRight","  [not readable: ","key_full_Escape","2*","ae","explorer","_computed","_applyShowClose","Avg Time","tab-view","_applyTheme","0x","__key",'_cmdDisposeSample',"_requestHeaders"," ms) ","_applyPage",'w',"omniweb","icon/16/actions/media-playback-start.png","changeMenu","))","_sampleToTreeNodeMap",'!==inherit){',"changeBarPosition","qx.ui.table.celleditor.TextField","changeTheme","qx.eventMonitorNoListeners","key_short_Insert","Classic Royale",'X',"_applyHoverItem","getLastActiveChild","widget/menu/radiobutton.gif",'value !== null && (qx.locale.Manager.getInstance().isDynamic(value) || typeof value === "string")',"_fields","icon/16/actions/dialog-cancel.png","_applyIconWidth","_lastMouseEventDate","_applyBehavior","_queue","_applyGlobalCursor","_applyStyleBottom","MaxWidth","image","valueOf","_applyInterval","galeon","_applyStatusBarVisible","_titles","join","removeDom","qx.ui.resizer.MResizable",'d',"Courier New","demobrowser.resourceUri","qx.html.StyleSheet","_appenderArr","AppleWebKit","Legacy properties are deprecated","Use setHtmlProperty instead","_remappingChildTable","k","about:blank","qx.ui.core.ClientDocument","qx.util.manager.Object","qx.ui.table.pane.Header","right-reversed","toolbar-part-handle",'<div style="max-width:200px">',"other gecko","form","qx.util.Compare","KK","qx.ui.basic.Atom","Percent","window-captionbar-icon","_applyBackgroundColor","combo-box-button","_applyCaption","qx.colorTheme","http://",'.classname)this.$$initialized=true;',"menu-radio-button","_applyResponseType","widget/arrows/next.gif","_valueData",'else{',"key_full_Enter","_focusIndicator","_selectedRangeArr","qx.core.Init","_applyHorizontalChildrenAlign","Ae",'<span class="selectorTag">',"Conflict",'#lines { width: 100%; height: expression((document.body.offsetHeight - 30) + "px"); }',"map","O","__theme$","_applyShowMaximize","Call Count","icon/16/actions/go-left.png",'value !== null && value.nodeType !== undefined',"\\.[^\\.]+$","_filterArr",'></iframe>',"widget/window/close.gif","<span class='comment'>","key_short_Home","rgb(",'computed=undefined;delete this.',"RealPlayer","icon/16/actions/view-pane-text.png","key_full_PageUp","icon/16/actions/media-seek-forward.png","font-style:","qx.core.Log.assert","_applyMarginTop","end_minus","Microsoft.XMLHTTP",'return retval;',"_parseRules","_applyVisibility",'if(computed===undefined||computed===inherit){',"_topRightWidget","splice",'<p style="margin:4px 0;padding:0">',"<h1>","  height: 100%;","_parseFeed","_applyMaxWidth","demobrowser.TreeDataHandler",'typeof value === "string"',"table-row-background-odd","Demo Browser","divider-vertical","static/history/helper.html","changeZIndex","qx.theme.classic.font.Default",'if(value!==null)',"background-color:",'>',"--- Object: ","application/x-www-form-urlencoded",'typeof value === "string" && value.length > 0',"_applyActiveWindow",'&gt;</div><div class="nodeChildren">',"Unknown status code",'&lt;\/?','<div>',"key_","create","Not available","_inlineEvents",")+;)|[^&","_applyIconTheme","_applyWidthRight","qx.lang.Object","_window","key_short_PageDown","  top: 0px;","key_full_Tab","<span class='string'>",'throw new Error("Property ',"_columnNameArr",'value !== null && qx.theme.manager.Border.getInstance().isDynamic(value)',"MacIntel","No content","changeMode","_applyFocusHandler","qx.core.Log.log","Top","qx.core.Log.warn","command","__convertString","</div><span style='float:left'>&hellip;</span>",".qooxdoo-table-cell-italic {","_applyMnemonic","This method is no longer needed since the event object is now an instance of the Response class.","_applyDisplay","_document","windowblur","_attachedWidget","qx.ui.tree.SelectionManager","_applyTableModel","cldr_am","__user$excludeSpecificTreeLines","start_minus","_applyShowStatusbar","_header","mozBoxSizing","%1 of %2 rows",'name="',"form_","qx.dom.String","ue",'_cmdLoadProfile',"_applyHtml","unix","changeFontTheme",'<span class="objectBox-null">',"Source Code","body {}","type","search","key_short_Down","qx.core.Aspect","window-active-caption"," errors.","mac","qx.ui.core.Border",'Requires exactly one argument!',"_divDataSets","widget/window/maximize.gif",'if(value===null)prop.error(this,4,"',"qx.ui.tree.TreeRowStructure","_widget","Flat Tree","</pre>","Parsed","_previousParentFolder","qx.bom.Document",'H','Basic ',"qx.ui.toolbar.ToolBar","html/welcome.html","_applySelectionModel",'<html><body><div id="state">',"location","window-captionbar-maximize-button",'value !== null && value.$$type === "Theme"',"key_short_Tab","_lastKeyCode",'    pre { margin: 0; padding: 4px 8px; font-family: Consolas, "Bitstream Vera Sans Mono", monospace; }',"MSIE","EE","Forbidden","qx.html.Entity","_applyCaptureWidget","anonymous","Reload","_lastMouseDown",'</span>=&quot;<span class="nodeValue">',"cssFloat","toolbar-part",'Referer','!(value && qx.Class.hasInterface(value.constructor, ',"real","Sample","qx.ui.basic.Label","changeVerticalScrollBarVisible","qx.ui.basic.ScrollArea","Use getUseTreeLines instead","[Theme ","runbutton","_rowArr","Proxy authentication required","qx.ui.popup.PopupAtom","beforeInsertDom","_applyAutoCloseWithErrors","M","qx.io.image.PreloaderSystem","Use getHideNode instead","qx.locale.Date","qx.html.EventRegistration","_innerStyle","icon/16/actions/document-new.png","verticalChildrenAlign","qx.html.Window","please use setText() instead.",")+>)|(&([^;]|","qx.bom.element.Location","Ue","_applyMode","_applyStyleRight",'===value)return value;',"-1","Object is null","<html><head><title>","_splitter","=[not readable: ","Bad request","end_plus"," in method "," qooxdoo-table-cell-right","i","qx.ui.basic.Terminator","_applyColorRight","_iframeNode","_applyWidthBottom",'if(value===undefined)prop.error(this,2,"',"#FEF0D2","_oldParent","key_short_Up","_applyItalic","widget/splitpane/knob-vertical.png","qx.ui.pageview.tabview.Bar","Ctrl-Left","key_full_Insert",'value=this.',"_statusText","splitpane-splitter","_formFields","toolbar=no,scrollbars=no,resizable=yes,","widget/cursors/move.gif",'<span class="objectBox-selector">',"Appearance","_minimizeButton","qx.ui.selection.SelectionManager","_active","qx.ui.tree.AbstractTreeElement","  text-align:right","MSXML2.XMLHTTP.3.0","_applyHideFocus","progid:DXImageTransform.Microsoft.Shadow(color='Gray', Direction=135, Strength=4)","qx.ui.embed.HtmlEmbed","_applyShowKnob","bottom-reversed","commandLine","_applyImplementation","qx.core.Log.dir","qx.core.MUserData",'value instanceof RegExp',"_logEventQueue","qx.event.type.DomEvent","<pre>Could not execute json: \n","__ondragevent","_valueOldValue","_applyLoaded","())","_applyParent","qx.jsonEncodeUndefined","qx.core.Variant","qx.core.Target",'<div ',"&quot;",'K',"qx.net.HttpRequest","/source/class/","_applyFirstVisibleRow","__listeners","beforeRemoveDom","<span style=\"text-decoration:underline\">","frame_","_applyMarginLeft","Request entity too large",'k',"qx.html.Location","Gecko","qx.log.LogEventProcessor","_closeButton","pixelTop","&#39;","_applyBarPosition",' of an instance of ',"_firstArea","qx.theme.classic.Border","text-decoration:","_applyShow",'E',"_applyFocusedChild",'<div class="objectBox-element">',"changeWidth","HHmmsszz","widget/table/ascending.png","widget/cursors/alias.gif",'</span>=<span class="string">',"_parentLogger","resizer-frame",'    #lines{ top: 30px; left: 0; right: 0; bottom: 0; position: absolute; overflow: auto; }',"dependent","qx.lang.Array","_applyColorLeft",'</div><div class="objectBox-element">&lt;/<span class="nodeTag">',"close","#134275 url(","_fontStyle","qx.ui.splitpane.SplitPaneSplitter","toLocaleLowerCase","changeFocusedChild","KDE","_children","Esc","qx.ui.splitpane.SplitPaneKnob","_horScrollBar","qx.ui.pageview.tabview.Pane","__applyPlayAll","_applyMethod","_modify","qx.ui.pageview.tabview.Page","</title></head>","every","\\\\","addChild","qx.ui.table.columnmodel.Resize","changeValidator","_slider","mm",'s',"qx.util.Mime","  border-bottom:1px solid #eeeeee;",'<td class="propertyNameCell"><span class="propertyName">',"__convertFunction","_change","box-sizing","_applyIconPosition","table-row","changeDisplay","d","_applyWidth","_applyColorInnerRight",'/&gt;</div>',"changeMaxHeight","Consolas","qx.locale.MTranslation","changeMinHeight",'return null;',"unselectable","Caps","qx.ui.layout.CanvasLayout","_remappingChildTarget","_applyWidgetTheme",".qooxdoo-table-cell {","html { border:0 none; } ",'\\n',"_locale","dir","', ((v==null)?0:v)+'px')"," Welcome","_value","qx.preloaderTimeout","changeShowCloseButton",'html/',"shift","qx.theme.manager.Appearance","toolbar.controlbutts","_editableColArr","parentPaddingLeft","org.w3c.dom.svg","Current stack trace","qx.ui.pageview.buttonview.Pane",'Null value is not allowed!',"table-focus-statusbar",'<iframe onload="parent.qx.ui.embed.Iframe.load(this)"',"HH:mm:ss zz","changeTableColumnModel","pixelLeft","qx.util.StringBuilder","file://","qx.event.handler.KeyEventHandler","key_full_Shift","qx.client.History","Request time-out","_arrowObject","key_full_NumLock"," with incoming value '","menu-separator","key_full_End","link",'Could not change or apply init value after constructing phase!',"new Date(Date.UTC(","__convertUndefined"," &#160;","qxsetting","orientation","changeOverflow","qx.ui.toolbar.Part","__stateMap","keyinput",'value instanceof Function',"_htmlProperties","...","__intervalHandler","qx.ui.menu.ButtonLayoutImpl","_req","qx.log.appender.FireBug","icon/16/actions/media-playback-stop.png","K","_valueCurrentTarget","qx.core.Log.dirxml","dragend","__oninput","_applySpellCheck","window-statusbar-text","width=","toLowerCase",'<span class="objectBox-string">&quot;',"key_full_Delete"," of class ",") top left repeat-x","_tablePane","cross_plus","_applyMinWidth","\" />","Multiple choices","  -o-text-overflow: ellipsis;","Win64","changeIconTheme","_applyCommand","/icon/Nuvola","menu-separator-line","HHmm","Run Sample","w","qx.ui.menu.Button","qx.html.Iframe",".qooxdoo-table-cell-right {","_applySelectionMode","PgUp",'Authorization',"icon/16/apps/accessories-alarm.png",'", computed, old);',"borderRight",",top=","_applyAlignTabsToLeft","MSXML2.XMLHTTP.6.0","widget/cursors/nodrop.gif","_resizeLine","1px 0",'value !== null && typeof value === "object"',"changeSelectionModel",'value instanceof Array',"qx.ui.splitpane.HorizontalSplitPane",'_cmdNamespacePollution',"_applyAlwaysShowPlusMinusSymbol",'<tr>',"changeWindowManager","__visible","qx.ui.layout.impl.HorizontalBoxLayoutImpl","key_full_Apps","Global Pollution","_filterTextWords",",left=","qx_log_","_applyTextColor",'&nbsp;<span class="nodeName">',"e","_applyColorInnerTop","_overallColumnArr","utf-8","_applyMaximum","} ","MozUserFocus","qx.theme.manager.Widget","demobrowser.Tree","_applyMarginRight","MSHTML-specific HTTP status code","_applyStyleLeft",'</div></body></html>',"Flex","key_full_Pause","demobrowser/image/colorstrip.gif","cldr_date_format_","nativewindow","font-family:",'var computed, old=this.',"_applyHeight","_applyKeepFirstVisibleRowComplete","qx.core.Log","_lastMouseEventType","qx.theme.icon.Nuvola",'    html, body{ padding: 0; margin: 0; border : 0 none; }',"_modalNativeWindow","window-captionbar-close-button","_isErroneous","[Class ","_applyWidthTop","_style","changeLeft","_valueDomTarget","Ctrl","changeTop","changeAnchorItem","__onselectevent","Payment required","font-weight:","firstChild","_bar",'</span>&quot;',"qx.ui.resizer.ResizablePopup",'<span class="objectBox-object">',"this.setStyleProperty('padding","windowfocus","BSD","qx.core.Log.clear","qx.ui.menu.Layout","changeMoveable","_applyFocusCellOnMouseMove","qx.Theme","icon/16/actions/system-run.png","gif","Date","_tableColumnModel","_applyHideNode","_applyUseTreeLines","_valueValue","Moved permanently","_applyShortcut","</h1>","changeStatus","_applyScrollTimeout","qx.ui.toolbar.MenuButton"," qooxdoo-table-cell-italic","icon/16/apps/accessories-magnifier.png","_captionIcon","H","_parameters",'&quot;</span>',"_applyColumnVisibilityButtonVisible","qx.util.Validation","qx.util.ColorUtil","_valueTarget","tree1","-resize","Open Sample in Own Window","borderLeft","cross_minus","qx.ui.pageview.AbstractPane","key_short_Alt","changeActive","No target to insert tests","horizontalChildrenAlign"," INFO:  ","_applyShowCaption","_applyTop","qx.dom.Element","icon/16/mimetypes/text-ascii.png","script","Profile Running Sample","changeGlobalCursor","key_short_PrintScreen","HH","icon/16/actions/edit-redo.png","toUpperCase",'var pa=this.getParent();if(pa)computed=pa.',"table-row-selected",'_cmdProfile',"_dynamic"," logRow-",".qooxdoo-table-cell-bold {","reverse","cldr_date_time_format_","changeTablePaneModel","changeHeight","qx.util.format.Format","X-Requested-With","return this.length === 0;","qx.theme","qx.ui.selection.Selection","insertDom","oe","_applyFamily","qx.ui.table.model.Simple","key_short_Enter","stretchChildrenOrthogonalAxis","empty","_ScriptTransport_","window-captionbar-minimize-button","qx.borderTheme",'value !== null && value.type !== undefined',"table-row-background-focused","Error: Could not get a reference to the sheet object","%1 rows",'value !== null && value.nodeType === 1 && value.attributes',"Not found",'value !== null && typeof value === "object" && !(value instanceof Array) && !(value instanceof qx.core.Object)',"_applyShowMinimize","Start","EEE","changeRowHeight","qx.ui.embed.Iframe","_applyShowIcon",'(computed, old);','</table>',"qx.ui.pageview.AbstractPageView","is",'()</span>','value !== null && value.nodeType === 9 && value.documentElement',"Gone","replace","#FFEEEE","_applySecondSize","Unauthorized","changeCaption","_applyPaddingBottom","qx.ui.pageview.buttonview.Page","_visibleColumnArr",".apply(this._remappingChildTarget, arguments)","You can only specify one non modifier key!","_registry","EEEE","closetab","*{","toolbar.sobutt","qx.ui.toolbar.PartHandle","  font-weight:bold","qx.log.MLogging","(\\d\\d)",'old=computed=this.',"_applyAllowMinimize","_applyColorTheme","qx.ui.menu.RadioButton","qx.core.Client","MSXML2.XMLHTTP","qx.ui.pageview.buttonview.Bar","qx.theme.manager.Meta","changeSpacing","key_short_Apps","key_short_Win","_applyIconHeight",'&lt;<span class="nodeTag">',"shiira",'===undefined)return;',"_applyActiveChild","substr","Use proxy","MaxHeight",'<span class="selectorClass">.','\\t',"_modalWidgets",'([0-9]{1,3}(?:',"  cursor:default;","qx.dom.Node","firefox","cldr_pm","changeVisibility","colorInnerTop","realplayer","demobrowser/image/class18.gif","px;overflow:hidden;white-space:nowrap'>","splitpane","_lastMouseDownDomTarget","_isPng","_applyUseAdvancedFlexAllocation","dirxml","qx.ui.table.columnmodel.resizebehavior.ColumnData","_applyUrl","tmap"," ---\n","  overflow:hidden;","qx.html.String",'))',"button-hover","_filterInput","key_full_Home","cldr_number_decimal_separator","qx.ui.table.headerrenderer.Default",'var retval=clazz.$$original.apply(this,arguments);',"camino",'    #control { top: 0; left: 0; right: 0; padding: 4px 8px; background: #eee; border-bottom: 1px solid #ccc; height: 30px }',"qx.ui.core.ClientDocumentBlocker"," ERROR: ","widget/arrows/down_small.gif","divider-horizontal",'class="',"_top","u",'<ul style="margin:4px 0;padding:0">',"activeX","qx.client.Timer","_valueRelatedTarget","[object Object]","qx.lang.Function",'<div style="width:200px">',"Out of resources",'_cmdPrevSample',"<span class='","qx.dev.StackTrace","qx.core.Setting","line-right","Liberation Sans Mono","Own Time","_applyModal","_globalCursorStyleSheet","_line",'\\"',"widget/table/descending.png"," (","children","Oe","/static/log/log.html","Method not allowed","line-height: ","_applyAppearanceTheme","content-box","Ok",'if(',"MMM","int",'<ol style="margin:4px 0;padding:0">','value instanceof Error','anonymous',"Unsupported media type","#F1FBF3","key_full_Left","qx.core.Property","Full tree view","table-row-background-even","Precondition failed","Ctrl-Shift-P","Debug","overflow: hidden;","__borderObject","_form","Load demos with profiling","Error in property ","_verScrollBar","Reset column widths","_applyProhibitCaching","MinWidth","this._style.","_applyExcludeSpecificTreeLines","tree-label","_applyStyleTop","?qxvariant:qx.aspects:on&qxsetting:qx.enableAspect:true","getFirstChild","marker",'"></iframe>',"window-captionbar-title"," (r","qx.io.Json","Gateway time-out","resizableSouth",'else if(computed===undefined)',"qx.core.Log.timeEnd","dd","_hideTimeStamp","qx.widgetTheme","__formatTree","spacing","example","X-Qooxdoo-Version",'<div class="script">',"-moz-scrollbars-none",'else this.',"\n</pre>","visible","Bottom","initial","qx.core.Log.time","colorInnerLeft","large","_applyOpenItem"," FATAL: ","Safari","hideFocus","<div style='",'A',"_applyDisabledIcon","_applyPaddingRight","_columnVisibilityMenu","changeBorder","Previous Sample","MM",'&gt;</span></div>',"en",'S',"__userData","00","Sample Object Summary","Length required","_applyWidthLeft","--- End of object ---","qx.isSource","_applyVisibleRowCount","_logLinesDiv","logRow",'var clazz=arguments.callee.constructor;',"_inputElement","__onwindowresize","window-active-caption-text","demobrowser/image/method_public18.gif","changeMinWidth","_applyHorizontalScrollBarVisible",'var computed, old;',"Run/reload selected sample",'}else{',"_secondArea","_isCreated",'<td><span class="propertyValue">',"window-inactive-caption","qx.util.manager.Value","qx.core.Bootstrap","toLocaleString","_shortcutObject","parentPaddingTop","horizontalAlign","qx.enableApplicationLayout","_jobQueue","key_short_Escape","some",'</body></html>',"_containerObject","widget/arrows/up_small.gif","qx.ui.toolbar.Button","Not a valid key name for a command: ",'typeof value === "boolean"',"changeDirection","Mixin","charCodeAt","qx.theme.classic.Appearance","])*)(","qx.lang.Number",'\\d+){0,1}',"box","',sizingMethod='scale')","[\xE4\xF6\xFC\xDF\xC4\xD6\xDC]","changeTabIndex","qx.lang.String","qx.ui.table.pane.Pane","_renderRuntime","_applyCapture","_appender",'.checkMap[value]===undefined','.check.call(this, value)',"Nuvola","overline","getLastChild","qx.html.ScrollIntoView","key_short_Meta","_applyReverseChildrenOrder",'([-+]){0,1}',"key_short_PageUp","key_short_Pause","  font-style:italic","_applyDecoration","qx.widgetDebugId","widgetLinkFull","rect(","colorInnerRight","_isLoaded","_applyCurrentToolTip","_items","__onwindowfocus","resizableWest","qx.ui.layout.VerticalBoxLayout","_headerClipper","_applyPlaceBarOnTop","konqueror","Auto","table-header-cell-hover","pop","BackgroundImageCache","isPrototypeOf","X11","demobrowser/css/style.css",'_iconObject','_cmdShowLastProfile',"Open in own window","NetNewsWire","qx.compatibility","_applyColorInnerLeft","  border-right:1px solid #eeeeee;","icon/32/actions/help-contents.png","^(((<([^>]|","qx.bom.Viewport","tab-view-page","key_full_Right","url(","img{","_ScriptTransport_id","key_full_Backspace","_applyBold","_applyStatus","changeWidgetTheme",'    <pre id="log" wrap="wrap"></pre>',';color:','this.createDispatchChangeEvent("',"script/demodata.js","_applyColorTop","html,body{width:100%;height:100%;overflow:hidden;}","changeOpenMenu","qx.log.appender.Abstract","qx.ui.table.cellrenderer.Abstract","qx.html.Style","_scrollContent","Run all examples","qx_srcview","__manager","Samples","qx.locale.Locale","_checkValue","useAdvancedFlexAllocation","return this._remappingChildTarget.","changeHorizontalScrollBarVisible","changeOrientation","HH:mm","pixelHeight","key_short_Shift","qx.ui.pageview.tabview.Button","__oninterval","key_short_Control","qx.ui.basic.HorizontalSpacer","Shiira","qx.theme.manager.Font","changeMaxWidth","MinHeight","key_full_CapsLock","qx.ui.splitpane.SplitPaneSlider","qx.io.image.PreloaderManager","Camino","state","qx.ui.layout.impl.CanvasLayoutImpl","qx.ui.tree.TreeFile","mainsplit","_commands","logappender",'  <style type="text/css">','<div class="nodeText">',"changeAppearanceTheme"];if(!window.qxsettings)qxsettings={};
if(qxsettings["qx.resourceUri"]==undefined)qxsettings["qx.resourceUri"]="./resource/qx";
if(qxsettings["demobrowser.resourceUri"]==undefined)qxsettings["demobrowser.resourceUri"]="./resource/demobrowser";
...
/* ID: qx.lang.Core */
qx.Class.define($[1299]);
if(!Error.prototype.toString||Error.prototype.toString()==$[1165]){Error.prototype.toString=function(){return this.message;
};
...
__init:function(){if(window.qxsettings){for(var $0 in qxsettings){if(($0.split($[32])).length<2){throw new Error('Malformed settings key "'+$0+'". Must be following the schema "namespace.key".');
}
if(!this.__settings[$0]){this.__settings[$0]={};
...
__loadUrlSettings:function(){if(this.get($[558])!=true){return;
}var $0=document.location.search.slice(1).split($[64]);
for(var $1=0;$1<$0.length;$1++){var $2=$0[$1].split($[63]);
if($2.length!=3||$2[0]!=$[1853]){continue;
}var $3=$2[1];
if(!this.__settings[$3]){this.__settings[$3]={};
}this.__settings[$3].value=decodeURIComponent($2[2]);
}}},
defer:function($0){$0.define($[558],
false);
$0.define($[601],
false);
$0.define($[223],
...
for(var $1=0;$1<$0.length;$1++){var $2=$0[$1].split($[63]);
if($2.length!=3||$2[0]!=$[1197]){continue;
}var $3=$2[1];
...
if($1.indexOf($[136])<0){$3=this.get($0)===$1;
}else{var $4=$1.split($[136]);
for(var $5=0,
...
__isValidArray:function($0){return typeof $0===$[39]&&$0!==null&&$0 instanceof Array;
},
__isValidObject:function($0){return typeof $0===$[39]&&$0!==null&&!($0 instanceof Array);
},
...
defer:function($0){$0.define($[1235],
[$[73],
$[117]],
$[73]);
$0.define($[2340],
...
wrap:function($0,
$1,
$2){if(!qx.core.Setting.get($[580])){return $1;
}var $3=[];
var $4=[];
for(var $5=0;$5<this.__registry.length;$5++){var $6=this.__registry[$5];
if($0.match($6.re)&&($2==$6.type||$6.type==$[129])){var $7=$6.pos;
if($7==$[615]){$3.push($6.fcn);
}else{$4.push($6.fcn);
}}}
...
$1,
$2,
$3){if($0!=$[615]&&$0!=$[997]){throw new Error("Unknown position: '"+$0+"'");
}this.__registry.push({pos:$0,
type:$1,
re:$2,
fcn:$3});
}},
defer:function(){qx.core.Setting.define($[580],
false);
}});
...
$8=$8.substring(0,
3)+$[32]+$8.substring(3);
$d=$1.indexOf($[1624])!==-1?$[23]:$1.indexOf($[1344])!==-1?$[28]:null;
}else if(typeof $2===$[10]&&$2===$[1770]&&/KHTML\/([0-9-\.]*)/.test($1)){$7=$[189];
$6=$[2328];
$8=RegExp.$1;
}else if($1.indexOf($[1447])!=-1&&/AppleWebKit\/([^ ]+)/.test($1)){$7=$[176];
$8=RegExp.$1;
$e=$8.indexOf($[201])!=-1;
var $g=RegExp($[919]).exec($8);
if($g){$8=$8.slice(0,
$g.index);
}
if($1.indexOf($[2234])!=-1){$6=$[1084];
}else if($1.indexOf($[915])!=-1){$6=$[1407];
}else if($1.indexOf($[2383])!=-1){$6=$[2101];
}else if($1.indexOf($[2339])!=-1){$6=$[1275];
}else if($1.indexOf($[1501])!=-1){$6=$[2117];
}else{$6=$[1177];
}
if($e){$6+=$[792];
}}else if(window.controllers&&typeof $3===$[10]&&$3===$[1738]&&/rv\:([^\);]+)(\)|;)/.test($1)){$7=$[28];
$8=RegExp.$1;
if($1.indexOf($[1293])!=-1){$6=$[2113];
}else if($1.indexOf($[2390])!=-1){$6=$[2138];
}else if($1.indexOf($[995])!=-1){$6=$[1436];
}else{$6=$[1459];
}}else if(/MSIE\s+([^\);]+)(\)|;)/.test($1)){$7=$[23];
$8=RegExp.$1;
$6=$[1394];
$5=!window.external;
}
...
var $i=document.compatMode!==$[113];
var $j=$[2245];
var $k=($7==$[23]?navigator.userLanguage:navigator.language).toLowerCase();
var $l=null;
var $m=$k.indexOf($[100]);
...
var $q=false;
var $r=false;
if($4.indexOf($[496])!=-1||$4.indexOf($[846])!=-1||$4.indexOf($[1886])!=-1){$o=true;
$n=$[436];
}else if($4.indexOf($[803])!=-1||$4.indexOf($[830])!=-1||$4.indexOf($[1556])!=-1){$p=true;
$n=$[1599];
}else if($4.indexOf($[2334])!=-1||$4.indexOf($[748])!=-1||$4.indexOf($[1973])!=-1){$q=true;
$n=$[1588];
}else{$r=true;
$n=$[72];
}var $s=false;
...
var $v=false;
if($7==$[23]){$s=true;
}if(document.implementation&&document.implementation.hasFeature){if(document.implementation.hasFeature($[1828],
$[850])){$t=$u=true;
}}this._runsLocally=$0;
this._engineName=$7;
this._engineNameMshtml=$7===$[23];
this._engineNameGecko=$7===$[28];
this._engineNameOpera=$7===$[138];
this._engineNameKhtml=$7===$[189];
this._engineNameWebkit=$7===$[176];
...
}if(!$1.hasOwnProperty($[883])&&!$1.type){$1.type=$[341];
}{};
...
genericToString:function(){return $[1955]+this.classname+$[108];
},
...
}if($3.init!==undefined){$0.prototype[$[444]+$5]=$3.init;
...
var $5;
if($2===$[25]){$4.getInstance=this.getInstance;
}$4.$$original=$0;
$0.wrapper=$4;
return $4;
}},
...
genericToString:function(){return $[1059]+this.name+$[108];
},
__registry:{},
__allowedKeys:null,
__validateConfig:function(){}}});
...
genericToString:function(){return $[1251]+this.name+$[108];
},
__registry:{},
...
destruct:function(){this._disposeFields($[2247]);
}});
...
var $6=$[31]+$3;
var $7=$[418]+$3;
$1[$4]=typeof $0.defaultValue!==$[6]?$0.defaultValue:null;
...
var $5=$[418]+$3;
var $6=$[1793]+$3;
if(typeof $0.defaultValue!==$[6]){$1[$4]=$0.defaultValue;
}$1[$[142]+$3]=function(){if(this[$4]==null){this[$4]=this[$5]();
}return this[$4];
};
$1[$[511]+$3]=function(){if(this[$4]!=null){this[$4]=null;
if($0.addToQueueRuntime){this.addToQueueRuntime($0.name);
}}};
$1[$[588]+$3]=function(){var $7=this[$4];
var $8=this[$5]();
if($8!=$7){this[$4]=$8;
this[$6]($8,
$7);
...
$1[$[142]+$3].self=$1.constructor;
$1[$[511]+$3].self=$1.constructor;
$1[$[588]+$3].self=$1.constructor;
},
addProperty:function($0,
$1){qx.log.Logger.deprecatedMethodWarning(arguments.callee,
$[1448]);
if(typeof $0!==$[39]){throw new Error("AddProperty: Param should be an object!");
}
if(typeof $0.name!==$[10]){throw new Error("AddProperty: Malformed input parameters: name needed!");
}if($0.dispose===undefined&&($0.type==$[51]||$0.type==$[39])){$0.dispose=true;
...
}else if(typeof $0.type!==$[6]){throw new Error("AddProperty: Invalid type definition for property "+$0.name+": "+$0.type);
}else{$0.hasType=false;
}
if(typeof $0.instance===$[10]){$0.hasInstance=true;
}else if(typeof $0.instance!==$[6]){throw new Error("AddProperty: Invalid instance definition for property "+$0.name+": "+$0.instance);
}else{$0.hasInstance=false;
}
if(typeof $0.classname===$[10]){$0.hasClassName=true;
}else if(typeof $0.classname!==$[6]){throw new Error("AddProperty: Invalid classname definition for property "+$0.name+": "+$0.classname);
...
var $2=qx.core.Property.$$store.user[$0.name]=$[681]+$0.name;
var $3=$[904]+$0.method;
var $4=$[1778]+$0.implMethod;
var $5=$[987]+$0.implMethod;
var $6=qx.core.Property.$$method;
if(!$6.set[$0.name]){$6.set[$0.name]=$[31]+$0.method;
$6.get[$0.name]=$[142]+$0.method;
$6.reset[$0.name]=$[130]+$0.method;
}$1[$2]=$0.defaultValue;
$1[$[142]+$0.method]=function(){return this[$2];
};
$1[$[996]+$0.method]=function($7){return this[$2]=$7;
};
$1[$[130]+$0.method]=function(){return this[$[31]+$0.method]($0.defaultValue);
};
if($0.type===$[77]){$1[$[563]+$0.method]=function($7){return this[$[31]+$0.method](!this[$2]);
};
}
...
if(typeof $0.getAlias===$[10]){$1[$0.getAlias]=$1[$[142]+$0.method];
}if(typeof $0.setAlias===$[10]){$1[$0.setAlias]=$1[$[31]+$0.method];
}}}});
...
$4;
if($1.charAt(0)===$[79]){if($1.charAt(1)===$[79]){$3=$[1182];
...
if($1.inheritable||$1.apply||$1.event){$6.init[$5]=$2+$[104]+$3;
...
if($1.inheritable){$6.refresh[$5]=$2+$[175]+$3;
...
if($1.check===$[2]){$4[$2+$[563]+$3]=new Function($[684]+$6.set[$5]+$[1242]+$6.get[$5]+$[1719]);
$4[$2+$[2065]+$3]=new Function($[684]+$6.get[$5]+$[687]);
}},
__errors:{0:$[1849],
1:$[1601],
2:$[1265],
...
var $6=$[2195]+$2+$[1878]+$5+$[1673]+this.$$method[$3][$2]+$[1845]+$4+$[1278];
$0.printStackTrace();
...
if($4.deferredInit&&$4.init===undefined){$6.push($[217],
this.$$store.init[$2],
$[157]);
$6.push($[216],
this.$$store.init[$2],
...
if($4.init!==undefined){$6.push($[216],
this.$$store.init[$2],
$[18]);
}else if($4.inheritable||$4.nullable){$6.push($[1806]);
}else{$6.push($[1553],
$2,
$[1744],
$1.classname,
...
var $6=$1.prototype;
var $7=[];
var $8=$3===$[31]||$3===$[61]||($3===$[104]&&$5.init===undefined);
var $9=$3===$[130]||$3===$[147];
var $a=$5.apply||$5.event||$5.inheritable;
if($3===$[61]||$3===$[147]){var $b=this.$$store.theme[$2];
}else if($3===$[104]){var $b=this.$$store.init[$2];
}else{var $b=this.$$store.user[$2];
}{if(!$5.nullable||$5.check||$5.inheritable){$7.push($[1350]);
}if($3===$[31]){$7.push($[1680]+$2+$[348]+$3+$[401]);
}};
if($8){if($5.transform){$7.push($[1689],
$5.transform,
$[1130]);
}}if($a){if($8){$7.push($[123],
$b,
$[1665]);
}else if($9){$7.push($[123],
$b,
$[2102]);
}}if($5.inheritable){$7.push($[781]);
}if($8&&(false||$3===$[31])){if(!$5.nullable){$7.push($[1604]+$2+$[348]+$3+$[401]);
}if($5.check!==undefined){if($5.nullable){$7.push($[1529]);
}if($5.inheritable){$7.push($[1237]);
}$7.push($[2176]);
if(this.__checks[$5.check]!==undefined){$7.push($[672],
this.__checks[$5.check],
$[281]);
}else if(qx.Class.isDefined($5.check)){$7.push($[1041],
$5.check,
$[281]);
}else if(qx.Interface.isDefined($5.check)){$7.push($[1636],
$5.check,
$[2131]);
}else if(typeof $5.check===$[51]){$7.push($[923],
$1.classname,
$[628],
$2);
$7.push($[2304]);
}else if(typeof $5.check===$[10]){$7.push($[672],
$5.check,
$[281]);
...
}$7.push($[1367]+$2+$[348]+$3+$[401]);
}}
if(!$a){if($3===$[31]){$7.push($[75],
this.$$store.user[$2],
$[67]);
}else if($3===$[130]){$7.push($[123],
this.$$store.user[$2],
$[157]);
$7.push($[144],
this.$$store.user[$2],
$[18]);
}else if($3===$[61]){$7.push($[75],
this.$$store.theme[$2],
$[67]);
}else if($3===$[147]){$7.push($[123],
this.$$store.theme[$2],
$[157]);
$7.push($[144],
this.$$store.theme[$2],
$[18]);
}else if($3===$[104]&&$8){$7.push($[75],
this.$$store.init[$2],
$[67]);
}}else{if($5.inheritable){$7.push($[1945],
this.$$store.inherit[$2],
$[18]);
}else{$7.push($[2264]);
}$7.push($[123],
this.$$store.user[$2],
$[238]);
if($3===$[31]){if(!$5.inheritable){$7.push($[275],
this.$$store.user[$2],
$[18]);
}$7.push($[48],
this.$$store.user[$2],
$[67]);
}else if($3===$[130]){if(!$5.inheritable){$7.push($[275],
this.$$store.user[$2],
$[18]);
}$7.push($[144],
this.$$store.user[$2],
...
$[271]);
$7.push($[126]);
}else{if($5.inheritable){$7.push($[48],
this.$$store.user[$2],
$[18]);
}else{$7.push($[2088],
this.$$store.user[$2],
...
if($5.themeable){$7.push($[217],
this.$$store.theme[$2],
$[238]);
if(!$5.inheritable){$7.push($[275],
this.$$store.theme[$2],
$[18]);
}
if($3===$[31]){$7.push($[48],
...
$[271]);
$7.push($[126]);
}else if($3===$[104]){if($8){$7.push($[75],
this.$$store.init[$2],
$[67]);
}$7.push($[48],
this.$$store.theme[$2],
$[18]);
}else if($3===$[175]){$7.push($[48],
this.$$store.theme[$2],
$[18]);
}$7.push($[126]);
}$7.push($[217],
...
if($3===$[104]){if($8){$7.push($[48],
this.$$store.init[$2],
$[67]);
}else{$7.push($[48],
this.$$store.init[$2],
$[18]);
}}else if($3===$[31]||$3===$[61]||$3===$[175]){$7.push($[144],
this.$$store.useinit[$2],
$[18]);
if($3===$[31]){$7.push($[48],
this.$$store.user[$2],
...
if($3===$[31]||$3===$[61]||$3===$[104]){$7.push($[1476]);
if($3===$[31]){$7.push($[48],
this.$$store.user[$2],
$[67]);
}else if($3===$[61]){$7.push($[48],
...
$7.push($[634]);
$7.push($[715]);
}else if($a){if($3!==$[31]&&$3!==$[61]){$7.push($[634]);
}$7.push($[519]);
$7.push($[715]);
}if($a){if($5.apply){$7.push($[75],
$5.apply,
$[2062]);
}if($5.event){$7.push($[2357],
$5.event,
$[1901]);
}if($5.inheritable&&$6.getChildren){$7.push($[1183]);
$7.push($[1240],
...
format:function($0,
$1){var $2=$0;
for(var $3=0;$3<$1.length;$3++){$2=$2.replace(new RegExp($[211]+($3+1),
$[372]),
$1[$3]);
}return $2;
},
...
toString:function(){if(this.classname){return $[1338]+this.classname+$[108];
}return $[2151];
},
base:function($0,
...
this._logFormatted($3.length?$3:[$[515]],
$[116]);
throw $1?$1:$[515];
}},
...
}if(qx.core.Setting){var $0=qx.core.Setting.get($[223])+$[2170];
...
this._consoleLog=$1.getElementById($[456]);
this._commandLine=$1.getElementById($[1708]);
...
$1){var $2=this._consoleLog.ownerDocument.createElement($[78]);
$2.className=$[2256]+($1?$[2028]+$1:$[0]);
...
if($7&&typeof ($7)==$[39]){var $8=$0[++$4];
$7.appender($8,
$2);
}else this._appendText($7,
$2);
}
for(var $6=$4+1;$6<$0.length;++$6){this._appendText($[54],
$2);
var $8=$0[$6];
...
var $7=$4[3]?parseInt($4[3]):($4[4]==$[32]?-1:0);
$1.push($0.substr(0,
$4[0][0]==$[211]?$4.index:$4.index+1));
$1.push({appender:$6,
precision:$7});
...
_escapeHTML:function($0){function $1($2){switch($2){case $[405]:return $[450];
case $[356]:return $[1279];
case $[64]:return $[645];
case $[174]:return $[1742];
case $[105]:return $[1725];
}return $[109];
...
$1){try{if($0==undefined)this._appendNull($[6],
$1);
else if($0==null)this._appendNull($[294],
$1);
else if(typeof $0==$[10])this._appendString($0,
$1);
else if(typeof $0==$[58])this._appendInteger($0,
$1);
...
$1);
else if(typeof $0==$[39])this._appendObjectFormatted($0,
$1);
...
$[96]);
if($0.className)$1.push($[2107],
this._escapeHTML($0.className),
$[96]);
$1.push($[96]);
},
_appendNode:function($0,
$1){if($0.nodeType==1){$1.push($[1751],
$[2100],
...
}else if($0.nodeType==3){$1.push($[2398],
...
return $1.compatMode===$[113]?$1.documentElement.clientWidth:$1.body.clientWidth;
}}),
...
"default":function($0){var $1=($0||window).document;
return $1.compatMode===$[113]?$1.documentElement.clientHeight:$1.body.clientHeight;
}}),
...
genericToString:function(){return $[1643]+this.name+$[108];
},
...
}var $3=$[650]+qx.core.Object.toHashCode($1)+($2?$[179]+qx.core.Object.toHashCode($2):$[0]);
...
}var $4=$[650]+qx.core.Object.toHashCode($1)+($2?$[179]+qx.core.Object.toHashCode($2):$[0]);
...
destruct:function(){this._disposeObjectDeep($[1730],
2);
}});
...
destruct:function(){this._disposeFields($[741],
$[2001],
$[2150],
$[1868]);
}});
...
defaultValue:false},
data:{_fast:true}},
destruct:function(){this._disposeFields($[1475]);
}});
...
destruct:function(){this._disposeFields($[1985],
$[1717]);
}});
...
while($3.length<6){$3=$[46]+$3;
}$2+=$3;
if(this.getUseLongFormat()){switch($0.level){case $1.LEVEL_DEBUG:$2+=$[903];
break;
case $1.LEVEL_INFO:$2+=$[2012];
break;
case $1.LEVEL_WARN:$2+=$[899];
break;
case $1.LEVEL_ERROR:$2+=$[2141];
break;
case $1.LEVEL_FATAL:$2+=$[2233];
break;
}}else{$2+=$[285];
}var $4=$[0];
for(var $5=0;$5<$0.indent;$5++){$4+=$[354];
}$2+=$4;
if(this.getUseLongFormat()){$2+=$0.logger.getName();
if($0.instanceId!=null){$2+=$[400]+$0.instanceId+$[108];
}$2+=$[285];
...
}}catch(exc){$2+=$4+$[1390]+exc+$[573];
}$7.sort();
for(var $5=0;$5<$7.length;$5++){try{$2+=$4+$[354]+$7[$5]+$[38]+$6[$7[$5]]+$[135];
}catch(exc){$2+=$4+$[354]+$7[$5]+$[1670]+exc+$[573];
}}$2+=$4+$[2252];
}}if($0.throwable!=null){var $9=$0.throwable;
if($9.name==null){$2+=$[285]+$9;
}else{$2+=$[285]+$9.name;
}
if($9.message!=null){$2+=$[805]+$9.message;
}
if($9.number!=null){$2+=$[1307]+$9.number+$[65];
}var $a=qx.dev.StackTrace.getStackTraceFromError($9);
}
if($0.trace){var $a=$0.trace;
}
if($a&&$a.length>0){$2+=$[135];
for(var $5=0;$5<$a.length;$5++){$2+=$[1178]+$a[$5]+$[135];
}}return $2;
}}});
...
}var $4=$[1693]+$[1874]+$0+$[1196]+$1+$[1922]+$2+$[1903]+$3;
...
$[23])?$[1485]:$[402];
$0.open();
$0.write($[1668]+this._name+$[1780]+$[1079]+this._id+$[941]+$[2397]+$[780]+$[1951]+$[739]+$[1759]+$[2139]+$[1623]+$[1156]+$1+$[1083]+$[852]+$[767]+this._filterText+$[466]+$[513]+$[1010]+$[2355]+$[513]+$[2281]);
$0.close();
this._logElem=$0.getElementById($[456]);
this._markerBtn=$0.getElementById($[2206]);
this._filterInput=$0.getElementById($[171]);
this._logLinesDiv=$0.getElementById($[1064]);
var $2=this;
this._markerBtn.onclick=function(){$2._showMessageInLog($[967]);
};
...
}else{this._showMessageInLog($[1345]+this._errorsPreventingAutoCloseCount+$[1138]);
}},
...
}else{var $1=this._logWindow.document.createElement($[78]);
if($0.level>=qx.log.Logger.LEVEL_ERROR){$1.style.backgroundColor=$[2070];
if(!this.getAutoCloseWithErrors()){this._errorsPreventingAutoCloseCount+=1;
}}else if($0.level==qx.log.Logger.LEVEL_DEBUG){$1.style.color=$[178];
}var $2;
...
if(this._removedMessageCount!=null){this._logElem.firstChild.innerHTML=$[114]+this._removedMessageCount+$[624];
}this._logLinesDiv.scrollTop=this._logLinesDiv.scrollHeight;
}},
setFilterText:function($0){if($0==null){$0=$[0];
}this._filterText=$0;
$0=$0.toUpperCase();
this._filterTextWords=$0.split($[54]);
...
}$0.elem.style[$[190]]=($1?$[0]:$[14]);
},
_applyAutoCloseWithErrors:function($0,
$1){if(!$0&&$1){this._errorsPreventingAutoCloseCount=0;
this._showMessageInLog($[957]);
}else if($0&&!$1){this._showMessageInLog($[1019]+this._errorsPreventingAutoCloseCount+$[1598]);
}}},
...
_oninterval:function(){if(this.getEnabled()){this.createDispatchEvent($[99]);
}}},
destruct:function(){if(this.__intervalHandler){window.clearInterval(this.__intervalHandler);
}this._disposeFields($[1862],
$[2380]);
}});
...
members:{appendLogEvent:function($0){if(typeof console!=$[553]){var $1=qx.log.Logger;
...
{extend:qx.log.appender.Abstract,
construct:function(){arguments.callee.base.call(this);
if(typeof console!=$[553]&&console.debug&&!console.emu){this._appender=new qx.log.appender.FireBug;
...
destruct:function(){this._disposeObjects($[2302]);
}});
...
measure:function($0,
$1,
$2){if(this._lastMeasureTime==null){$0=$[858]+$0;
...
settings:{"qx.logAppender":$[629],
"qx.minLogLevel":200},
defer:function($0){$0.ROOT_LOGGER=new $0("root",
null);
$0.ROOT_LOGGER.setMinLevel(qx.core.Setting.get($[1303]));
$0.ROOT_LOGGER.addAppender(new (qx.Class.getByName(qx.core.Setting.get($[844]))));
},
destruct:function(){this._disposeFields($[1757],
$[1446]);
}});
...
"webkit":function($0){if($0.sourceURL&&$0.line){return [this.__fileNameToClassName($0.sourceURL)+$[63]+$0.line];
}},
...
getFunctionName:function($0){if($0.$$original){return $0.classname+$[973];
}
if($0.wrapper){return $0.wrapper.classname+$[647];
}
if($0.classname){return $0.classname+$[647];
}
if($0.mixin){for(var $1 in $0.mixin.$$members){if($0.mixin.$$members[$1]==$0){return $0.mixin.name+$[63]+$1;
}}for(var $1 in $0.mixin){if($0.mixin[$1]==$0){return $0.mixin.name+$[63]+$1;
}}}
if($0.self){var $2=$0.self.constructor;
if($2){for(var $1 in $2.prototype){if($2.prototype[$1]==$0){return $2.classname+$[63]+$1;
}}for(var $1 in $2){if($2[$1]==$0){return $2.classname+$[63]+$1;
}}}}var $3=$0.toString().match(/(function\s*\w*\(.*?\))/);
if($3&&$3.length>=1&&$3[1]){return $3[1];
}var $3=$0.toString().match(/(function\s*\(.*?\))/);
if($3&&$3.length>=1&&$3[1]){return $[1304]+$3[1];
}return $[2181];
},
__fileNameToClassName:function($0){var $1=$[1728];
var $2=$0.indexOf($1);
...
function($1){var $2={"  ":$[838],
"\n":$[654]};
return $2[$1]||$1;
});
},
toText:function($0){return qx.html.String.unescape($0.replace(/\s+|<([^>])+>/gi,
function($1){if(/\s+/.test($1)){return $[54];
}else if(/^<BR|^<br/gi.test($1)){return $[135];
}else{return $[0];
}}));
}}});
...
}else{if($2.charAt(0)==$[1168]){if($2.charAt(1).toUpperCase()==$[1419]){$4=$2.substring(2);
if($4.match(/^[0-9A-Fa-f]+$/gi)){$3=String.fromCharCode(parseInt($[1400]+$4));
...
{};
if(!this.getApplication()){var $2=qx.Class.getByName(qx.core.Setting.get($[836]));
...
svn:0,
folder:$[0],
toString:function(){return this.major+$[32]+this.minor+(this.revision==0?$[0]:$[32]+this.revision)+(this.state==$[0]?$[0]:$[100]+this.state)+(this.svn==0?$[0]:$[2209]+this.svn+$[65])+(this.folder==$[0]?$[0]:$[728]+this.folder+$[108]);
},
__init:function(){var $0=qx.core.Setting.get($[862]).split($[54]);
var $1=$0.shift();
var $2=$0.join($[54]);
...
$1,
$2){{};
var $3=$[644]+$1.toHashCode()+$[179]+qx.core.Object.toHashCode($0);
...
destruct:function(){this._disposeFields($[2079],
$[2027]);
}});
...
this._aliases={};
this.add($[341],
qx.core.Setting.get($[223])+$[1114]);
},
members:{_preprocess:function($0){var $1=this._dynamic;
if($1[$0]===false){return $0;
}else if($1[$0]===undefined){if($0.charAt(0)===$[56]||$0.charAt(0)===$[32]||$0.indexOf($[1470])===0||$0.indexOf($[1169])===$[46]||$0.indexOf($[1838])===0){$1[$0]=false;
return $0;
}var $2=$0.substring(0,
$0.indexOf($[56]));
...
$6.indexOf($[56]))===$0){$2[$6]=$1+$6.substring($0.length);
$5[$6]=true;
...
destruct:function(){this._disposeFields($[1216]);
}});
...
qx.Theme.define($[1277],
{title:$[496],
widgets:{uri:qx.core.Setting.get($[223])+$[1349]}});




/* ID: qx.theme.classic.Appearance */
qx.Theme.define($[2290],
{title:$[408],
appearances:{"empty":{},
"widget":{},
"image":{},
"atom":{},
"popup":{},
"cursor-dnd-move":{style:function($0){return {source:$[1694]};
}},
"cursor-dnd-copy":{style:function($0){return {source:$[1285]};
}},
"cursor-dnd-alias":{style:function($0){return {source:$[1755]};
}},
"cursor-dnd-nodrop":{style:function($0){return {source:$[1906]};
}},
"label":{style:function($0){return {textColor:$0.disabled?$[282]:$[6]};
}},
"client-document":{style:function($0){return {backgroundColor:$[84],
textColor:$[172],
font:$[55]};
}},
"client-document-blocker":{style:function($0){return {cursor:$[55],
backgroundImage:$[224]};
}},
"tool-tip":{include:$[579],
style:function($0){return {backgroundColor:$[670],
textColor:$[666],
border:$[670],
padding:[1,
3,
...
"iframe":{style:function($0){return {border:$[89]};
}},
"check-box":{style:function($0){return {padding:[2,
3]};
}},
"radio-button":{include:$[1217]},
"button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[89];
}else{var $1=$[82];
}
...
4];
}return {backgroundColor:$0.abandoned?$[286]:$0.over?$[2132]:$[169],
border:$1,
padding:$2};
}},
"toolbar":{style:function($0){return {border:$[225],
backgroundColor:$[84]};
}},
"toolbar-part":{},
...
"toolbar-button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[227];
var $2=[3,
2,
1,
4];
}else if($0.over){var $1=$[225];
var $2=[2,
3];
}else{var $1=$[6];
var $2=[3,
...
border:$1,
padding:$2,
verticalChildrenAlign:$[33],
backgroundColor:$0.abandoned?$[286]:$[169],
backgroundImage:$0.checked&&!$0.over?$[583]:null};
}},
"button-view":{style:function($0){return {border:$[163]};
}},
"button-view-pane":{style:function($0){return {backgroundColor:$[376],
padding:10};
}},
"button-view-page":{},
"button-view-bar":{style:function($0){var $1=$[6];
var $2=$[6];
...
$3=$[3];
$2=null;
}return {backgroundColor:$0.checked?$[376]:$[6],
iconPosition:$[16],
margin:$1,
width:$2,
height:$3,
...
"tab-view-bar":{},
"tab-view-pane":{style:function($0){return {backgroundColor:$[426],
...
"radio-view":{include:$[630]},
"radio-view-pane":{style:function($0){return {backgroundColor:$[1111]};
}},
"radio-view-page":{},
"radio-view-bar":{style:function($0){return {backgroundColor:$[1037],
padding:[1,
0],
...
$2=[3,
7];
}return {backgroundColor:$0.checked?$[875]:$[6],
iconPosition:$[9],
margin:[0,
1],
width:$[3],
...
"window":{style:function($0){return {backgroundColor:$[84],
padding:1,
border:$0.maximized?$[6]:$[82]};
}},
"window-captionbar":{style:function($0){return {padding:[1,
2,
2],
verticalChildrenAlign:$[33],
backgroundColor:$0.active?$[1597]:$[2270],
textColor:$0.active?$[2260]:$[988]};
}},
"window-resize-frame":{style:function($0){return {border:$[163]};
}},
"window-captionbar-icon":{style:function($0){return {marginRight:2};
}},
"window-captionbar-title":{style:function($0){return {cursor:$[55],
font:$[261],
marginRight:2};
}},
"window-captionbar-button":{include:$[169],
...
"window-captionbar-minimize-button":{include:$[298],
style:function($0){return {icon:$[1382]};
}},
"window-captionbar-restore-button":{include:$[298],
style:function($0){return {icon:$[1194]};
}},
"window-captionbar-maximize-button":{include:$[298],
style:function($0){return {icon:$[1603]};
}},
"window-captionbar-close-button":{include:$[298],
style:function($0){return {marginLeft:2,
icon:$[1496]};
}},
"window-statusbar":{style:function($0){return {border:$[227]};
}},
...
"resizer-frame":{style:function($0){return {border:$[163]};
}},
"menu":{style:function($0){return {backgroundColor:$[678],
border:$[82],
padding:1};
}},
"menu-layout":{},
...
4],
verticalChildrenAlign:$[33],
backgroundColor:$0.over?$[69]:$[6],
textColor:$0.over?$[228]:$[6]};
}},
"menu-button-arrow":{style:function($0){return {source:$[1474]};
}},
"menu-check-box":{include:$[371],
style:function($0){return {icon:$0.checked?$[1288]:$[224]};
}},
"menu-radio-button":{include:$[371],
style:function($0){return {icon:$0.checked?$[1422]:$[224]};
}},
...
"list":{style:function($0){return {border:$[227],
backgroundColor:$[207]};
}},
...
padding:[3,
5],
backgroundColor:$0.selected?$[69]:$[6],
textColor:$0.selected?$[228]:$[6]};
}},
"text-field":{style:function($0){return {border:$[89],
padding:[1,
3],
textColor:$0.disabled?$[282]:$[6],
backgroundColor:$[237]};
}},
"text-area":{include:$[170]},
"combo-box":{style:function($0){return {border:$[89],
backgroundColor:$[237]};
}},
"combo-box-list":{include:$[207],
style:function($0){return {border:$[6],
overflow:$[121]};
}},
"combo-box-popup":{include:$[207],
style:function($0){return {maxHeight:150,
border:$[163]};
}},
"combo-box-text-field":{include:$[170],
style:function($0){return {border:$[6],
backgroundColor:$[258]};
}},
"combo-box-button":{include:$[169],
...
"combo-box-ex":{style:function($0){return {border:$[89],
backgroundColor:$[237]};
}},
"combo-box-ex-list":{include:$[207],
style:function($0){return {border:$[6],
edge:0};
}},
"combo-box-ex-text-field":{include:$[170],
style:function($0){return {border:$[6],
minWidth:30,
width:100,
backgroundColor:$[258]};
}},
"combo-box-ex-popup":{include:$[207],
style:function($0){return {border:$[674]};
}},
"combo-box-ex-button":{include:$[1467]},
"treevirtual-focus-indicator":{include:$[2045]},
...
"tree-element-label":{include:$[165],
style:function($0){return {marginLeft:3,
height:15,
padding:2,
backgroundColor:$0.selected?$[69]:$[6],
textColor:$0.disabled?$[282]:($0.selected?$[228]:$[6])};
}},
"tree-folder":{include:$[726]},
"tree-folder-icon":{include:$[695]},
"tree-folder-label":{include:$[535]},
"tree":{include:$[394]},
"tree-icon":{include:$[545]},
"tree-label":{include:$[693]},
...
6],
spacing:4,
backgroundColor:$0.over?$[1027]:$[6],
paddingBottom:$0.over?0:2,
border:$0.over?new qx.ui.core.Border.fromConfig({bottom:[2,
$[5],
$[97]]}):$[6]};
}},
"list-view-header-cell-arrow-up":{style:function($0){return {source:$[1001]};
}},
"list-view-header-cell-arrow-down":{style:function($0){return {source:$[716]};
}},
"list-view-header-separator":{style:function($0){return {backgroundColor:$[723],
width:1,
marginTop:1,
marginBottom:1};
}},
"list-view-content-cell":{style:function($0){return {cursor:$[55],
backgroundColor:$0.selected?$[69]:$[6],
textColor:$0.selected?$[228]:$[6],
border:$0.lead&&
!$0.selected?
...
"list-view-content-cell-image":{include:$[462],
style:function($0){return {paddingLeft:6,
paddingRight:6};
}},
"list-view-content-cell-text":{include:$[462],
style:function($0){return {overflow:$[24],
paddingLeft:6,
paddingRight:6};
}},
"list-view-content-cell-html":{include:$[326]},
"list-view-content-cell-icon-html":{include:$[326]},
"list-view-content-cell-link":{include:$[326]},
"group-box":{style:function($0){return {backgroundColor:$[84]};
}},
...
"radio-button-group-box-legend":{include:$[1200]},
"spinner":{style:function($0){return {border:$[89],
backgroundColor:$[237]};
}},
"spinner-text-field":{include:$[170],
style:function($0){return {backgroundColor:$[258]};
}},
"spinner-button":{style:function($0){return {width:16,
backgroundColor:$[84],
paddingLeft:3,
border:$0.pressed||$0.checked||$0.abandoned?$[89]:$[82]};
}},
"spinner-button-up":{include:$[546],
style:function($0){return {source:$[2283]};
}},
"spinner-button-down":{include:$[546],
style:function($0){return {paddingTop:1,
source:$[2142]};
}},
"colorselector":{style:function($0){return {backgroundColor:$[84],
border:$[82]};
}},
"datechooser-toolbar-button":{style:function($0){var $1={backgroundColor:$0.abandoned?$[286]:$[169],
backgroundImage:($0.checked&&!$0.over)?$[583]:null,
spacing:4,
width:$[3],
verticalChildrenAlign:$[33]};
if($0.pressed||$0.checked||$0.abandoned){$1.border=$[227];
}else if($0.over){$1.border=$[225];
}else{$1.border=$[6];
}
...
"datechooser-monthyear":{style:function($0){return {font:$[2231],
textAlign:$[59],
verticalAlign:$[33]};
}},
...
font:$[1356],
textAlign:$[59],
textColor:$0.weekend?$[315]:$[329],
backgroundColor:$0.weekend?$[329]:$[315]};
}},
"datechooser-day":{style:function($0){return {textAlign:$[59],
verticalAlign:$[33],
border:$0.today?$[226]:$[6],
textColor:$0.selected?$[228]:$0.otherMonth?$[282]:$[6],
backgroundColor:$0.selected?$[69]:$[6],
padding:[2,
4]};
}},
...
"table-editor-textfield":{include:$[170],
style:function($0){return {border:$[6],
padding:[0,
2]};
}},
"table-pane":{style:function($0){return {backgroundColor:$[590]};
}},
...
"table-menubar-button":{style:function($0){if($0.pressed||$0.checked||$0.abandoned){var $1=$[227];
var $2=[3,
2,
1,
4];
...
border:$1,
backgroundColor:$2,
icon:$0.sorted?($0.sortedAscending?$[1754]:$[2166]):null,
horizontalChildrenAlign:$[9]};
}},
"splitpane":{style:function($0){return {overflow:$[24],
splitterSize:8,
backgroundColor:$[84]};
}},
"splitpane-splitter":{style:function($0){return {cursor:$0.horizontal?$[314]:$[384]};
}},
...
"scrollbar-blocker":{style:function($0){return {backgroundColor:$[226],
opacity:0.2};
}}}});
...
qx.Theme.define($[1950],
{title:$[2305],
icons:{uri:qx.core.Setting.get($[223])+$[1889]}});
...
construct:function(){arguments.callee.base.call(this);
this._layoutChanges={};
if(qx.core.Setting.get($[2316])){this._generateHtmlId();
}},
...
}if(qx.Class.isDefined($[930])){for($0 in $5){$1=$5[$0];
...
var $6=$4==null?$5.indexOf($0)+$2:$4===$[561]?0:$5.length-1;
var $7=$5[$6];
...
__initApplyMethods:function($0){var $1=$[2300];
var $2=$[1145];
var $3=$[2200];
var $4=$[1323];
var $5=$[644];
...
$a+$7[$b]+$4);
$0[$9+$7[$b]]=new Function($a+$7[$b]+$[397]);
}var $c=$1+$[653];
var $d=$2+$[653];
var $e=$3+$[479];
if(qx.core.Variant.isSet($[1],
$[28])){for(var $b=0;$b<4;$b++){$0[$c+$7[$b]]=new Function($5,
$e+$7[$b]+$4);
$0[$d+$7[$b]]=new Function($e+$7[$b]+$[397]);
}}else{for(var $b=0;$b<4;$b++){$0[$c+$7[$b]]=new Function($5,
$[1971]+$7[$b]+$[1817]);
$0[$d+$7[$b]]=new Function($[826]+$7[$b]+$[1213]);
}}for(var $b=0;$b<$6.length;$b++){$0[$1+$7[$b]]=new Function($5,
$3+$6[$b]+$4);
$0[$2+$7[$b]]=new Function($3+$6[$b]+$[397]);
}},
TYPE_NULL:0,
TYPE_PIXEL:1,
TYPE_PERCENT:2,
...
TYPE_FLEX:4,
layoutPropertyTypes:{},
__initLayoutProperties:function($0){var $1=[$[30],
$[35],
$[80],
$[81],
$[102],
...
$5,
$6;$2<$3;$2++){$4=$1[$2];
$5=$[1395]+qx.lang.String.toFirstUp($4);
$6=$5+$[460];
...
initScrollbarWidth:function(){var $0=document.createElement($[78]);
var $1=$0.style;
$1.height=$1.width=$[317];
$1.overflow=$[37];
...
nullable:true,
init:null},
backgroundImage:{check:$[8],
nullable:true,
apply:$[885],
themeable:true},
backgroundRepeat:{check:$[8],
nullable:true,
apply:$[956],
themeable:true},
overflow:{check:[$[24],
...
nullable:true,
themeable:true},
marginRight:{check:$[17],
apply:$[1935],
nullable:true,
themeable:true},
marginBottom:{check:$[17],
apply:$[871],
nullable:true,
themeable:true},
marginLeft:{check:$[17],
...
nullable:true,
themeable:true},
paddingRight:{check:$[17],
apply:$[2239],
nullable:true,
themeable:true},
paddingBottom:{check:$[17],
apply:$[2074],
nullable:true,
themeable:true},
paddingLeft:{check:$[17],
apply:$[1223],
nullable:true,
themeable:true},
left:{apply:$[1331],
...
$[1081]],
themeable:true},
clipLocation:{group:[$[704],
$[620]]},
clipDimension:{group:[$[714],
$[508]]},
clip:{group:[$[704],
$[620],
$[714],
...
$1){this._unitDetectionPixelPercentAutoFlex($[30],
$0);
this.addToQueue($[30]);
},
...
$1){this._unitDetectionPixelPercentAuto($[81],
$0);
this.addToQueue($[81]);
},
_applyHeight:function($0,
$1){this._unitDetectionPixelPercentAutoFlex($[35],
$0);
this.addToQueue($[35]);
},
_applyMinHeight:function($0,
$1){this._unitDetectionPixelPercentAuto($[102],
$0);
this.addToQueue($[102]);
},
_applyMaxHeight:function($0,
$1){this._unitDetectionPixelPercentAuto($[101],
$0);
this.addToQueue($[101]);
},
...
$[190])!=$[14]&&qx.html.Style.getStyleProperty($0,
$[364])!=$[24]&&$0.offsetWidth>0&&$0.offsetHeight>0);
},
...
if(typeof this._insertIndex==$[58]){qx.lang.Array.insertAt($0.getChildren(),
this,
this._insertIndex);
...
return this._handleDisplayable($[322]);
},
_applyDisplay:function($0,
$1){return this._handleDisplayable($[190]);
},
_handleDisplayable:function($0){var $1=this._computeDisplayable();
if(this._isDisplayable==$1&&!($1&&$0==$[322])){return true;
...
$2.addToJobQueue($[1783]);
}this.addToLayoutChanges($[2228]);
...
_beforeAppear:function(){this.createDispatchEvent($[980]);
},
_afterAppear:function(){this._isSeeable=true;
this.createDispatchEvent($[162]);
},
_beforeDisappear:function(){this.removeState($[68]);
if(qx.Class.isDefined($[387])){this.removeState($[47]);
this.removeState($[60]);
}this.createDispatchEvent($[1360]);
},
_afterDisappear:function(){this._isSeeable=false;
this.createDispatchEvent($[195]);
},
_isSeeable:false,
...
_beforeInsertDom:function(){this.createDispatchEvent($[1648]);
},
_afterInsertDom:function(){this.createDispatchEvent($[2039]);
},
_beforeRemoveDom:function(){this.createDispatchEvent($[1731]);
},
_afterRemoveDom:function(){this.createDispatchEvent($[1440]);
},
_applyVisibility:function($0,
$1){if($0){if(this._isDisplayable){this._beforeAppear();
}this.removeStyleProperty($[190]);
if(this._isDisplayable){this._afterAppear();
}}else{if(this._isDisplayable){this._beforeDisappear();
}this.setStyleProperty($[190],
$[14]);
...
_createElementImpl:function(){this.setElement(this.getTopLevelWidget().getDocumentElement().createElement($[78]));
},
...
$e=$d.length;
if($1.paddingLeft){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1827]);
}}
if($1.paddingRight){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1211]);
}}
if($1.paddingTop){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[2275]);
}}
if($1.paddingBottom){for(var $c=0;$c<$e;$c++){$d[$c].addToLayoutChanges($[1002]);
}}}
...
switch(this.getOverflow()){case $[37]:case $[121]:$0+=qx.ui.core.Widget.SCROLLBAR_SIZE;
break;
case $[3]:break;
}return $0;
},
...
switch(this.getOverflow()){case $[37]:case $[140]:$0+=qx.ui.core.Widget.SCROLLBAR_SIZE;
break;
case $[3]:break;
}return $0;
},
...
switch(typeof $0){case $[58]:return isNaN($0)?qx.ui.core.Widget.TYPE_NULL:qx.ui.core.Widget.TYPE_PIXEL;
case $[10]:return $0.indexOf($[211])!=-1?qx.ui.core.Widget.TYPE_PERCENT:$0.indexOf($[129])!=-1?qx.ui.core.Widget.TYPE_FLEX:qx.ui.core.Widget.TYPE_NULL;
...
switch(typeof $0){case $[58]:return isNaN($0)?qx.ui.core.Widget.TYPE_NULL:qx.ui.core.Widget.TYPE_PIXEL;
case $[10]:return $0.indexOf($[211])!=-1?qx.ui.core.Widget.TYPE_PERCENT:qx.ui.core.Widget.TYPE_NULL;
}return qx.ui.core.Widget.TYPE_NULL;
},
...
if($b!=this[$7]){switch($0){case $[80]:case $[81]:case $[30]:case $[9]:case $[12]:this._invalidateHasPercentX();
break;
case $[101]:case $[102]:case $[35]:case $[16]:case $[19]:this._invalidateHasPercentY();
break;
}}if($c!=this[$8]){switch($0){case $[80]:case $[81]:case $[30]:this._invalidateHasAutoX();
break;
case $[102]:case $[101]:case $[35]:this._invalidateHasAutoY();
break;
}}if($d!=this[$9]){switch($0){case $[30]:this._invalidateHasFlexX();
break;
case $[35]:this._invalidateHasFlexY();
break;
}}},
...
if($a!=this[$7]){switch($0){case $[80]:case $[81]:case $[30]:case $[9]:case $[12]:this._invalidateHasPercentX();
break;
case $[102]:case $[101]:case $[35]:case $[16]:case $[19]:this._invalidateHasPercentY();
break;
}}if($b!=this[$8]){switch($0){case $[80]:case $[81]:case $[30]:this._invalidateHasAutoX();
break;
case $[102]:case $[101]:case $[35]:this._invalidateHasAutoY();
break;
}}},
...
if($9!=this[$7]){switch($0){case $[80]:case $[81]:case $[30]:case $[9]:case $[12]:this._invalidateHasPercentX();
break;
case $[102]:case $[101]:case $[35]:case $[16]:case $[19]:this._invalidateHasPercentY();
break;
}}},
...
{"mshtml":function($0){},
"gecko":function($0){if($0.focused){if(!qx.event.handler.FocusHandler.mouseFocus&&!this.getHideFocus()){this.setStyleProperty($[417],
$[437]);
}}else{this.removeStyleProperty($[417]);
}},
"default":function($0){if($0.focused){if(!qx.event.handler.FocusHandler.mouseFocus&&!this.getHideFocus()){this.setStyleProperty($[493],
$[437]);
}}else{this.removeStyleProperty($[493]);
}}}),
...
_generateHtmlId:function(){var $0=this.classname+$[32]+qx.ui.core.Widget._idCounter++;
this.debug("setting autogenerated HTML id to "+$0);
this.setHtmlProperty($[255],
$0);
},
...
_applyEnabled:function($0,
$1){if($0===false){this.addState($[567]);
this.removeState($[68]);
if(qx.Class.isDefined($[387])){this.removeState($[60]);
this.removeState($[47]);
}}else{this.removeState($[567]);
}},
...
$1){if($0==null){this.removeStyleProperty($[411]);
}else{this.setStyleProperty($[411],
$0);
}},
_applyTabIndex:qx.core.Variant.select($[1],
{"mshtml":function($0,
$1){this.setHtmlProperty($[481],
$0<0?-1:1);
},
"gecko":function($0,
$1){this.setStyleProperty($[1932],
($0<0?$[679]:$[222]));
},
"default":function($0,
$1){this.setStyleProperty($[999],
($0<0?$[679]:$[222]));
this.setHtmlProperty($[481],
$0<0?-1:1);
}}),
...
$1){},
"gecko":function($0,
$1){if($0){this.removeStyleProperty($[504]);
}else{this.setStyleProperty($[504],
$[14]);
}},
"webkit":function($0,
$1){if($0){this.removeStyleProperty($[699]);
}else{this.setStyleProperty($[699],
$[14]);
}},
"khtml":function($0,
$1){if($0){this.removeStyleProperty($[520]);
}else{this.setStyleProperty($[520],
$[14]);
}},
"default":function($0,
$1){if($0){return this.removeStyleProperty($[709]);
}else{this.setStyleProperty($[709],
$[14]);
}}}),
_applyOpacity:qx.core.Variant.select($[1],
{"mshtml":function($0,
$1){if($0==null||$0>=1||$0<0){this.removeStyleProperty($[171]);
}else{this.setStyleProperty($[171],
($[1199]+Math.round($0*100)+$[65]));
}},
"default":function($0,
$1){if($0==null||$0>1){if(qx.core.Variant.isSet($[1],
$[28])){this.removeStyleProperty($[575]);
}else if(qx.core.Variant.isSet($[1],
$[189])){this.removeStyleProperty($[491]);
}this.removeStyleProperty($[485]);
}else{$0=qx.lang.Number.limit($0,
0,
1);
if(qx.core.Variant.isSet($[1],
$[28])){this.setStyleProperty($[575],
$0);
}else if(qx.core.Variant.isSet($[1],
$[189])){this.setStyleProperty($[491],
$0);
}this.setStyleProperty($[485],
$0);
}}}),
...
$1){if($0){this.setStyleProperty($[425],
this.__cursorMap[$0]||$0);
}else{this.removeStyleProperty($[425]);
}},
...
$[2348]+$0+$[65]):this.removeStyleProperty($[598]);
},
_applyBackgroundRepeat:function($0,
$1){$0?this.setStyleProperty($[507],
$0):this.removeStyleProperty($[507]);
},
...
var $4,
$5;
if($0==null){$4=($2==null?$[3]:$2+$[52]);
$0=$[3];
}else{$4=($2==null?$[3]:$0+$2+$[52]);
$0=$0+$[52];
}
if($1==null){$5=($3==null?$[3]:$3+$[52]);
$1=$[3];
}else{$5=($3==null?$[3]:$1+$3+$[52]);
$1=$1+$[52];
}return this.setStyleProperty($[1343],
($[2318]+$1+$[21]+$4+$[21]+$5+$[21]+$0+$[65]));
},
_applyOverflow:qx.core.Variant.select($[1],
{"default":function($0,
$1){var $2=$0;
var $3=$[87];
switch($0){case $[140]:$3=$[212];
$2=$[37];
break;
case $[121]:$3=$[213];
$2=$[37];
...
switch($0){case $[140]:this.setStyleProperty($[213],
$[24]);
break;
case $[121]:this.setStyleProperty($[212],
$[24]);
break;
...
$1){var $2=$0;
var $3=$[87];
switch($2){case $[140]:case $[121]:$2=$[37];
break;
}this._renderOverflow($3,
$2,
$0,
...
_styleBackgroundColor:function($0){$0?this.setStyleProperty($[658],
$0):this.removeStyleProperty($[658]);
},
...
}else{if($1===$[9]||$1===$[12]){this.__reflowBorderX($0);
...
var $1=this._borderElement=document.createElement($[78]);
var $2=$0.style;
var $3=this._innerStyle=$1.style;
if(qx.core.Variant.isSet($[1],
$[23])){}else{$3.width=$3.height=$[11];
}$3.position=$[74];
for(var $4 in this._styleProperties){switch($4){case $[411]:case $[171]:case $[190]:break;
default:$3[$4]=$2[$4];
$2[$4]=$[0];
}}
for(var $4 in this._htmlProperties){switch($4){case $[1807]:$1.unselectable=this._htmlProperties[$4];
}}while($0.firstChild){$1.appendChild($0.firstChild);
}$0.appendChild($1);
}}),
_applyPaddingTop:function($0,
$1){this.addToQueue($[247]);
this._invalidateFrameHeight();
},
...
if(qx.core.Variant.isSet($[1],
$[23])){$1._renderRuntimeWidth=function($2){this._style.pixelWidth=($2==null)?0:$2;
...
/* ID: qx.html.Style */
qx.Class.define($[2364],
{statics:{getStylePropertySure:qx.lang.Object.select((document.defaultView&&document.defaultView.getComputedStyle)?$[608]:$[521],
...
if($2!=null&&typeof $2!=$[6]&&$2!=$[0]){return $2;
}return $0.style[$1];
...
getStyleProperty:qx.lang.Object.select((document.defaultView&&document.defaultView.getComputedStyle)?$[608]:$[521],
{"hasComputed":function($0,
...
{statics:{includeFile:function($0){var $1=document.createElement($[1848]);
$1.type=$[600];
$1.rel=$[1262];
$1.href=$0;
var $2=document.getElementsByTagName($[686])[0];
$2.appendChild($1);
},
createElement:qx.lang.Object.select(document.createStyleSheet?$[167]:$[72],
...
$1.type=$[600];
$1.appendChild(document.createTextNode($0||$[1592]));
document.getElementsByTagName($[686])[0].appendChild($1);
if($1.sheet){return $1.sheet;
}else{var $2=document.styleSheets;
for(var $3=$2.length-1;$3>=0;$3--){if($2[$3].ownerNode==$1){return $2[$3];
}}}throw $[2051];
}}),
addRule:qx.lang.Object.select(document.createStyleSheet?$[167]:$[72],
{"ie4+":function($0,
$1,
$2){$0.addRule($1,
$2);
},
"other":qx.lang.Object.select(qx.core.Client.getInstance().isSafari2()?$[302]:$[72],
{"safari2+":function($0,
$1,
$2){if(!$0._qxRules){$0._qxRules={};
}
if(!$0._qxRules[$1]){var $3=document.createTextNode($1+$[370]+$2+$[219]);
$0.ownerNode.appendChild($3);
$0._qxRules[$1]=$3;
}},
"other":function($0,
$1,
$2){$0.insertRule($1+$[370]+$2+$[219],
$0.cssRules.length);
}})}),
removeRule:qx.lang.Object.select(document.createStyleSheet?$[167]:$[72],
{"ie4+":function($0,
$1){var $2=$0.rules;
var $3=$2.length;
...
removeAllRules:qx.lang.Object.select(document.createStyleSheet?$[167]:$[72],
...
addImport:qx.lang.Object.select(document.createStyleSheet?$[167]:$[72],
{"ie4+":function($0,
$1){$0.addImport($1);
},
"other":qx.lang.Object.select(qx.core.Client.getInstance().isSafari2()?$[302]:$[72],
{"safari2+":function($0,
$1){$0.ownerNode.appendChild(document.createTextNode($[705]+$1+$[539]));
},
"other":function($0,
$1){$0.insertRule($[705]+$1+$[539],
$0.cssRules.length);
}})}),
removeImport:qx.lang.Object.select(document.createStyleSheet?$[167]:$[72],
{"ie4+":function($0,
$1){var $2=$0.imports;
var $3=$2.length;
...
removeAllImports:qx.lang.Object.select(document.createStyleSheet?$[167]:$[72],
...
properties:{focusHandler:{check:$[698],
apply:$[1559],
nullable:true},
activeChild:{check:$[110],
apply:$[2103],
event:$[937],
nullable:true},
focusedChild:{check:$[110],
apply:$[1750],
event:$[1769],
nullable:true},
...
$1){if($0){this.addEventListener($[70],
...
$1){var $2=$0!=null;
var $3=$1!=null;
if(qx.Class.isDefined($[204])&&$2){var $4=qx.ui.popup.PopupManager.getInstance();
if($4){$4.update($0);
}}
if($3){if($1.hasEventListeners($[345])){var $5=new qx.event.type.FocusEvent($[345],
$1);
if($2){$5.setRelatedTarget($0);
}$1.dispatchEvent($5);
$5.dispose();
}}
if($2){if($0.hasEventListeners($[319])){var $5=new qx.event.type.FocusEvent($[319],
$0);
...
var $5=new qx.event.type.FocusEvent($[301],
$1);
if($2){$5.setRelatedTarget($0);
}$1.dispatchEvent($5);
if(qx.Class.isDefined($[183])){var $4=qx.ui.popup.ToolTipManager.getInstance();
if($4){$4.handleBlur($5);
}}$5.dispose();
}
...
var $5=new qx.event.type.FocusEvent($[287],
$0);
if($3){$5.setRelatedTarget($1);
}$0.dispatchEvent($5);
if(qx.Class.isDefined($[183])){var $4=qx.ui.popup.ToolTipManager.getInstance();
...
$[138])){$1._layoutChildOrig=$1._layoutChild;
...
destruct:function(){this._disposeObjectDeep($[1771],
1);
this._disposeObjects($[1363],
$[735]);
this._disposeFields($[416],
$[416],
$[1450],
$[1810],
$[794]);
...
$0);
this.setTarget($1);
switch($0){case $[319]:case $[345]:this.setBubbles(true);
...
if($7!=null&&$7.getEnabled()){switch($4){case $[215]:case $[279]:if(qx.Class.isDefined($[185])){qx.ui.menu.Manager.getInstance().update($7,
$1);
}break;
}if(!this.getAllowClientSelectAll()){if($0.ctrlKey&&$4==$[188]){switch($5.tagName.toLowerCase()){case $[161]:case $[366]:case $[198]:break;
default:qx.event.handler.EventHandler.stopDomEvent($0);
}}}$7.dispatchEvent($8);
if(qx.Class.isDefined($[389])){qx.event.handler.DragAndDropHandler.getInstance().handleKeyEvent($8);
}}$8.dispose();
},
...
var $2=$0.type;
if($2==$[66]){if(this._mouseIsDown&&$0.button==0){this._onmouseevent_post($0,
$[22]);
this._mouseIsDown=false;
}}else{if($2==$[15]){this._mouseIsDown=true;
}else if($2==$[22]){this._mouseIsDown=false;
}if($2==$[22]&&!this._lastMouseDown&&((new Date).valueOf()-this._lastMouseEventDate)<250){this._onmouseevent_post($0,
$[15]);
}else if($2==$[128]&&this._lastMouseEventType==$[22]&&((new Date).valueOf()-this._lastMouseEventDate)<250){this._onmouseevent_post($0,
$[91]);
}
switch($2){case $[15]:case $[22]:case $[91]:case $[128]:case $[214]:this._lastMouseEventType=$2;
...
var $2=$0.type;
switch($2){case $[548]:$2=$[260];
break;
case $[91]:case $[128]:if($0.which!==1){return;
}}this._onmouseevent_post($0,
$2,
$1);
}}),
...
break;
case $[22]:if(this._lastMouseDownDispatchTarget===$2&&$0!==this._lastMouseDownDomTarget){$3=true;
...
if(qx.core.Variant.isSet($[1],
$[28])){$9=this._onmouseevent_click_fix($2,
$1,
$5);
}if($1==$[214]&&!this.getAllowClientContextMenu()){qx.event.handler.EventHandler.stopDomEvent($0);
...
$b.setActiveChild($6);
}}switch($1){case $[86]:case $[145]:$8=qx.event.handler.EventHandler.getRelatedTargetObjectFromEvent($0);
if($8==$6){return;
...
$3,
$0);
}else{if($1==$[86]){if(qx.Class.isDefined($[183])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOver($3);
}}}$3.dispose();
$3=null;
qx.ui.core.Widget.flushGlobalQueues();
...
$4,
$5,
$6){switch($0){case $[15]:if(qx.Class.isDefined($[204])){qx.ui.popup.PopupManager.getInstance().update($1);
}
if(qx.Class.isDefined($[185])){qx.ui.menu.Manager.getInstance().update($1,
$0);
}
if(qx.Class.isDefined($[332])){qx.ui.embed.IframeManager.getInstance().handleMouseDown($5);
}break;
case $[22]:if(qx.Class.isDefined($[185])){qx.ui.menu.Manager.getInstance().update($1,
$0);
}
if(qx.Class.isDefined($[332])){qx.ui.embed.IframeManager.getInstance().handleMouseUp($5);
}break;
case $[86]:if(qx.Class.isDefined($[183])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOver($5);
}break;
case $[145]:if(qx.Class.isDefined($[183])){qx.ui.popup.ToolTipManager.getInstance().handleMouseOut($5);
}break;
}this._ignoreWindowBlur=$0===$[15];
if(qx.Class.isDefined($[389])&&$1){qx.event.handler.DragAndDropHandler.getInstance().handleMouseEvent($5);
}},
...
if(qx.Class.isDefined($[204])){qx.ui.popup.PopupManager.getInstance().update();
}if(qx.Class.isDefined($[185])){qx.ui.menu.Manager.getInstance().update();
}if(qx.Class.isDefined($[389])){qx.event.handler.DragAndDropHandler.getInstance().globalCancelDrag();
}qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[1571]);
},
_onwindowfocus:function($0){if(this._focused){return;
}this._focused=true;
qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[1972]);
},
_onwindowresize:function($0){qx.ui.core.ClientDocument.getInstance().createDispatchEvent($[499]);
}},
destruct:function(){this.detachEvents();
this._disposeObjectDeep($[2395],
1);
this._disposeFields($[1319],
$[1716],
$[1963],
$[1342],
$[2323],
$[2259]);
this._disposeFields($[1949],
$[1631],
$[1427],
$[2121],
$[1055]);
...
if(!(this._lastUpDownType[$4]==$[70]&&$3==$[45])){this._idealKeyHandler($1,
$2,
$3,
$0);
...
if($3==$[160]||$3==$[45]){$1=this._charCode2KeyCode[$0.charCode]||$0.keyCode;
...
_specialCharCodeMap:{8:$[382],
9:$[279],
13:$[90],
27:$[215],
32:$[122]},
_keyCodeToIdentifierMap:{16:$[299],
17:$[243],
18:$[280],
20:$[554],
224:$[265],
...
91:$[368],
93:$[359]},
_numpadToCharCode:{96:$[46].charCodeAt(0),
97:$[652].charCodeAt(0),
98:$[568].charCodeAt(0),
99:$[592].charCodeAt(0),
100:$[522].charCodeAt(0),
101:$[542].charCodeAt(0),
102:$[472].charCodeAt(0),
103:$[498].charCodeAt(0),
104:$[470].charCodeAt(0),
105:$[248].charCodeAt(0),
106:$[129].charCodeAt(0),
107:$[201].charCodeAt(0),
109:$[100].charCodeAt(0),
110:$[21].charCodeAt(0),
111:$[56].charCodeAt(0)},
_charCodeA:$[188].charCodeAt(0),
_charCodeZ:$[391].charCodeAt(0),
_charCode0:$[46].charCodeAt(0),
_charCode9:$[248].charCodeAt(0),
...
if($0>=$[46]&&$0<=$[248]){return true;
}
if($0>=$[188]&&$0<=$[391]){return true;
}
switch($0){case $[201]:case $[100]:case $[129]:case $[56]:return true;
...
if(qx.core.Variant.isSet($[1],
$[23])){$1._lastUpDownType={};
$1._charCode2KeyCode={13:13,
27:27};
}else if(qx.core.Variant.isSet($[1],
$[28])){$1._lastUpDownType={};
$1._keyCodeFix={12:$1._identifierToKeyCode($[182])};
}else if(qx.core.Variant.isSet($[1],
$[176])){$1._charCode2KeyCode={63289:$1._identifierToKeyCode($[182]),
63276:$1._identifierToKeyCode($[159]),
63277:$1._identifierToKeyCode($[197]),
63275:$1._identifierToKeyCode($[200]),
63273:$1._identifierToKeyCode($[180]),
63234:$1._identifierToKeyCode($[85]),
63232:$1._identifierToKeyCode($[133]),
63235:$1._identifierToKeyCode($[88]),
63233:$1._identifierToKeyCode($[146]),
63272:$1._identifierToKeyCode($[246]),
63302:$1._identifierToKeyCode($[313]),
63236:$1._identifierToKeyCode($[420]),
63237:$1._identifierToKeyCode($[318]),
63238:$1._identifierToKeyCode($[468]),
63239:$1._identifierToKeyCode($[497]),
63240:$1._identifierToKeyCode($[335]),
63241:$1._identifierToKeyCode($[544]),
63242:$1._identifierToKeyCode($[569]),
63243:$1._identifierToKeyCode($[593]),
63244:$1._identifierToKeyCode($[606]),
63245:$1._identifierToKeyCode($[506]),
63246:$1._identifierToKeyCode($[484]),
63247:$1._identifierToKeyCode($[454]),
63248:$1._identifierToKeyCode($[288]),
3:$1._identifierToKeyCode($[90]),
12:$1._identifierToKeyCode($[182]),
13:$1._identifierToKeyCode($[90])};
}else if(qx.core.Variant.isSet($[1],
$[138])){$1._lastKeyCode=null;
}},
destruct:function(){this._detachEvents();
this._disposeFields($[1227],
$[1622]);
}});
...
destruct:function(){this._disposeFields($[1324],
$[1959]);
}});
...
{"mshtml":function(){if(this.getType()==$[91]){return true;
...
2:$[12],
1:$[33]}}),
_computeButton:function(){switch(this.getDomEvent().type){case $[91]:case $[128]:return $[9];
case $[214]:return $[12];
...
destruct:function(){this._disposeObjectDeep($[676]);
}});
...
destruct:function(){this._disposeFields($[1606]);
}});
...
limit:function($0,
$1,
$2){if(typeof $2===$[58]&&$0>$2){return $2;
}else if(typeof $1===$[58]&&$0<$1){return $1;
}else{return $0;
}}}});
...
this.blockHelper,
this);
this._blocker.addEventListener($[22],
this.blockHelper,
this);
...
if(qx.Class.isDefined($[685])&&$0 instanceof qx.ui.window.Window){this._modalWidgets.push($0);
var $1=$0.getZIndex();
this._getBlocker().setZIndex($1);
$0.setZIndex($1+1);
}else if(qx.Class.isDefined($[407])&&$0 instanceof qx.client.NativeWindow){this._modalNativeWindow=$0;
this._getBlocker().setZIndex(1e7);
}},
release:function($0){if($0){if(qx.Class.isDefined($[407])&&$0 instanceof qx.client.NativeWindow){this._modalNativeWindow=null;
...
_onwindowresize:function($0){if(qx.Class.isDefined($[204])){qx.ui.popup.PopupManager.getInstance().update();
}this._recomputeInnerWidth();
this._recomputeInnerHeight();
qx.ui.core.Widget.flushGlobalQueues();
},
...
defer:function(){if(qx.core.Setting.get($[897])){var $0=qx.core.Client.getInstance().getEngineBoxSizingAttributes();
var $1=$0.join($[501])+$[501];
var $2=$0.join($[471])+$[471];
qx.html.StyleSheet.createElement($[1045]+$[1813]+$[2082]+$1+$[1931]+$[2349]+$2+$[219]);
}
if(qx.core.Setting.get($[2277])){qx.html.StyleSheet.createElement($[2360]);
}},
destruct:function(){this._disposeObjects($[664]);
this._disposeFields($[1548],
$[1570],
$[2109],
$[1952],
$[2163]);
...
}if(this._initialLayoutDone){this.addToJobQueue($[71]);
}},
...
properties:{appearanceTheme:{check:$[148],
nullable:true,
apply:$[2173],
event:$[2399]}},
...
destruct:function(){this._disposeFields($[986],
$[1857]);
}});
...
getMetaThemes:function(){return this.__queryThemes($[474]);
},
getColorThemes:function(){return this.__queryThemes($[532]);
},
getBorderThemes:function(){return this.__queryThemes($[707]);
},
getFontThemes:function(){return this.__queryThemes($[633]);
},
getWidgetThemes:function(){return this.__queryThemes($[403]);
},
getIconThemes:function(){return this.__queryThemes($[656]);
},
getAppearanceThemes:function(){return this.__queryThemes($[423]);
}},
settings:{"qx.theme":$[578],
"qx.colorTheme":null,
"qx.borderTheme":null,
"qx.fontTheme":null,
"qx.widgetTheme":null,
...
{type:$[25],
extend:qx.util.manager.Value,
properties:{colorTheme:{check:$[148],
nullable:true,
apply:$[2090],
event:$[1137]}},
...
rgbToRgbString:function($0){return $[1499]+$0[0]+$[21]+$0[1]+$[21]+$0[2]+$[65];
},
...
{type:$[25],
extend:qx.util.manager.Value,
properties:{borderTheme:{check:$[148],
nullable:true,
apply:$[1206],
event:$[815]}},
...
switch($3){case $[181]:case $[230]:case $[89]:case $[82]:case $[5]:case $[205]:case $[221]:case $[209]:case $[14]:$1.setStyle($3);
break;
...
properties:{widthTop:{check:$[17],
init:0,
apply:$[1956]},
widthRight:{check:$[17],
init:0,
apply:$[1546]},
widthBottom:{check:$[17],
init:0,
apply:$[1679]},
widthLeft:{check:$[17],
init:0,
...
_applyStyleTop:function(){this.__informManager($[16]);
},
_applyStyleRight:function(){this.__informManager($[12]);
},
_applyStyleBottom:function(){this.__informManager($[19]);
},
...
{"gecko":function($0){var $1=$0._style;
$1.borderTopWidth=this.__widthTop||$[50];
$1.borderTopColor=this.__colorTop||$[0];
if(this.__complexTop){$1.borderTopStyle=$[5];
$1.MozBorderTopColors=this.__colorTop+$[54]+this.__colorInnerTop;
...
{"gecko":function($0){var $1=$0._style;
$1.borderRightWidth=this.__widthRight||$[50];
$1.borderRightColor=this.__colorRight||$[0];
if(this.__complexRight){$1.borderRightStyle=$[5];
$1.MozBorderRightColors=this.__colorRight+$[54]+this.__colorInnerRight;
...
{"gecko":function($0){var $1=$0._style;
$1.borderBottomWidth=this.__widthBottom||$[50];
$1.borderBottomColor=this.__colorBottom||$[0];
if(this.__complexBottom){$1.borderBottomStyle=$[5];
$1.MozBorderBottomColors=this.__colorBottom+$[54]+this.__colorInnerBottom;
...
$2=$0._innerStyle;
}$1.borderBottomWidth=$2.borderBottomWidth=$[199];
...
}else{$1.borderBottomWidth=this.__widthBottom||$[50];
...
{"gecko":function($0){var $1=$0._style;
$1.borderLeftWidth=this.__widthLeft||$[50];
$1.borderLeftColor=this.__colorLeft||$[0];
if(this.__complexLeft){$1.borderLeftStyle=$[5];
$1.MozBorderLeftColors=this.__colorLeft+$[54]+this.__colorInnerLeft;
...
qx.Class.define($[2384],
{type:$[25],
extend:qx.util.manager.Value,
properties:{fontTheme:{check:$[148],
nullable:true,
apply:$[1229],
event:$[1589]}},
...
var $3=[];
var $4;
for(var $5=0;$5<$2.length;$5++){switch($4=$2[$5]){case $[261]:$1.setBold(true);
break;
case $[510]:$1.setItalic(true);
break;
case $[388]:$1.setDecoration($[388]);
break;
...
reset:function($0){$0.removeStyleProperty($[639]);
$0.removeStyleProperty($[177]);
$0.removeStyleProperty($[518]);
$0.removeStyleProperty($[449]);
$0.removeStyleProperty($[635]);
},
...
$1){var $2=$[0];
for(var $3=0,
$4=$0.length;$3<$4;$3++){if($0[$3].indexOf($[54])>0){$2+=$[105]+$0[$3]+$[105];
}else{$2+=$0[$3];
}
if($3!=$4-1){$2+=$[21];
}}this.__family=$2;
...
$1){this.__bold=$0===null?null:$0?$[261]:$[222];
},
_applyItalic:function($0,
$1){this.__italic=$0===null?null:$0?$[510]:$[222];
},
_applyDecoration:function($0,
$1){this.__decoration=$0===null?null:$0;
},
render:function($0){$0.setStyleProperty($[639],
this.__family);
$0.setStyleProperty($[177],
this.__size);
$0.setStyleProperty($[518],
this.__bold);
$0.setStyleProperty($[449],
this.__italic);
$0.setStyleProperty($[635],
this.__decoration);
},
...
generateStyle:function(){return (this.__family?$[1944]+this.__family.replace(/\"/g,
$[174])+$[92]:$[0])+(this.__size?$[1244]+this.__size+$[92]:$[0])+(this.__weight?$[1965]+this.__weight+$[92]:$[0])+(this.__style?$[1505]+this.__style+$[92]:$[0])+(this.__decoration?$[1747]+this.__decoration+$[92]:$[0]);
}}});
...
{type:$[25],
extend:qx.core.Target,
properties:{iconTheme:{check:$[148],
nullable:true,
apply:$[1545],
event:$[1887]}},
...
{type:$[25],
extend:qx.core.Target,
properties:{widgetTheme:{check:$[148],
nullable:true,
apply:$[1811],
event:$[2354]}},
...
$1){if($1.getKeyIdentifier()!=$[279]){return;
}$1.stopPropagation();
$1.preventDefault();
...
destruct:function(){this._disposeFields($[1572]);
}});
...
while($0.tagName.toLowerCase()!=$[152]){$0=$0.offsetParent;
...
destruct:function(){this._disposeFields($[1061],
$[1917]);
}});
...
$[103]);
if($3!=$[74]&&$3!=$[150]){$1-=qx.html.Style.getBorderLeft($2);
}if($4!=$[74]&&$4!=$[150]){while($2){$2=$2.parentNode;
if(!$2||typeof $2.tagName!==$[10]){break;
}var $5=qx.html.Style.getStyleProperty($2,
$[103]);
if($5==$[74]||$5==$[150]){$1-=qx.html.Style.getBorderLeft($2)+qx.html.Style.getPaddingLeft($2);
break;
}}}return $1;
},
...
var $4=qx.html.Style.getStyleProperty($2,
$[103]);
if($3!=$[74]&&$3!=$[150]){$1-=qx.html.Style.getBorderTop($2);
}if($4!=$[74]&&$4!=$[150]){while($2){$2=$2.parentNode;
if(!$2||typeof $2.tagName!==$[10]){break;
}var $5=qx.html.Style.getStyleProperty($2,
$[103]);
if($5==$[74]||$5==$[150]){$1-=qx.html.Style.getBorderTop($2)+qx.html.Style.getPaddingTop($2);
break;
}}}return $1;
},
...
$[87])){case $[37]:case $[3]:case $[362]:$5=true;
break;
default:switch(qx.html.Style.getStyleProperty($6,
$[212])){case $[37]:case $[3]:$5=true;
break;
default:$5=false;
}}
...
if($6.tagName.toLowerCase()==$[152]){break;
}$6=$6.offsetParent;
}return true;
},
scrollY:function($0,
...
while($6){switch(qx.html.Style.getStyleProperty($6,
$[87])){case $[37]:case $[3]:case $[352]:$5=true;
break;
default:switch(qx.html.Style.getStyleProperty($6,
$[213])){case $[37]:case $[3]:$5=true;
break;
default:$5=false;
}}
...
}this._timer=new qx.client.Timer(qx.core.Setting.get($[1820]));
this._timer.addEventListener($[99],
this.__oninterval,
this);
...
$1.addEventListener($[71],
this.__onload,
this);
$1.addEventListener($[116],
this.__onerror,
this);
}}this._check();
},
...
destruct:function(){if(this._timer){this._timer.removeEventListener($[99],
this.__oninterval,
this);
this._disposeObjects($[266]);
}this._disposeFields($[934]);
}});
...
destruct:function(){this._disposeFields($[676]);
}});
...
this._element.src=$0;
if(qx.core.Variant.isSet($[1],
$[23])){this._isPng=/\.png$/i.test(this._element.nameProp);
...
if(this.hasEventListeners($[71])){this.dispatchEvent(new qx.event.type.Event($[71]),
true);
}},
...
if(this.hasEventListeners($[116])){this.dispatchEvent(new qx.event.type.Event($[116]),
true);
}}},
destruct:function(){if(this._element){this._element.onload=this._element.onerror=null;
}this._disposeFields($[316],
$[2320],
$[1954],
$[2122]);
}});
...
/* ID: demobrowser.Application */
qx.Class.define($[886],
{extend:qx.application.Gui,
members:{main:function(){arguments.callee.base.call(this);
qx.io.Alias.getInstance().add($[1034],
qx.core.Setting.get($[1444]));
qx.html.StyleSheet.includeFile(qx.io.Alias.getInstance().resolve($[2335]));
qx.html.StyleSheet.includeFile(qx.io.Alias.getInstance().resolve($[1075]));
...
_load:function(){this.viewer.dataLoader($[2358]);
}},
settings:{"demobrowser.resourceUri":$[475]},
destruct:function(){this._disposeObjects($[1201]);
}});
...
properties:{orientation:{check:[$[27],
$[34]],
init:$[27],
apply:$[719],
event:$[2375]},
...
themeable:true,
apply:$[1481]},
verticalChildrenAlign:{check:[$[16],
$[33],
$[19]],
init:$[16],
themeable:true,
...
defaultValue:null}},
members:{_createLayoutImpl:function(){return this.getOrientation()==$[34]?new qx.ui.layout.impl.VerticalBoxLayoutImpl(this):new qx.ui.layout.impl.HorizontalBoxLayoutImpl(this);
},
...
$1){this._layoutHorizontal=$0==$[27];
this._layoutVertical=$0==$[34];
...
if(($0.getHorizontalAlign()||this.getWidget().getHorizontalChildrenAlign())==$[59]){$0.addToLayoutChanges($[125]);
}return $1||$2;
},
updateChildOnInnerHeightChange:function($0){if(this.getWidget().getVerticalChildrenAlign()==$[33]){$0.addToLayoutChanges($[141]);
...
if($0.horizontalChildrenAlign){$3._addChildrenToLayoutQueue($[125]);
}
if($0.stretchChildrenOrthogonalAxis){$1=true;
}if($1){$3._recomputeChildrenStretchingX();
$3._addChildrenToLayoutQueue($[30]);
}
if($2){$3._recomputeChildrenStretchingY();
$3._addChildrenToLayoutQueue($[35]);
}return true;
},
updateChildrenOnRemoveChild:function($0,
$1){var $2=this.getWidget(),
...
}switch($2.getLayoutMode()){case $[19]:case $[264]:while(($5=$3[++$6])&&$6<$1){$5.addToLayoutChanges($[141]);
}break;
case $[33]:case $[272]:while($5=$3[++$6]){$5.addToLayoutChanges($[141]);
}break;
default:$6+=$1;
...
switch($1.getLayoutMode()){case $[19]:case $[264]:for(var $5=$3-1;$5>=0&&!$0[$2[$5].toHashCode()];$5--){}for(var $6=0;$6<=$5;$6++){$1._layoutChild($4=$2[$6]);
}break;
case $[33]:case $[272]:$5=-1;
...
layoutChild_locationY:function($0,
$1){var $2=this.getWidget();
if($2.getFirstVisibleChild()==$0){switch($2.getLayoutMode()){case $[19]:case $[264]:var $3=$2.getPaddingBottom()+$2.getAccumulatedChildrenOuterHeight()-$0.getOuterHeight();
break;
case $[33]:case $[272]:var $3=$2.getPaddingTop()+Math.round(($2.getInnerHeight()-$2.getAccumulatedChildrenOuterHeight())/2);
break;
default:var $3=$2.getPaddingTop();
}}else{var $4=$0.getPreviousVisibleSibling();
switch($2.getLayoutMode()){case $[19]:case $[264]:var $3=$4._cachedLocationVertical-$0.getOuterHeight()-$2.getSpacing();
break;
default:var $3=$4._cachedLocationVertical+$4.getOuterHeight()+$2.getSpacing();
}}$0._cachedLocationVertical=$3;
switch(this.getWidget().getLayoutMode()){case $[19]:case $[1707]:case $[272]:$3+=!$0._computedBottomTypeNull?$0.getBottomValue():!$0._computedTopTypeNull?-($0.getTopValue()):0;
$0._resetRuntimeTop();
...
$1){var $2=this.getWidget();
if(qx.core.Variant.isSet($[1],
$[28])){if($0.getAllowStretchX()&&$2.getStretchChildrenOrthogonalAxis()&&$0._computedWidthTypeNull){$0._renderRuntimeLeft($2.getPaddingLeft()||0);
$0._renderRuntimeRight($2.getPaddingRight()||0);
return;
}}var $3=$0.getHorizontalAlign()||$2.getHorizontalChildrenAlign();
var $4=$3==$[59]?Math.round(($2.getInnerWidth()-$0.getOuterWidth())/2):0;
...
qx.Class.define($[1999],
{statics:{isValid:function($0){switch(typeof $0){case $[6]:return false;
case $[39]:return $0!==null;
case $[10]:return $0!==$[0];
case $[58]:return !isNaN($0);
case $[51]:case $[77]:return true;
}return false;
},
isInvalid:function($0){switch(typeof $0){case $[6]:return true;
case $[39]:return $0===null;
case $[10]:return $0===$[0];
case $[58]:return isNaN($0);
case $[51]:case $[77]:return false;
}return true;
},
isValidNumber:function($0){return typeof $0===$[58]&&!isNaN($0);
},
isInvalidNumber:function($0){return typeof $0!==$[58]||isNaN($0);
},
isValidString:function($0){return typeof $0===$[10]&&$0!==$[0];
},
isInvalidString:function($0){return typeof $0!==$[10]||$0===$[0];
},
isValidArray:function($0){return typeof $0===$[39]&&$0!==null&&$0 instanceof Array;
},
isInvalidArray:function($0){return typeof $0!==$[39]||$0===null||!($0 instanceof Array);
},
isValidObject:function($0){return typeof $0===$[39]&&$0!==null&&!($0 instanceof Array);
},
isInvalidObject:function($0){return typeof $0!==$[39]||$0===null||$0 instanceof Array;
},
isValidNode:function($0){return typeof $0===$[39]&&$0!==null;
},
isInvalidNode:function($0){return typeof $0!==$[39]||$0===null;
},
isValidElement:function($0){return typeof $0===$[39]&&$0!==null||$0.nodeType!==1;
},
isInvalidElement:function($0){return typeof $0!==$[39]||$0===null||$0.nodeType!==1;
},
isValidFunction:function($0){return typeof $0===$[51];
},
isInvalidFunction:function($0){return typeof $0!==$[51];
},
isValidBoolean:function($0){return typeof $0===$[77];
},
isInvalidBoolean:function($0){return typeof $0!==$[77];
},
...
updateChildOnInnerWidthChange:function($0){if(this.getWidget().getHorizontalChildrenAlign()==$[59]){$0.addToLayoutChanges($[125]);
...
if(($0.getVerticalAlign()||this.getWidget().getVerticalChildrenAlign())==$[33]){$0.addToLayoutChanges($[141]);
}return $1||$2;
},
...
var $3=this.getWidget();
if($0.orientation){$1=$2=true;
}if($0.spacing||$0.orientation||$0.reverseChildrenOrder||$0.horizontalChildrenAlign){$3._addChildrenToLayoutQueue($[125]);
}
...
}switch($2.getLayoutMode()){case $[12]:case $[251]:while(($5=$3[++$6])&&$6<$1){$5.addToLayoutChanges($[125]);
}break;
case $[59]:case $[274]:while($5=$3[++$6]){$5.addToLayoutChanges($[125]);
}break;
default:$6+=$1;
while($5=$3[++$6]){$5.addToLayoutChanges($[125]);
}}},
updateChildrenOnMoveChild:function($0,
$1,
$2){var $3=this.getWidget().getVisibleChildren();
...
var $5=Math.max($1,
$2)+1;
for(var $6=$4;$6<$5;$6++){$3[$6].addToLayoutChanges($[125]);
}},
flushChildrenQueue:function($0){var $1=this.getWidget(),
$2=$1.getVisibleChildren(),
$3=$2.length,
...
switch($1.getLayoutMode()){case $[12]:case $[251]:for(var $5=$3-1;$5>=0&&!$0[$2[$5].toHashCode()];$5--){}for(var $6=0;$6<=$5;$6++){$1._layoutChild($4=$2[$6]);
}break;
case $[59]:case $[274]:$5=-1;
while($4=$2[++$5]){$1._layoutChild($4);
}break;
default:$5=-1;
var $7=false;
...
layoutChild_locationX:function($0,
$1){var $2=this.getWidget();
if($2.getFirstVisibleChild()==$0){switch($2.getLayoutMode()){case $[12]:case $[251]:var $3=$2.getPaddingRight()+$2.getAccumulatedChildrenOuterWidth()-$0.getOuterWidth();
break;
case $[59]:case $[274]:var $3=$2.getPaddingLeft()+Math.round(($2.getInnerWidth()-$2.getAccumulatedChildrenOuterWidth())/2);
break;
default:var $3=$2.getPaddingLeft();
}}else{var $4=$0.getPreviousVisibleSibling();
switch($2.getLayoutMode()){case $[12]:case $[251]:var $3=$4._cachedLocationHorizontal-$0.getOuterWidth()-$2.getSpacing();
break;
default:var $3=$4._cachedLocationHorizontal+$4.getOuterWidth()+$2.getSpacing();
}}$0._cachedLocationHorizontal=$3;
switch($2.getLayoutMode()){case $[12]:case $[1456]:case $[274]:$3+=!$0._computedRightTypeNull?$0.getRightValue():!$0._computedLeftTypeNull?-($0.getLeftValue()):0;
$0._resetRuntimeLeft();
...
$1){var $2=this.getWidget();
if(qx.core.Variant.isSet($[1],
$[28])){if($0.getAllowStretchY()&&$2.getStretchChildrenOrthogonalAxis()&&$0._computedHeightTypeNull){$0._renderRuntimeTop($2.getPaddingTop()||0);
$0._renderRuntimeBottom($2.getPaddingBottom()||0);
return;
}}var $3=$0.getVerticalAlign()||$2.getVerticalChildrenAlign();
var $4=$3==$[33]?Math.round(($2.getInnerHeight()-$0.getOuterHeight())/2):0;
if($3==$[19]){$4+=$2.getPaddingBottom();
...
var $0=new qx.ui.splitpane.HorizontalSplitPane(200,
$[42]);
this.add($0);
this.mainsplit=$0;
$0.setLiveResize(true);
$0.set({height:$[42]});
var $1=this.__makeLeft();
this.left=$1.buttview;
this.mainsplit.addLeft($1);
...
this.toolbar.set({show:$[120],
verticalChildrenAlign:$[33]});
$2.add(this.toolbar);
var $3=this.__makeOutputViews();
$2.add($3);
this.widgets[$[512]].setChecked(true);
this.__setStateInitialized();
this._history=qx.client.History.getInstance();
this._history.addEventListener($[587],
function($4){var $5=$4.getData().replace($[495],
$[56]);
if(this._currentSample!=$5){this.setCurrentSample($5);
}},
this);
this.__states={};
...
statics:{Img_PlayAll_Default:$[1504],
Img_PlayAll_Stop:$[1866]},
properties:{playAll:{check:$[2],
apply:$[1776],
init:false}},
members:{__makeHeader:function(){var $0=new qx.ui.embed.HtmlEmbed($[1517]+$[1110]+$[1093]+$[173]+$[1988]+$[773]+qx.core.Version.toString()+$[390]);
$0.setHtmlProperty($[255],
$[576]);
$0.setStyleProperty($[84],
$[1765]+qx.io.Alias.getInstance().resolve($[1941])+$[1879]);
$0.setHeight(70);
return $0;
},
__makeCommands:function(){this._cmdObjectSummary=new qx.client.Command($[971]);
this._cmdObjectSummary.addEventListener($[29],
function(){var $0=this.f1.getContentWindow();
if($0&&$0.qx){alert($0.qx.dev.ObjectSummary.getInfo());
}else{alert("Unable to access Sample namespace currently.");
}},
this);
this._cmdRunSample=new qx.client.Command($[335]);
this._cmdRunSample.addEventListener($[29],
this.runSample,
this);
this._cmdPrevSample=new qx.client.Command($[1687]);
this._cmdPrevSample.addEventListener($[29],
this.playPrev,
this);
this._cmdNextSample=new qx.client.Command($[1171]);
this._cmdNextSample.addEventListener($[29],
this.playNext,
this);
this._cmdSampleInOwnWindow=new qx.client.Command();
this._cmdSampleInOwnWindow.addEventListener($[29],
function($1){var $2=this.f1.getContentWindow().location.href;
var $3=new qx.client.NativeWindow($2,
$[1638]);
this.widgets[$[1943]]=$3;
$3.setDimension(700,
550);
...
this._cmdLoadProfile.addEventListener($[29],
function($1){var $4=$1.getData().getChecked();
this._useProfile=$4;
this.runSample();
},
this);
this._cmdProfile=new qx.client.Command($[2189]);
this._cmdProfile.addEventListener($[29],
function($1){var $4=$1.getData().getChecked();
var $0=this.f1.getContentWindow();
if($0&&$0.qx){if($4){$0.qx.dev.Profile.start();
}else{$0.qx.dev.Profile.stop();
$0.qx.dev.Profile.normalizeProfileData();
this.showProfile($0.qx.dev.Profile.getProfileData());
this._cmdShowLastProfile.setEnabled(true);
}}this._cmdProfile.setEnabled(false);
this.widgets[$[340]].setChecked($4);
this.widgets[$[395]].setChecked($4);
this._cmdProfile.setEnabled(true);
},
this);
this._cmdProfile.setUserData($[115],
true);
this._cmdShowLastProfile=new qx.client.Command();
this._cmdShowLastProfile.addEventListener($[29],
function(){var $0=this.f1.getContentWindow();
if($0&&$0.qx){$0.qx.dev.Profile.normalizeProfileData();
this.showProfile($0.qx.dev.Profile.getProfileData());
}},
this);
this._cmdDisposeSample=new qx.client.Command();
this._cmdDisposeSample.addEventListener($[29],
function($1){var $0=this.f1.getContentWindow();
if($0&&$0.qx){$0.qx.core.Object.dispose();
alert("Done!");
}else{alert("Unable to access Sample namespace currently.");
...
this._cmdNamespacePollution.addEventListener($[29],
function($1){var $0=this.f1.getContentWindow();
if($0&&$0.qx){alert($0.qx.dev.Pollution.getInfo());
}else{alert("Unable to access Sample namespace currently.");
}},
this);
},
__setStateInitialized:function(){this._cmdObjectSummary.setEnabled(false);
...
this.widgets[$[312]].setEnabled(false);
this.widgets[$[139]].setEnabled(true);
},
__setStateLoading:function(){this.__states.isLoading=true;
this.__setStateInitialized();
if(!this.isPlayAll()){this.widgets[$[139]].setEnabled(false);
}},
__setStateLoaded:function(){this.__states.isLoading=false;
this.widgets[$[139]].setEnabled(true);
this.widgets[$[233]].resetEnabled();
this.widgets[$[241]].resetEnabled();
this.widgets[$[338]].resetEnabled();
this.widgets[$[158]].resetEnabled();
},
__setStateSampleLoaded:function(){this._cmdObjectSummary.setEnabled(true);
this._cmdRunSample.setEnabled(true);
if(!this.__states.isFirstSample){this._cmdPrevSample.setEnabled(true);
}
if(!this.__states.isLastSample){this._cmdNextSample.resetEnabled();
}this._cmdSampleInOwnWindow.setEnabled(true);
this.widgets[$[139]].setEnabled(true);
this.widgets[$[340]].setChecked(true);
this.widgets[$[395]].setChecked(true);
...
__fillAppearanceMenu:function(){var $0=this.f1.getContentWindow();
if($0&&$0.qx){var $1=this.widgets[$[312]];
$1.setEnabled(true);
var $2=$1.getMenu();
$2.removeAll();
var $3=$0.qx.theme.manager.Meta.getInstance();
var $4=$3.getMetaThemes();
var $5=new qx.ui.selection.RadioManager();
for(var $6=0,
$7=$4.length;$6<$7;$6++){theme=$4[$6];
if(theme.type===$[49]){continue;
}var $8=(theme==$3.getTheme());
var $9=new qx.ui.menu.RadioButton(theme.title,
null,
$8);
$9.setUserData($[662],
theme);
$9.addEventListener($[29],
function($a){$3.setTheme($a.getTarget().getUserData($[662]));
});
$5.add($9);
$2.add($9);
}}},
__makeMenuBar:function(){var $0=[{label:$[911],
items:[{label:$[1630],
...
{label:$[409],
type:$[380],
checked:this._cmdProfile.getUserData($[115]),
...
var $2=function($3,
$4){var $5={};
for(var $6 in $4){if($6!==$[1593]&&$6!==$[1274]&&$6!==$[165]&&$6!==$[255]){$5[$6]=$4[$6];
}}$3.set($5);
if($4.id!==undefined){$1.widgets[$4.id]=$3;
}
if($4.command!==undefined){$4.command.addEventListener($[276],
function($7){$3.setEnabled($7.getValue());
});
}};
var $8=function($9){var $a=new qx.ui.menu.Menu();
for(var $b=0;$b<$9.length;$b++){var $c=$9[$b];
var $d=$c.type||$[435];
switch($d){case $[435]:var $e=new qx.ui.menu.Button($c.label);
break;
case $[380]:var $e=new qx.ui.menu.CheckBox($c.label);
break;
case $[413]:var $e=new qx.ui.menu.Separator;
break;
default:throw new Error("Invalid case : '"+$d+"'!");
}$2($e,
$c);
$a.add($e);
}$a.addToDocument();
...
var $f=new qx.ui.menubar.MenuBar();
for(var $b=0;$b<$0.length;$b++){var $g=new qx.ui.menubar.Button($0[$b].label);
$g.setMenu($8($0[$b].items));
$2($g,
$0[$b]);
$f.add($g);
}return $f;
},
__bindCommand:function($0,
$1){$0.setCommand($1);
$1.addEventListener($[276],
function($2){$0.setEnabled($2.getValue());
});
},
__makeToolbar:function(){var $0=new qx.ui.toolbar.ToolBar;
$0.setBorder($[1207]);
$0.setHeight(27);
var $1=new qx.ui.toolbar.Part();
$0.add($1);
this.widgets[$[1825]]=$1;
this.runbutton=new qx.ui.toolbar.Button($[1892],
$[1408]);
$1.add(this.runbutton);
this.widgets[$[324]]=this.runbutton;
this.__bindCommand(this.runbutton,
this._cmdRunSample);
this.runbutton.setToolTip(new qx.ui.popup.ToolTip($[2265]));
var $2=new qx.ui.toolbar.Button($[1030],
demobrowser.DemoBrowser.Img_PlayAll_Default);
this.widgets[$[139]]=$2;
$1.add($2);
$2.addEventListener($[29],
this.__ehPlayAll,
this);
$2.setToolTip(new qx.ui.popup.ToolTip($[2366]));
var $3=new qx.ui.toolbar.Button($[2242],
$[1491]);
$1.add($3);
this.widgets[$[1292]]=$3;
this.__bindCommand($3,
this._cmdPrevSample);
$3.setToolTip(new qx.ui.popup.ToolTip($[751]));
var $4=new qx.ui.toolbar.Button($[786],
$[821]);
$1.add($4);
this.widgets[$[353]]=$4;
this.__bindCommand($4,
this._cmdNextSample);
$4.setToolTip(new qx.ui.popup.ToolTip($[733]));
var $5=new qx.ui.toolbar.Button($[1369],
$[2022]);
$1.add($5);
this.widgets[$[2083]]=$5;
$5.setToolTip(new qx.ui.popup.ToolTip($[2004]));
this.__bindCommand($5,
this._cmdSampleInOwnWindow);
$0.add((new qx.ui.basic.HorizontalSpacer).set({width:$[42]}));
var $6=new qx.ui.toolbar.Part();
$0.add($6);
this.widgets[$[811]]=$6;
$6.set({height:$[11],
width:$[3],
...
$6.resetBorder();
$6.setEnabled(false);
var $7=new qx.ui.toolbar.CheckBox($[409],
$[1900],
this._cmdProfile.getUserData($[115]));
$6.add($7);
this.__bindCommand($7,
this._cmdProfile);
$7.setToolTip(new qx.ui.popup.ToolTip($[2018]));
this.widgets[$[340]]=$7;
var $8=new qx.ui.toolbar.Button($[584],
$[1993]);
$6.add($8);
$8.set({height:$[11],
width:$[3],
command:this._cmdObjectSummary});
this.__bindCommand($8,
this._cmdObjectSummary);
$8.setToolTip(new qx.ui.popup.ToolTip($[2249]));
var $9=new qx.ui.toolbar.Button($[1920],
$[764]);
$6.add($9);
this.__bindCommand($9,
this._cmdNamespacePollution);
$9.setToolTip(new qx.ui.popup.ToolTip($[1181]));
return $0;
},
showProfile:function($0){if(!this._profWindow){var $1=new qx.ui.window.Window($[1321]);
$1.set({space:[20,
800,
20,
600],
...
$1.addToDocument();
this._profWindow=$1;
var $2=new qx.ui.table.model.Simple();
$2.setColumns([$[76],
$[460],
$[2161],
$[1397],
$[1490]]);
$2.setData([]);
this._profTableModel=$2;
var $3={tableColumnModel:function($4){return new qx.ui.table.columnmodel.Resize($4);
}};
var $5=new qx.ui.table.Table($2,
$3);
$5.set({height:$[11],
width:$[11]});
var $6=$5.getTableColumnModel();
var $7=$6.getBehavior();
$7.set(0,
{width:$[1392],
minWidth:50});
...
for(var $9 in $0){var $a=$0[$9];
if($a.name==$[824]){continue;
}$8.push([$a.name+$[687],
$a.type,
$a.calibratedOwnTime,
$a.calibratedOwnTime/$a.callCount,
$a.callCount]);
}this._profTableModel.setData($8);
this._profTableModel.sortByColumn(2);
this._profWindow.open();
},
__makeOutputViews:function(){var $0=new qx.ui.pageview.tabview.TabView();
$0.set({height:$[42],
padding:10});
this.widgets[$[338]]=$0;
this.widgets[$[233]]=$0.getBar();
var $1=new qx.ui.pageview.tabview.Button($[2057],
$[1979]);
this.widgets[$[399]]=$1;
$1.setChecked(true);
$0.getBar().add($1);
var $2=new qx.ui.pageview.tabview.Page($1);
$2.set({padding:[5]});
$0.getPane().add($2);
var $3=new qx.ui.embed.Iframe;
this.f1=$3;
$2.add($3);
this.widgets[$[241]]=$3;
$3.set({overflow:$[3],
...
width:$[11],
border:$[163]});
$3.addEventListener($[71],
this.__ehIframeLoaded,
this);
var $4=new qx.ui.pageview.tabview.Button($[1046],
$[2016]);
$0.getBar().add($4);
var $5=new qx.ui.pageview.tabview.Page($4);
$5.set({padding:[5]});
$0.getPane().add($5);
var $6=new qx.ui.layout.VerticalBoxLayout();
$5.add($6);
$6.set({height:$[11],
width:$[11]});
this.f2=new qx.ui.embed.HtmlEmbed();
$6.add(this.f2);
this.f2.set({overflow:$[3],
height:$[42],
width:$[11],
border:$[163],
font:$[415]});
this.logappender=new qx.log.appender.HtmlElement;
this.logger=new qx.log.Logger($[1524]);
this.logger.addAppender(this.logappender);
this.f2.addEventListener($[162],
function($7){this.logappender.setElement(this.f2.getElement());
},
this);
var $8=new qx.ui.pageview.tabview.Button($[1591],
$[753]);
$0.getBar().add($8);
var $9=new qx.ui.pageview.tabview.Page($8);
$9.set({padding:[5]});
$0.getPane().add($9);
var $a=new qx.ui.embed.HtmlEmbed($[1067]);
$9.add($a);
this.widgets[$[477]]=$a;
$a.set({overflow:$[3],
width:$[11],
...
border:$[163],
font:$[415]});
$a.setHtmlProperty($[255],
$[2367]);
return $0;
},
__makeLeft:function(){var $0=new qx.ui.pageview.buttonview.ButtonView();
$0.set({height:$[11],
width:$[11],
border:$[2159]});
$0.getPane().setPadding(0);
this.widgets[$[158]]=$0;
var $1=new qx.ui.pageview.buttonview.Button($[631],
$[1047]);
$0.getBar().add($1);
this.widgets[$[512]]=$1;
$1.setShow($[120]);
$1.setToolTip(new qx.ui.popup.ToolTip($[2186]));
var $2=new qx.ui.pageview.buttonview.Page($1);
$2.set({width:$[11],
height:$[11],
backgroundColor:$[62]});
$0.getPane().add($2);
var $3=new qx.ui.tree.Tree($[2369]);
$2.add($3);
this.tree=$3;
this.widgets[$[131]]=$3;
$1.setUserData($[537],
...
padding:5,
overflow:$[3]});
$3.getManager().addEventListener($[168],
this.treeGetSelection,
this);
$3.addEventListener($[128],
function($4){if($4.getTarget() instanceof qx.ui.tree.TreeFile){qx.client.Timer.once(this.runSample,
this,
50);
}else{this.setCurrentSample(this.defaultUrl);
}},
this);
var $5=new qx.ui.pageview.buttonview.Button($[1607],
$[1502]);
this.widgets[$[863]]=$5;
$5.setShow($[120]);
$5.setToolTip(new qx.ui.popup.ToolTip($[874]));
var $6=new qx.ui.pageview.buttonview.Page($5);
$0.getPane().add($6);
var $7=new qx.ui.tree.Tree($[1247]);
$6.add($7);
this.tree1=$7;
this.widgets[$[300]]=$7;
$5.setUserData($[537],
...
padding:5,
overflow:$[3]});
$7.getManager().addEventListener($[168],
this.treeGetSelection,
this);
this.tree={};
var $8=this;
this.tree.getSelectedElement=function(){var $9=$8.widgets[$[158]].getBar().getManager().getSelected();
var $a;
if($9.getLabel()==$[631]){$a=$8.widgets[$[131]].getSelectedElement();
}else{$a=$8.widgets[$[300]].getSelectedElement();
}return $a;
};
return $0;
},
treeGetSelection:function($0){if(!this.tree.getSelectedElement()){return;
}var $1=this.tree.getSelectedElement();
var $2=$1.getUserData($[203]);
this.tests.selected=this.tests.handler.getFullName($2);
if($1 instanceof qx.ui.tree.TreeFolder){this._cmdRunSample.setEnabled(false);
this._cmdPrevSample.setEnabled(false);
this._cmdNextSample.setEnabled(false);
this._cmdSampleInOwnWindow.setEnabled(false);
}else{this._cmdRunSample.setEnabled(true);
if($1.getUserData($[290]).getPrevSibling()){this._cmdPrevSample.setEnabled(true);
this.__states.isFirstSample=false;
}else{this._cmdPrevSample.setEnabled(false);
this.__states.isFirstSample=true;
}
if($1.getUserData($[290]).getNextSibling()){this._cmdNextSample.setEnabled(true);
this.__states.isLastSample=false;
}else{this._cmdNextSample.setEnabled(false);
this.__states.isLastSample=true;
}}},
leftReloadTree:function($0){this._sampleToTreeNodeMap={};
var $1=this._sampleToTreeNodeMap;
function $2($3,
$4){var $5=$4.getChildren();
var $6,
$7,
$8;
for(var $9=0;$9<$5.length;$9++){var $a=$5[$9];
if($a.hasChildren()){$6=new qx.ui.tree.TreeFolder($h.polish($a.label),
$[655]);
$6.setUserData($[357],
false);
$6.setUserData($[677],
$a);
$6.setAlwaysShowPlusMinusSymbol(true);
$6.addEventListener($[551],
function($0){if(!this.getUserData($[357])){$2(this,
this.getUserData($[677]));
this.setUserData($[357],
true);
}});
if($a.label==$[2220]){$6.setOpen(true);
}}else{$6=new qx.ui.tree.TreeFile($h.polish($a.label),
$[2261]);
var $b=$a.pwd().slice(1).join($[56])+$[56]+$a.label;
$1[$b]=$6;
$8=$a.desc;
$8=$8.replace(/<p>/g,
$[1516]);
...
}$7=new qx.ui.popup.ToolTip($8,
$[2343]);
$7.getAtom().getLabelObject().setWrap(true);
$7.setShowInterval(200);
$6.setToolTip($7);
}$3.add($6);
$6.setUserData($[203],
$a);
$a.widgetLinkFull=$6;
if($h.tests.handler.getFullName($a)==$h.tests.selected){$m=$a;
}}}function $c($3,
$4){var $d=$4.getIterator($[268]);
var $a;
while($a=$d()){if(!($a.type&&$a.type==$[137])){if($g.hasTests($a)){var $b=$g.getFullName($a);
var $6=new qx.ui.tree.TreeFolder($h.polish($b),
$[655]);
$3.add($6);
$6.setUserData($[203],
$a);
...
for(var $9=0;$9<$5.length;$9++){if($5[$9].type&&$5[$9].type==$[137]){var $e=new qx.ui.tree.TreeFile($h.polish($5[$9].label),
$[2118]);
$e.setToolTip(new qx.ui.popup.ToolTip($5[$9].desc));
$6.add($e);
$e.setUserData($[203],
$5[$9]);
$5[$9].widgetLinkFlat=$e;
if($h.tests.handler.getFullName($5[$9])==$h.tests.selected){$m=$5[$9];
}}}}}}}var $f=this.tests.handler.ttree;
var $g=this.tests.handler;
var $h=this;
this.widgets[$[158]].setEnabled(false);
var $i=this.widgets[$[131]];
var $j=this.widgets[$[300]];
var $k=[$i,
$j];
var $l=this.widgets[$[158]].getBar().getManager().getSelected();
for(var $9=0;$9<$k.length;$9++){$k[$9].resetSelected();
$k[$9].destroyContent();
$k[$9].setUserData($[203],
$f);
}$f.widgetLinkFull=$i;
...
$2(this.widgets[$[131]],
$f);
this.widgets[$[158]].setEnabled(true);
if($m){if($m.widgetLinkFull){this.widgets[$[131]].setSelectedElement($m.widgetLinkFull);
if($m.widgetLinkFull instanceof qx.ui.tree.TreeFolder){$m.widgetLinkFull.open();
}}
if($m.widgetLinkFlat){this.widgets[$[300]].setSelectedElement($m.widgetLinkFlat);
if($m.widgetLinkFlat instanceof qx.ui.tree.TreeFolder){$m.widgetLinkFlat.open();
}}}},
runSample:function($0){if(!this.tests.selected){return;
}
if(!this.widgets[$[324]].isEnabled()){return;
}
if(true){var $1=this.tests.selected.replace($[32],
$[56]);
this.setCurrentSample($1);
}},
setCurrentSample:function($0){if(!$0){return;
}
if(!this._sampleToTreeNodeMap){return;
}this.widgets[$[233]].getManager().setSelected(this.widgets[$[399]]);
this.widgets[$[241]].setEnabled(false);
this.__setStateLoading();
var $1=this.widgets[$[241]].getContentDocument();
if($1){$1.body.innerHTML=$[0];
}this.widgets[$[233]].setEnabled(false);
this.widgets[$[338]].setEnabled(false);
var $2;
var $3=this._sampleToTreeNodeMap[$0];
if($3){$3.setSelected(true);
$2=$[1822]+$0;
if(this._useProfile){$2+=$[2204];
}else{$2+=$[766];
}}else{$2=this.defaultUrl;
}this.widgets[$[158]].setEnabled(false);
this.logappender.clear();
this.logger.info("load demo: "+$0);
this._currentSampleUrl==$2?this.f1.reload():this.f1.setSource($2);
this._currentSample=$0;
this._currentSampleUrl=$2;
},
__ehIframeLoaded:function($0){var $1=this.f1.getContentWindow();
var $2=$1.location.pathname+$[0];
var $3=$2.indexOf($[109]);
if($3!=-1){$2=$2.substring(0,
$3+1);
}var $4=$2.split($[56]);
if(this.f1.getSource()!=$[0]&&this.f1.getSource()!=this.defaultUrl){$1.qx.log.Logger.ROOT_LOGGER.removeAllAppenders();
$1.qx.log.Logger.ROOT_LOGGER.addAppender(this.logappender);
var $5=$1.location.href;
var $6=$5.indexOf($[1352])+6;
var $7=$5.indexOf($[109]);
$7=$7==-1?$5.length:$7;
var $8=$5.substring($6,
$7).split($[56]);
var $9=String.fromCharCode(187);
if($8.length==2){var $a=$8[0];
$a=$a.charAt(0).toUpperCase()+$a.substring(1);
var $b=$8[1].replace($[703],
$[0]).replace(/_/g,
$[54]);
$b=$b.charAt(0).toUpperCase()+$b.substring(1);
var $c=$[651]+$9+$[419]+$9+$[54]+$a+$[54]+$9+$[54]+$b;
}else{var $c=$[651]+$9+$[419]+$9+$[1818];
}var $d=$4.slice(-2).join($[730]);
this._history.addToHistory($d,
$c);
if(this._currentSampleUrl!=this.defaultUrl){this.__setStateSampleLoaded();
this.__getPageSource(this._currentSampleUrl);
}else{this.__setStateInitialized();
}}this.__setStateLoaded();
this.widgets[$[399]].setLabel(this.polish($4[$4.length-1]));
this.debug("Demo loaded...");
if(this.isPlayAll()){if(this.widgets[$[353]].isEnabled()){qx.client.Timer.once(function(){this.widgets[$[353]].execute();
},
this,
1500);
}else{this.setPlayAll(false);
}}},
__ehPlayAll:function($0){if(!this.isPlayAll()){this.setPlayAll(true);
var $1=this._sampleToTreeNodeMap[$[729]];
this.widgets[$[131]].setSelectedElement($1);
this.widgets[$[324]].execute();
}else{if(this.__states.isLoading){this.widgets[$[139]].setEnabled(false);
}this.setPlayAll(false);
}},
__applyPlayAll:function($0,
$1){if($0==true){this.widgets[$[139]].setIcon(demobrowser.DemoBrowser.Img_PlayAll_Stop);
}else{this.widgets[$[139]].setIcon(demobrowser.DemoBrowser.Img_PlayAll_Default);
}},
__getPageSource:function($0){if(typeof ($0)!=$[10]){return;
}var $1=new qx.io.remote.Request($0);
$1.setTimeout(180000);
$1.setProhibitCaching(false);
$1.addEventListener($[20],
function($2){var $3=new Date();
this.debug("Time to load page source from server: "+($3.getTime()-$5.getTime())+"ms");
var $4=$2.getContent();
if($4){this.widgets[$[477]].setHtml(this.__beautySource($4));
this.__sourceCodeLoaded=1;
}},
this);
$1.addEventListener($[26],
...
dataLoader:function($0){var $1=new qx.io.remote.Request($0);
$1.setTimeout(180000);
$1.setProhibitCaching(false);
$1.addEventListener($[20],
function($2){var $3=new Date();
...
qx.client.Timer.once(function(){this.tests.handler=new demobrowser.TreeDataHandler($6);
var $5=new Date();
this.leftReloadTree();
var $7=new Date();
this.debug("Time to build/display tree: "+($7.getTime()-$5.getTime())+"ms");
var $8=this._history.getState();
if($8){this.setCurrentSample($8.replace($[495],
$[56]));
}else{this.setCurrentSample(this.defaultUrl);
}},
this,
...
playPrev:function($0){var $1=this.tree.getSelectedElement();
if($1){var $2=$1.getUserData($[290]).getPrevSibling().widgetLinkFull;
if($2){this.widgets[$[131]].setSelectedElement($2);
this.runSample();
}}},
playNext:function($0){var $1=this.tree.getSelectedElement();
if($1){var $2=$1.getUserData($[290]).getNextSibling().widgetLinkFull;
if($2){this.widgets[$[131]].setSelectedElement($2);
this.runSample();
}}},
__beautySource:function($0){var $1=$[916];
var $2=[];
var $3=$[0];
var $4=/^\s*<script\b[^>]*?(?!\bsrc\s*=)[^>]*?>\s*$/i;
var $5=/^\s*<\/script>\s*$/i;
$0=$0.replace(/\r\n/g,
$[135]).replace(/\r/g,
$[135]);
var $2=$0.split($[396]);
for(var $6=0;$6<$2.length;$6++){if($4.exec($2[$6])){$1+=this.__beautyHtml(qx.html.String.escape($3+$2[$6]));
$3=$[0];
}else if($5.exec($2[$6])){var $7=qx.dev.Tokenizer.javaScriptToHtml($3);
$1+=$[2222]+$7+$[196];
$3=$2[$6]+$[396];
}else{$3+=$2[$6]+$[396];
}}$1+=this.__beautyHtml(qx.html.String.escape($3))+$[1608];
return $1;
},
__beautyHtml:function($0){var $1=$0;
var $2=$[1538];
function $3($4){var $5=arguments[1]+$[1378]+arguments[2]+$[96];
var $6,
$7;
var $8=false;
if(arguments.length-2>3){for(var $9=3;$9<arguments.length-2;$9++){$7=arguments[$9];
if($7==$[56]){$8=true;
break;
}else{var $a=/\s*([^=]+?)\s*=\s*((?!&quot;)\S+|&quot;.*?&quot;)\s*/g;
var $b;
while(($b=$a.exec($7))!=null){$5+=$[1135]+$b[1]+$[1756]+$b[2].replace(/\s*$/,
$[0])+$[96];
}}}$5+=($8?$[56]:$[0]);
}$5+=$[817];
return $5;
}$1=$1.replace(/(&lt;\/?)([a-zA-Z]+)(.*?)(\/?)&gt;/g,
$3);
return $1;
},
polish:function($0){return $0.replace($[703],
$[0]).replace($[79],
$[54]);
},
defaultUrl:$[1615]},
destruct:function(){this._disposeFields($[403],
$[1333],
$[1411],
$[622],
$[443]);
this._disposeObjects($[576],
$[2394],
$[2002],
$[9],
$[1644],
...
liveResize:{check:$[2],
init:false},
orientation:{check:[$[27],
$[34]],
apply:$[719],
init:$[27],
nullable:true},
firstSize:{apply:$[1058],
init:$[42]},
secondSize:{apply:$[2071],
init:$[42]},
...
switch($1){case $[27]:this._splitter.removeEventListener($[15],
this._onSplitterMouseDownX,
this);
this._splitter.removeEventListener($[66],
this._onSplitterMouseMoveX,
this);
this._splitter.removeEventListener($[22],
this._onSplitterMouseUpX,
this);
this._knob.removeEventListener($[15],
this._onSplitterMouseDownX,
this);
this._knob.removeEventListener($[66],
this._onSplitterMouseMoveX,
this);
this._knob.removeEventListener($[22],
this._onSplitterMouseUpX,
this);
this._splitter.removeState($[27]);
this._knob.removeState($[27]);
this._firstArea.setWidth(null);
this._secondArea.setWidth(null);
this._splitter.setWidth(null);
break;
case $[34]:this._splitter.removeEventListener($[15],
...
switch($0){case $[27]:this._splitter.addEventListener($[66],
this._onSplitterMouseMoveX,
this);
this._splitter.addEventListener($[15],
this._onSplitterMouseDownX,
this);
this._splitter.addEventListener($[22],
this._onSplitterMouseUpX,
this);
this._knob.addEventListener($[66],
this._onSplitterMouseMoveX,
this);
this._knob.addEventListener($[15],
this._onSplitterMouseDownX,
this);
this._knob.addEventListener($[22],
this._onSplitterMouseUpX,
this);
this._splitter.addState($[27]);
this._knob.addState($[27]);
break;
case $[34]:this._splitter.addEventListener($[15],
this._onSplitterMouseDownY,
this);
this._splitter.addEventListener($[66],
this._onSplitterMouseMoveY,
this);
this._splitter.addEventListener($[22],
this._onSplitterMouseUpY,
...
_syncFirstSize:function(){switch(this.getOrientation()){case $[27]:this._firstArea.setWidth(this.getFirstSize());
break;
case $[34]:this._firstArea.setHeight(this.getFirstSize());
break;
}},
_syncSecondSize:function(){switch(this.getOrientation()){case $[27]:this._secondArea.setWidth(this.getSecondSize());
break;
case $[34]:this._secondArea.setHeight(this.getSecondSize());
break;
}},
_syncSplitterSize:function(){switch(this.getOrientation()){case $[27]:this._splitter.setWidth(this.getSplitterSize());
break;
case $[34]:this._splitter.setHeight(this.getSplitterSize());
break;
}},
_onSplitterMouseDownX:function($0){if(!$0.isLeftButtonPressed()){return;
}this._commonMouseDown();
this.getTopLevelWidget().setGlobalCursor($[314]);
this._slider.addState($[193]);
this._knob.addState($[193]);
...
this.getTopLevelWidget().setGlobalCursor($[384]);
this._slider.addState($[193]);
this._knob.addState($[193]);
...
this._slider.removeState($[193]);
this._knob.removeState($[193]);
},
...
$1){this.setFirstSize($0+$[129]);
this.setSecondSize($1+$[129]);
},
...
destruct:function(){this._disposeObjects($[823],
$[1745],
$[2267],
$[1669],
$[1786],
...
qx.Class.define($[2388],
{extend:qx.ui.layout.CanvasLayout,
construct:function($0){arguments.callee.base.call(this);
this.setAppearance($[1259]);
this.setStyleProperty($[177],
$[50]);
...
init:1e8}},
destruct:function(){this._disposeObjects($[263]);
}});
...
qx.Class.define($[1024],
{extend:qx.ui.basic.Terminator,
construct:function($0,
$1,
$2){arguments.callee.base.call(this);
this._blank=qx.io.Alias.getInstance().resolve($[224]);
...
}else{$0.addEventListener($[71],
this._onload,
this);
$0.addEventListener($[116],
this._onerror,
this);
...
$[176])){this._image=document.createElement($[1295]);
}else{this._image=new Image;
}this._image.style.border=$[577];
this._image.style.verticalAlign=$[16];
this._image.alt=$[0];
this._image.title=$[0];
...
$0.style.filter=$[859]+$2+$[2295];
}else{$0.src=$2;
$0.style.filter=this.getEnabled()?$[0]:$[810];
}},
...
$2=0;
if(qx.core.Variant.isSet($[1],
$[23])&&$0.getBoundingClientRect){var $3=qx.dom.Node.getWindow($0);
...
$4-=this.__num($2,
$[93]);
if($1.compatMode===$[113]){$3+=this.__num($2,
$[191]);
$4+=this.__num($2,
$[186]);
}return {left:$3,
...
var $2=$1.offsetLeft;
var $3=$1.offsetTop;
if(qx.bom.element.Dimension.getBoxSizing($1)!==$[293]){$2+=this.__num($1,
$[98]);
$3+=this.__num($1,
$[93]);
if(!$0.getBoundingClientRect){var $4;
while($0){if(this.__style($0,
$[103])===$[74]||this.__style($0,
$[103])===$[150]){$4=true;
break;
}$0=$0.offsetParent;
}
...
var $3=$2.left;
var $4=$2.top;
if($1.compatMode===$[113]){$3-=this.__num($0,
$[98]);
$4-=this.__num($0,
$[93]);
...
if($5.getBoxSizing($0)!==$[293]){$2-=this.__num($0,
$[98]);
$3-=this.__num($0,
$[93]);
}
...
$[87])!=$[2226]){$2+=this.__num($0.parentNode,
$[98]);
...
if($0.tagName==$[1128]){var $3=$2.left;
var $4=$2.top;
...
if($1){switch($1){case $[585]:$3-=this.__num($0,
$[191]);
$4-=this.__num($0,
$[186]);
$7+=this.__num($0,
...
"mshtml":function($0){if(qx.bom.Document.isStandardMode(qx.dom.Node.getDocument($0))){if(!this.__usesNativeBorderBox($0)){return $[2174];
}}return $[293];
},
...
/* ID: qx.bom.Document */
qx.Class.define($[1611],
{statics:{isQuirksMode:function($0){return ($0||window).document.compatMode!==$[113];
},
isStandardMode:function($0){return ($0||window).document.compatMode===$[113];
},
getWidth:function($0){var $1=($0||window).document;
var $2=qx.bom.Viewport.getWidth($0);
var $3=$1.compatMode===$[113]?$1.documentElement.scrollWidth:$1.body.scrollWidth;
return Math.max($3,
$2);
},
getHeight:function($0){var $1=($0||window).document;
var $2=qx.bom.Viewport.getHeight($0);
var $3=$1.compatMode===$[113]?$1.documentElement.scrollHeight:$1.body.scrollHeight;
return Math.max($3,
$2);
}}});
...
this._iframe=document.createElement($[198]);
this._iframe.style.visibility=$[24];
this._iframe.style.position=$[74];
this._iframe.style.left=$[721];
this._iframe.style.top=$[721];
document.body.appendChild(this._iframe);
var $0=qx.io.Alias.getInstance().resolve($[1526]);
this._iframe.src=$0;
this._titles={};
...
events:{"request":$[36]},
properties:{timeoutInterval:{check:$[17],
init:100,
apply:$[749]}},
...
if($0!=this._state){top.location.hash=$[349]+encodeURIComponent($0);
this.__storeState($0);
}},
...
this.createDispatchDataEvent($[587],
$0);
...
{"mshtml":function($0){var $1=$[1617]+encodeURIComponent($0)+$[1938];
...
"default":function($0){qx.client.Timer.once(function(){top.location.hash=$[349]+encodeURIComponent($0);
},
this,
0);
return true;
...
qx.Class.define($[1705],
{extend:qx.ui.basic.Terminator,
construct:function($0){arguments.callee.base.call(this);
if($0!=null){this.setHtml($0);
}},
properties:{html:{check:$[8],
init:$[0],
apply:$[1587],
event:$[1134]},
textAlign:{check:[$[9],
...
$1){$0===null?this.removeStyleProperty($[296]):this.setStyleProperty($[296],
$0);
},
_applyFont:function($0,
...
_styleTextColor:function($0){$0?this.setStyleProperty($[283],
$0):this.removeStyleProperty($[283]);
},
...
execute:function($0){if(this.hasEventListeners($[29])){var $1=new qx.event.type.DataEvent($[29],
$0);
...
switch($5){case $[243]:case $[299]:case $[265]:case $[280]:this.__modifier[$5]=true;
break;
case $[244]:var $6=$[2285]+$2[$4];
this.error($6);
throw $6;
default:if(this.__key){var $6=$[2078];
this.error($6);
throw $6;
}this.__key=$5;
}}}return true;
...
__oldKeyNameToKeyIdentifierMap:{esc:$[215],
ctrl:$[243],
print:$[288],
del:$[246],
pageup:$[159],
...
if($0.length==1&&$0>=$[306]&&$0<=$[586]){return $0.toUpperCase();
}$0=$0.toLowerCase();
if(!qx.event.type.KeyEvent.keys[$0]){return $[244];
...
var $2=[];
for(var $3 in this.__modifier){$2.push(qx.locale.Key.getKeyName($[151],
$3));
}
if($1){$2.push(qx.locale.Key.getKeyName($[151],
$1));
}
...
properties:{locale:{check:$[8],
nullable:true,
apply:$[783],
event:$[363]}},
members:{_defaultLocale:$[946],
getLanguage:function(){return this._language;
},
getTerritory:function(){return this.getLocale().split($[79])[1]||$[0];
},
...
$1){this.addTranslation($0.substring($0.lastIndexOf($[32])+1),
$1);
},
...
destruct:function(){this._disposeFields($[1254]);
}});
...
$1,
$2){if($0!=$[151]&&$0!=$[289]){throw new Error('format must be one of: "short", "full"');
}var $3=$[1540]+$0+$[79]+$1;
...
$3[$4.marktr($[2043])]=$[90];
$3[$4.marktr($[2378])]=$[299];
$3[$4.marktr($[2381])]=$[1960];
$3[$4.marktr($[2008])]=$[280];
$3[$4.marktr($[832])]=$[1808];
$3[$4.marktr($[2309])]=$[265];
$3[$4.marktr($[2279])]=$[1772];
$3[$4.marktr($[910])]=$[85];
$3[$4.marktr($[1683])]=$[133];
$3[$4.marktr($[920])]=$[88];
$3[$4.marktr($[1595])]=$[146];
$3[$4.marktr($[2312])]=$[1898];
$3[$4.marktr($[1549])]=$[1074];
$3[$4.marktr($[1005])]=$[200];
$3[$4.marktr($[1498])]=$[180];
$3[$4.marktr($[1417])]=$[1099];
$3[$4.marktr($[882])]=$[1157];
$3[$4.marktr($[907])]=$[1374];
$3[$4.marktr($[2020])]=$[835];
$3[$4.marktr($[1238])]=$[334];
...
$1){if(!this.isClosed()){this._window.location.replace($0!=null?$0:($[1348]+$[56]));
}},
...
if(this.getWidth()!=null){$0.push($[30]);
$0.push($[38]);
$0.push(this.getWidth());
$0.push($[21]);
}
if(this.getHeight()!=null){$0.push($[35]);
$0.push($[38]);
...
if(this.getTop()!=null){$0.push($[16]);
$0.push($[38]);
$0.push(this.getTop());
$0.push($[21]);
}$0.push($[1760]);
$0.push($[38]);
$0.push(this.getDependent()?$[124]:$[119]);
$0.push($[21]);
$0.push($[1236]);
$0.push($[38]);
$0.push(this.getResizable()?$[124]:$[119]);
$0.push($[21]);
$0.push($[778]);
$0.push($[38]);
$0.push(this.getShowStatusbar()?$[124]:$[119]);
$0.push($[21]);
$0.push($[1618]);
$0.push($[38]);
$0.push(this.getShowLocation()?$[124]:$[119]);
$0.push($[21]);
$0.push($[970]);
$0.push($[38]);
$0.push(this.getShowMenubar()?$[124]:$[119]);
$0.push($[21]);
$0.push($[367]);
$0.push($[38]);
$0.push(this.getShowToolbar()?$[124]:$[119]);
$0.push($[21]);
$0.push($[898]);
$0.push($[38]);
$0.push(this.getAllowScrollbars()?$[124]:$[119]);
$0.push($[21]);
$0.push($[866]);
$0.push($[38]);
$0.push(this.getModal()?$[124]:$[119]);
$0.push($[21]);
if(this.getName()!=null){this.setName($[969]+this.toHashCode());
...
}else if(!this._loaded){try{if(this._window.document&&this._window.document.readyState==$[445]){this._loaded=true;
this.createDispatchEvent($[71]);
}}catch(ex){}}},
_onload:function($0){var $1=this._native;
if(!$1._loaded){$1._loaded=true;
$1.createDispatchEvent($[71]);
}}},
...
destruct:function(){this._disposeObjectDeep($[2322],
1);
}});
...
qx.locale.Manager.getInstance().addEventListener($[363],
...
destruct:function(){this._disposeObjects($[378],
$[305],
$[2274],
$[1843]);
}});
...
if(!$0){$0=document.createElement($[78]);
var $1=$0.style;
$1.width=$1.height=$[3];
$1.visibility=$[24];
$1.position=$[74];
...
$1){$0==null?this.removeStyleProperty($[560]):this.setStyleProperty($[560],
$0?$[222]:$[797]);
},
...
if($1===$[3]){$1=qx.util.Validation.isValidString($0)&&$0.match(/<.*>/)?$[406]:$[172];
}
switch($1){case $[172]:var $2=qx.html.String.escape($0).replace(/(^ | $)/g,
$[954]).replace(/  /g,
$[1379]);
this._isHtml=$2!==$0;
this._content=$2;
break;
case $[406]:this._isHtml=true;
this._content=$0;
break;
}
...
$1){this._mnemonicTest=$0?new RegExp($[2344]+$0+$[1660]+$0+$[1544]+$0+$[2291]+$0+$[65],
$[1675]):null;
if(this._isCreated){this._renderContent();
}},
...
$1){return ($[1202]+($1-14)+$[2119]+$0+$[1565]);
},
...
if(this.getMnemonic()){if(this._mnemonicTest.test($0)){$0=RegExp.$1+$[1732]+RegExp.$7+$[173]+RegExp.rightContext;
this._isHtml=true;
}else{$0+=$[2167]+this.getMnemonic()+$[65];
}}var $2=$1.style;
if(this.getTextOverflow()&&!this.getWrap()){if(this.getInnerWidth()<this.getPreferredInnerWidth()){$2.overflow=$[24];
if(qx.core.Variant.isSet($[1],
$[467])){$2.textOverflow=$[440];
}else if(qx.core.Variant.isSet($[1],
$[138])){$2.OTextOverflow=$[440];
}else{$0=this.__patchTextOverflow($0,
this.getInnerWidth());
this._isHtml=true;
}}else{$2.overflow=$[0];
if(qx.core.Variant.isSet($[1],
$[467])){$2.textOverflow=$[0];
}else if(qx.core.Variant.isSet($[1],
$[138])){$2.OTextOverflow=$[0];
}}}
...
getTextContent:qx.lang.Object.select(qx.core.Client.getInstance().supportsTextContent()?$[673]:qx.core.Client.getInstance().supportsInnerText()?$[667]:$[55],
...
setTextContent:qx.lang.Object.select(qx.core.Client.getInstance().supportsTextContent()?$[673]:qx.core.Client.getInstance().supportsInnerText()?$[667]:$[55],
...
if(qx.Class.isDefined($[185])){var $1=qx.lang.Object.getValues(qx.ui.menu.Manager.getInstance().getAll());
...
if(qx.Class.isDefined($[292])&&$0 instanceof qx.ui.popup.ToolTip&&!($1 instanceof qx.ui.popup.ToolTip)){continue;
}$1.hide();
}}}});
...
qx.Class.define($[747],
{statics:{__umlautsRegExp:new RegExp($[2296],
$[372]),
__umlautsShortData:{"\xC4":$[188],
"\xD6":$[1487],
"\xDC":$[940],
"\xE4":$[306],
"\xF6":$[989],
...
this._onmouseover);
this.addEventListener($[66],
this._onmouseover);
this.addEventListener($[145],
this._onmouseout);
this.addEventListener($[45],
this._onkeydown);
this.addEventListener($[70],
this._onkeypress);
...
members:{_remappingChildTable:[$[572],
$[524],
$[550],
$[657],
$[421],
...
_onkeydown:function($0){if($0.getKeyIdentifier()==$[90]){this._onkeydown_enter($0);
}$0.preventDefault();
},
_onkeypress:function($0){switch($0.getKeyIdentifier()){case $[133]:this._onkeypress_up($0);
break;
case $[146]:this._onkeypress_down($0);
break;
case $[85]:this._onkeypress_left($0);
break;
case $[88]:this._onkeypress_right($0);
break;
default:return;
}$0.preventDefault();
},
...
$5=$3.getChildren();
$6=$5.length;
for(var $8=0;$8<$6;$8++){$5[$8].addToLayoutChanges($[125]);
}}}return arguments.callee.base.call(this,
$0);
}}});
...
destruct:function(){this._disposeObjects($[2164]);
}});
...
}if(qx.Class.isDefined($[486])&&$4!=null&&$2!=null&&$3!=null&&qx.ui.embed.Flash.getPlayerVersion().getMajor()>0){this._flashMode=true;
this.setIcon($4);
...
_createIcon:function(){if(this._flashMode&&qx.Class.isDefined($[486])){var $0=this._iconObject=new qx.ui.embed.Flash(this.getIcon());
...
$1){switch($0){case $[16]:case $[19]:this.setOrientation($[34]);
this.setReverseChildrenOrder($0==$[19]);
break;
default:this.setOrientation($[27]);
...
_handleLabel:function(){switch(this.getShow()){case $[165]:case $[156]:case $[143]:this._labelIsVisible=!!this.getLabel();
break;
...
_handleIcon:function(){switch(this.getShow()){case $[120]:case $[156]:case $[143]:this._iconIsVisible=!!this.getIcon();
break;
...
if(this.hasState($[60])){this.removeState($[60]);
this.addState($[47]);
}this.addState($[68]);
},
_onmouseout:function($0){if($0.getTarget()!=this){return;
}this.removeState($[68]);
if(this.hasState($[47])){this.setCapture(true);
this.removeState($[47]);
this.addState($[60]);
}},
...
var $1=this.hasState($[47]);
var $2=this.hasState($[60]);
if($1){this.removeState($[47]);
}
if($2){this.removeState($[60]);
}
if(!$2){this.addState($[68]);
if($1){this.execute();
}}},
_onkeydown:function($0){switch($0.getKeyIdentifier()){case $[90]:case $[122]:this.removeState($[60]);
this.addState($[47]);
$0.stopPropagation();
}},
_onkeyup:function($0){switch($0.getKeyIdentifier()){case $[90]:case $[122]:if(this.hasState($[47])){this.removeState($[60]);
this.removeState($[47]);
this.execute();
$0.stopPropagation();
}}}}});
...
$1.setLeft($3.left);
switch(this.getDirection()){case $[473]:$1.setBottom($3.top);
$1.setTop(null);
break;
case $[325]:$1.setTop($3.bottom);
$1.setBottom(null);
break;
}this.addState($[47]);
...
$1.removeEventListener($[162],
this._onmenuappear,
this);
$1.removeEventListener($[195],
this._onmenudisappear,
this);
}
if($0){$0.setOpener(this);
$0.addEventListener($[162],
this._onmenuappear,
this);
$0.addEventListener($[195],
this._onmenudisappear,
this);
}},
_onmousedown:function($0){if($0.getTarget()!=this||!$0.isLeftButtonPressed()){return;
}this.hasState($[47])?this._hideMenu():this._showMenu();
},
...
inheritable:true,
event:$[344]}},
destruct:function(){this._disposeObjects($[1147]);
}});
...
_onkeypress:function($0){switch($0.getKeyIdentifier()){case $[85]:return this._onkeypress_left();
case $[88]:return this._onkeypress_right();
}},
...
$1){$0===true?this.addState($[115]):this.removeState($[115]);
},
...
destruct:function(){this._disposeObjects($[1028]);
}});
...
{type:$[25],
extend:qx.util.manager.Object,
properties:{currentToolTip:{check:$[292],
nullable:true,
apply:$[2321]}},
...
event:$[541]}},
members:{_applyChecked:function($0,
$1){$0?this.addState($[115]):this.removeState($[115]);
},
_onmouseup:function($0){this.setCapture(false);
if(!this.hasState($[60])){this.addState($[68]);
...
switch(this.getResizeMethod()){case $[166]:this.setOpacity(0.5);
break;
case $[106]:var $6=this._frame;
...
this.getTopLevelWidget().setGlobalCursor(null);
switch(this.getResizeMethod()){case $[106]:var $2=this._frame;
if(!($2&&$2.getParent())){break;
}case $[623]:if($1.lastLeft!=null){this.setLeft($1.lastLeft);
}
...
if(this.getResizeMethod()==$[106]){this._frame.setParent(null);
}break;
case $[166]:this.setOpacity(null);
break;
...
switch(this.getResizeMethod()){case $[291]:case $[166]:if(this._resizeWest||this._resizeEast){this.setWidth($1.lastWidth);
...
default:var $2=this.getResizeMethod()==$[106]?this._frame:this;
...
if(this._near($5.top,
$0.getPageY())){if(this.getResizableNorth()){$3=$[891];
this._resizeNorth=true;
}}else if(this._near($5.bottom,
$0.getPageY())){if(this.getResizableSouth()){$3=$[414];
this._resizeSouth=true;
}}
if(this._near($5.left,
$0.getPageX())){if(this.getResizableWest()){$3+=$[1893];
this._resizeWest=true;
}}else if(this._near($5.right,
$0.getPageX())){if(this.getResizableEast()){$3+=$[1926];
this._resizeEast=true;
}}
if(this._resizeNorth||this._resizeSouth||this._resizeWest||this._resizeEast){this.setCursor($3+$[2003]);
}else{this.resetCursor();
}}$0.stopPropagation();
}},
destruct:function(){this._disposeObjects($[393]);
}});
...
$b.setAppearance($[1953]);
$b.setTabIndex(-1);
$b.addEventListener($[29],
...
$d.setAppearance($[1267]);
$d.setHeight($[3]);
var $e=this._statusText=new qx.ui.basic.Label($[343]);
$e.setAppearance($[1873]);
...
this._captionBar.removeState($[83]);
this._minimizeButton.removeState($[83]);
this._restoreButton.removeState($[83]);
this._maximizeButton.removeState($[83]);
this._closeButton.removeState($[83]);
}else{if(!this.getFocusedChild()){this.setFocused(true);
}this.getWindowManager().setActiveWindow(this);
this.bringToFront();
this.addState($[83]);
this._captionBar.addState($[83]);
this._minimizeButton.addState($[83]);
this._restoreButton.addState($[83]);
this._maximizeButton.addState($[83]);
this._closeButton.addState($[83]);
}},
...
this._minimizeButton.removeState($[47]);
this._minimizeButton.removeState($[60]);
this._minimizeButton.removeState($[68]);
$0.stopPropagation();
},
_onrestorebuttonclick:function($0){this.restore();
this._restoreButton.removeState($[47]);
this._restoreButton.removeState($[60]);
this._restoreButton.removeState($[68]);
$0.stopPropagation();
},
_onmaximizebuttonclick:function($0){this.maximize();
this._maximizeButton.removeState($[47]);
this._maximizeButton.removeState($[60]);
this._maximizeButton.removeState($[68]);
$0.stopPropagation();
},
_onclosebuttonclick:function($0){this.close();
this._closeButton.removeState($[47]);
this._closeButton.removeState($[60]);
this._closeButton.removeState($[68]);
$0.stopPropagation();
},
...
switch(this.getMoveMethod()){case $[166]:this.setOpacity(0.5);
break;
case $[106]:var $6=this._frame;
...
}switch(this.getMoveMethod()){case $[166]:this.setOpacity(null);
break;
case $[106]:this._frame.setParent(null);
break;
...
}var $2=this.getMoveMethod()==$[106]?this._frame:this;
...
destruct:function(){this._disposeObjects($[463],
$[966],
$[1994],
$[878],
$[1260],
...
qx.Class.define($[689],
{extend:qx.util.manager.Object,
properties:{activeWindow:{check:$[112],
nullable:true,
apply:$[1535]}},
...
qx.Interface.define($[718],
{events:{"dataChanged":$[36],
"metaDataChanged":$[36]},
...
destruct:function(){this._disposeFields($[1311],
$[1554],
$[938]);
}});
...
destruct:function(){this._disposeFields($[1645],
$[1826],
$[809]);
}});
...
if(!$0.stylesheet){$0.stylesheet=qx.html.StyleSheet.createElement($[1812]+$[998]+$[1550]+$[1518]+$[2129]+$[1297]+$[1885]+$[1318]+$[2342]+$[1790]+$[841]+$[2111]+(qx.core.Variant.isSet($[1],
$[23])?$[402]:$[1243])+$[219]+$[1896]+$[1701]+$[383]+$[1566]+$[2314]+$[383]+$[2029]+$[2085]+$[383]);
}},
members:{_getCellClass:function($0){return $[732];
},
...
init:true}},
members:{_getStyleFlags:function($0){if(this.getUseAutoAlign()){if(typeof $0.value==$[58]){return qx.ui.table.cellrenderer.Default.STYLEFLAG_ALIGN_RIGHT;
}}},
_getCellClass:function($0){var $1=arguments.callee.base.call(this,
$0);
if(!$1){return $[0];
}var $2=this._getStyleFlags($0);
if($2&qx.ui.table.cellrenderer.Default.STYLEFLAG_ALIGN_RIGHT){$1+=$[1674];
}
if($2&qx.ui.table.cellrenderer.Default.STYLEFLAG_BOLD){$1+=$[1186];
}
if($2&qx.ui.table.cellrenderer.Default.STYLEFLAG_ITALIC){$1+=$[1992];
}return $1;
},
...
if(typeof $1==$[10]){return $1;
}else if(typeof $1==$[58]){if(!qx.ui.table.cellrenderer.Default._numberFormat){qx.ui.table.cellrenderer.Default._numberFormat=new qx.util.format.NumberFormat();
...
properties:{minimumIntegerDigits:{check:$[17],
init:0},
maximumIntegerDigits:{check:$[17],
nullable:true},
minimumFractionDigits:{check:$[17],
init:0},
maximumFractionDigits:{check:$[17],
nullable:true},
...
postfix:{check:$[8],
init:$[0]}},
members:{format:function($0){switch($0){case Infinity:return $[1039];
case -Infinity:return $[1054];
case NaN:return $[953];
}var $1=($0<0);
if($1){$0=-$0;
}
...
var $5=$4.substring(0,
$3);
while($5.length<this.getMinimumIntegerDigits()){$5=$[46]+$5;
}
...
while($6.length<this.getMinimumFractionDigits()){$6+=$[46];
}
...
var $3=new RegExp($[398]+qx.lang.String.escapeRegexpChars(this.getPrefix())+$[2311]+$[2110]+$1+$[779]+$[680]+$2+$[2293]+qx.lang.String.escapeRegexpChars(this.getPostfix())+$[179]);
var $4=$3.exec($0);
...
{statics:{getDecimalSeparator:function($0){return new qx.locale.LocalizedString($[2135],
[],
$0);
},
getGroupSeparator:function($0){return new qx.locale.LocalizedString($[939],
[],
$0);
},
getPercentFormat:function($0){return new qx.locale.LocalizedString($[1361],
[],
$0);
}}});
...
}else{this._format=qx.locale.Date.getDateFormat($[218],
this._locale)+$[54]+qx.locale.Date.getDateTimeFormat($[339],
$[347],
this._locale);
}},
statics:{getDateTimeInstance:function(){var $0=qx.util.format.DateFormat;
var $1=qx.locale.Date.getDateFormat($[218])+$[54]+qx.locale.Date.getDateTimeFormat($[339],
$[347]);
...
var $1=qx.locale.Date.getDateFormat($[151])+$[0];
...
if($e.type==$[262]){$c+=$e.text;
}else{var $f=$e.character;
var $g=$e.size;
var $h=$[109];
switch($f){case $[865]:if($g==2){$h=this.__fillNumber($3%100,
2);
}else if($g==4){$h=$3;
}break;
case $[1008]:$h=this.__fillNumber(this.__getDayInYear($0),
$g);
break;
case $[1442]:$h=this.__fillNumber($5,
$g);
break;
case $[1406]:$h=this.__fillNumber(this.__getWeekInYear($0),
$g);
break;
case $[1749]:if($g==2){$h=qx.locale.Date.getDayName($[187],
$6,
$2);
}else if($g==3){$h=qx.locale.Date.getDayName($[134],
$6,
$2);
...
case $[893]:if($g==1||$g==2){$h=this.__fillNumber($4+1,
$g);
}else if($g==3){$h=qx.locale.Date.getMonthName($[134],
$4,
$2);
...
case $[641]:$h=($7<12)?qx.locale.Date.getAmMarker($2):qx.locale.Date.getPmMarker($2);
break;
case $[1612]:$h=this.__fillNumber($7,
$g);
break;
case $[1736]:$h=this.__fillNumber(($7==0)?24:$7,
$g);
break;
case $[1726]:$h=this.__fillNumber($7%12,
$g);
break;
case $[1187]:$h=this.__fillNumber((($7%12)==0)?12:($7%12),
$g);
break;
case $[737]:$h=this.__fillNumber($8,
$g);
break;
case $[1788]:$h=this.__fillNumber($9,
$g);
break;
case $[2246]:$h=this.__fillNumber($a,
$g);
break;
case $[660]:if($g==1){$h=$[765]+(($b<0)?$[100]:$[201])+this.__fillNumber($b)+$[1125];
}else if($g==2){$h=$1.MEDIUM_TIMEZONE_NAMES[$b];
}else if($g==3){$h=$1.FULL_TIMEZONE_NAMES[$b];
}break;
case $[610]:$h=(($b<0)?$[100]:$[201])+this.__fillNumber($b,
2)+$[2248];
}$c+=$h;
}}return $c;
},
...
switch($4){case $[607]:if($6==$[174]){if($5+1>=$3.length){$5++;
break;
}var $7=$3.charAt($5+1);
if($7==$[174]){$2+=$6;
$5++;
...
case $[253]:if($6==$0){$1++;
$5++;
}else{this.__formatTree.push({type:$[253],
character:$0,
size:$1});
$0=null;
$1=0;
...
default:if(($6>=$[641]&&$6<=$[660])||($6>=$[2237]&&$6<=$[610])){$0=$6;
$4=$[253];
}else if($6==$[174]){if($5+1>=$3.length){$2+=$6;
$5++;
break;
}var $7=$3.charAt($5+1);
if($7==$[174]){$2+=$6;
...
if($4!=$[55]){if($2.length>0){this.__formatTree.push({type:$[262],
text:$2});
$2=$[0];
}}else{$2+=$6;
$5++;
}break;
}}if($0!=null){this.__formatTree.push({type:$[253],
character:$0,
size:$1});
}else if($2.length>0){this.__formatTree.push({type:$[262],
text:$2});
}},
...
if($4.type==$[262]){$2+=qx.lang.String.escapeRegexpChars($4.text);
...
var $9=qx.locale.Date.getMonthNames($[134],
this._locale);
...
var $e=qx.locale.Date.getDayNames($[187],
this._locale);
...
var $g=qx.locale.Date.getDayNames($[134],
this._locale);
...
this._parseRules.push({pattern:$[813],
regex:$[867],
groups:2,
manipulator:$1});
this._parseRules.push({pattern:$[807],
regex:$[2087],
manipulator:$1});
this._parseRules.push({pattern:$[1650],
regex:$[57],
manipulator:$4});
this._parseRules.push({pattern:$[2243],
regex:$[57],
manipulator:$4});
this._parseRules.push({pattern:$[2177],
regex:$[114]+$9.join($[136])+$[65],
manipulator:$b});
this._parseRules.push({pattern:$[1312],
regex:$[114]+$c.join($[136])+$[65],
manipulator:$d});
this._parseRules.push({pattern:$[2215],
regex:$[57],
field:$[605]});
this._parseRules.push({pattern:$[1798],
regex:$[57],
field:$[605]});
this._parseRules.push({pattern:$[1625],
regex:$[114]+$e.join($[136])+$[65],
manipulator:$f});
this._parseRules.push({pattern:$[2058],
regex:$[114]+$g.join($[136])+$[65],
manipulator:$h});
this._parseRules.push({pattern:$[2080],
regex:$[114]+$i.join($[136])+$[65],
manipulator:$j});
this._parseRules.push({pattern:$[306],
regex:$[114]+$0.AM_MARKER+$[136]+$0.PM_MARKER+$[65],
manipulator:$5});
this._parseRules.push({pattern:$[2021],
regex:$[57],
field:$[245]});
this._parseRules.push({pattern:$[1995],
regex:$[57],
field:$[245]});
this._parseRules.push({pattern:$[917],
regex:$[57],
manipulator:$6});
this._parseRules.push({pattern:$[1451],
regex:$[57],
manipulator:$6});
this._parseRules.push({pattern:$[1462],
regex:$[57],
field:$[245]});
this._parseRules.push({pattern:$[1867],
regex:$[57],
field:$[245]});
this._parseRules.push({pattern:$[1016],
regex:$[57],
manipulator:$7});
this._parseRules.push({pattern:$[745],
regex:$[57],
manipulator:$7});
this._parseRules.push({pattern:$[1787],
regex:$[57],
field:$[612]});
this._parseRules.push({pattern:$[1205],
regex:$[57],
field:$[612]});
this._parseRules.push({pattern:$[691],
regex:$[57],
field:$[595]});
this._parseRules.push({pattern:$[414],
regex:$[57],
field:$[595]});
this._parseRules.push({pattern:$[945],
regex:$[361],
field:$[239]});
this._parseRules.push({pattern:$[889],
regex:$[361],
field:$[239]});
this._parseRules.push({pattern:$[1173],
regex:$[361],
field:$[239]});
this._parseRules.push({pattern:$[391],
regex:$[887],
manipulator:$8});
this._parseRules.push({pattern:$[586],
regex:$[1203],
manipulator:$8});
}},
destruct:function(){this._disposeFields($[1215],
$[1815],
$[2218],
$[1519],
$[1511]);
...
/* ID: qx.locale.Date */
qx.Class.define($[1653],
{statics:{getAmMarker:function($0){return new qx.locale.LocalizedString($[1575],
[],
$0);
},
getPmMarker:function($0){return new qx.locale.LocalizedString($[2114],
[],
$0);
},
getDayNames:function($0,
$1){if($0!=$[134]&&$0!=$[187]&&$0!=$[132]){throw new Error('format must be one of "abbreviated", "narrow", "wide"');
}var $2=[$[713],
$[682],
$[710],
$[646],
...
$[649]];
var $3=[];
for(var $4=0;$4<$2.length;$4++){var $5=$[430]+$0+$[79]+$2[$4];
...
$1,
$2){if($0!=$[134]&&$0!=$[187]&&$0!=$[132]){throw new Error('format must be one of "abbreviated", "narrow", "wide"');
}var $3=[$[713],
$[682],
$[710],
$[646],
...
for(var $3=0;$3<12;$3++){var $4=$[488]+$0+$[79]+($3+1);
...
$1){if($0!=$[151]&&$0!=$[323]&&$0!=$[218]&&$0!=$[289]){throw new Error('format must be one of "short", "medium", "long", "full"');
}var $2=$[1942]+$0;
...
switch($0){case $[151]:case $[323]:return qx.locale.Date.getDateTimeFormat($[1891],
$[2376]);
case $[218]:return qx.locale.Date.getDateTimeFormat($[339],
$[347]);
case $[289]:return qx.locale.Date.getDateTimeFormat($[1753],
$[1834]);
...
_getTerritory:function($0){if($0){var $1=$0.split($[79])[1]||$0;
...
properties:{validationFunction:{check:$[76],
nullable:true,
init:null}},
...
if(typeof $0.originalValue==$[58]){$1=parseFloat($1);
}return $1;
}}});
...
this);
this.addEventListener($[301],
this._onblur);
this.addEventListener($[287],
this._onfocus);
this.addEventListener($[161],
this._oninput);
},
...
if(qx.core.Variant.isSet($[1],
$[23])){$2.onpropertychange=this.__oninput;
}else{$2.addEventListener($[161],
this.__oninput,
false);
}$0.appendChild($2);
}},
...
if($1){if($1==$[375]&&qx.core.Client.getInstance().isMshtml()){$0.cursor=$[234];
}else{$0.cursor=$1;
}}else{$0.cursor=$[0];
}},
_applyTextAlign:function($0,
...
if($0){this.addState($[683]);
}else{this.removeState($[683]);
}},
_applyTextColor:function($0,
$1){qx.theme.manager.Color.getInstance().connect(this._styleTextColor,
this,
...
{"mshtml":function($0){if(!this._inValueProperty&&$0.propertyName===$[451]){this.createDispatchDataEvent($[161],
this.getComputedValue());
}},
"default":function($0){this.createDispatchDataEvent($[161],
this.getComputedValue());
}}),
...
$[23])){this._inputElement.onpropertychange=null;
}else{this._inputElement.removeEventListener($[161],
this.__oninput,
false);
}}this._disposeFields($[2258],
$[648],
$[1871]);
}});
...
events:{"widthChanged":$[36],
"visibilityChangedPre":$[36],
"visibilityChanged":$[36],
"orderChanged":$[36]},
...
newWidth:$1,
oldWidth:$2};
this.createDispatchDataEvent($[346],
$3);
}},
...
visible:$1};
this.createDispatchDataEvent($[464],
$9);
this.createDispatchDataEvent($[328],
$9);
}}},
...
fromOverXPos:$0,
toOverXPos:$1};
this.createDispatchDataEvent($[675],
$4);
}},
destruct:function(){this._disposeFields($[1928],
$[2076],
$[1155],
$[768]);
}});
...
var $3;
var $4=qx.io.Alias;
var $5=$4.getInstance().resolve($[1357]);
$3=new qx.ui.menu.Separator();
$2.add($3);
$3=new qx.ui.menu.Button($[2197],
$5);
$2.add($3);
$3.addEventListener($[29],
this._onappear,
this);
},
...
destruct:function(){this._disposeFields($[492]);
}});
...
properties:{newResizeBehaviorColumnData:{check:$[76],
...
set:function($0,
$1){for(var $2 in $1){switch($2){case $[30]:this.setWidth($0,
$1[$2]);
break;
case $[80]:this.setMinWidth($0,
$1[$2]);
break;
case $[81]:this.setMaxWidth($0,
$1[$2]);
break;
...
events:{"columnVisibilityMenuCreateStart":$[36],
"columnVisibilityMenuCreateEnd":$[36],
"tableWidthChanged":$[36],
"verticalScrollBarChanged":$[36],
"cellClick":$[164],
"cellDblclick":$[164],
"cellContextmenu":$[164]},
...
cellDblclick:1,
cellContextmenu:1}},
properties:{selectionModel:{check:$[342],
apply:$[1616],
event:$[1910]},
tableModel:{check:$[718],
apply:$[1574],
event:$[834],
nullable:true},
tableColumnModel:{check:$[446],
apply:$[1252],
event:$[1835]},
rowHeight:{check:$[17],
init:20,
...
if($1!=null){$1.removeEventListener($[168],
this._onSelectionChanged,
this);
}$0.addEventListener($[168],
this._onSelectionChanged,
this);
},
...
}$0.addEventListener($[328],
this._onColVisibilityChanged,
this);
$0.addEventListener($[346],
this._onColWidthChanged,
this);
$0.addEventListener($[675],
...
switch($1){case $[90]:this.stopEditing();
var $3=this._focusedRow;
this.moveFocusedCell(0,
1);
if(this._focusedRow!=$3){$2=this.startEditing();
}break;
case $[215]:this.cancelEditing();
this.focus();
break;
default:$2=false;
break;
}}}else{$2=true;
switch($1){case $[180]:this.setFocusedCell(this._focusedCol,
0,
true);
break;
case $[200]:var $4=this.getTableModel().getRowCount();
...
switch($1){case $[318]:case $[90]:$2=this.startEditing();
break;
default:$2=false;
break;
}}else if($0.isCtrlPressed()){$2=true;
switch($1){case $[188]:var $4=this.getTableModel().getRowCount();
...
switch($3){case $[122]:this._selectionManager.handleSelectKeyDown(this._focusedRow,
$0);
break;
case $[85]:this.moveFocusedCell(-1,
0);
break;
case $[88]:this.moveFocusedCell(1,
0);
break;
case $[133]:this.moveFocusedCell(0,
-1);
break;
case $[146]:this.moveFocusedCell(0,
1);
break;
case $[159]:case $[197]:var $4=this.getPaneScroller(0);
...
var $2;
if($0==0){$2=this.trn($[1255],
$[2052],
$1,
$1);
}else{$2=this.trn($[1151],
$[1581],
$1,
$0,
$1);
...
var $3=$2?$[42]:$0[$1].getTablePaneModel().getTotalWidth();
$0[$1].setWidth($3);
}},
...
var $4={table:this,
menu:$0};
this.createDispatchDataEvent($[843],
$4,
true);
...
menu:$0};
this.createDispatchDataEvent($[442],
$4,
true);
...
destruct:function(){this._disposeFields($[879],
$[1766],
$[648],
$[311]);
}});
...
_dumpRanges:function(){var $0=$[1286];
for(var $1=0;$1<this._selectedRangeArr.length;$1++){var $2=this._selectedRangeArr[$1];
$0+=$[728]+$2.minIndex+$[933]+$2.maxIndex+$[108];
}this.debug($0);
},
_fireChangeSelection:function(){if(this.hasBatchMode()){this._hadChangeEventInBatchMode=true;
}this.createDispatchEvent($[168]);
}},
destruct:function(){this._disposeFields($[1479]);
}});
...
properties:{appearance:{refine:true,
init:$[590]},
firstVisibleRow:{check:$[17],
init:0,
apply:$[1729]},
visibleRowCount:{check:$[17],
init:0,
apply:$[2254]},
maxCacheLines:{check:$[17],
init:1000,
apply:$[1048]}},
...
$n+=$[935]+$8+$[870]+$6.getTotalWidth()+$[337];
if($n){$k.push($[1335],
$n,
$[625]);
}$k.push($[1531]);
...
}}if(!this._tableContainer){this._tableContainer=document.createElement($[78]);
}var $9=$[1539];
...
if(qx.core.Variant.isSet($[1],
$[28])){$a.childNodes[0].offsetHeight;
...
destruct:function(){this._disposeObjects($[427]);
}});
...
this._horScrollBar.addEventListener($[208],
this._onScrollX,
this);
this._verScrollBar.addEventListener($[208],
this._onScrollY,
this);
...
this._headerClipper.setDimension($[42],
$[3]);
this._headerClipper.setOverflow($[24]);
...
this._paneClipper.setWidth($[42]);
this._paneClipper.setOverflow($[24]);
this._paneClipper.add(this._tablePane,
this._focusIndicator);
this._paneClipper.addEventListener($[260],
this._onmousewheel,
this);
...
$2,
this._horScrollBar);
this._headerClipper.addEventListener($[570],
this._onChangeCaptureHeader,
this);
this._headerClipper.addEventListener($[66],
this._onmousemoveHeader,
this);
this._paneClipper.addEventListener($[66],
...
this);
this._focusIndicator.addEventListener($[22],
this._onMouseupFocusIndicator,
this);
this._headerClipper.addEventListener($[22],
this._onmouseupHeader,
this);
this._paneClipper.addEventListener($[22],
this._onmouseupPane,
this);
this._headerClipper.addEventListener($[91],
this._onclickHeader,
this);
this._paneClipper.addEventListener($[91],
this._onclickPane,
this);
this._paneClipper.addEventListener($[214],
this._onContextMenu,
this);
this._paneClipper.addEventListener($[128],
...
$1){if($1!=null){$1.removeEventListener($[547],
this._onPaneModelChanged,
this);
}$0.addEventListener($[547],
this._onPaneModelChanged,
this);
},
_applyShowCellFocusIndicator:function($0,
...
_onScrollX:function($0){this.createDispatchChangeEvent($[1308],
$0.getValue(),
$0.getOldValue());
var $1=$0.getValue();
...
_onScrollY:function($0){this.createDispatchChangeEvent($[509],
$0.getValue(),
$0.getOldValue());
...
if(this.hasEventListeners($[252])){this.dispatchEvent(new qx.ui.table.pane.CellEvent(this,
$[252],
$0),
true);
...
if(this.hasEventListeners($[690])){this.dispatchEvent(new qx.ui.table.pane.CellEvent(this,
$[690],
$0),
true);
}}},
...
$2);
this.startEditing();
if(this.hasEventListeners($[665])){var $3=this._getRowForPagePos($1,
$2);
...
this._cellEditor.addEventListener($[195],
...
this._cellEditor.removeEventListener($[195],
this._onCellEditorModalWindowClose,
this);
...
this._focusIndicator.removeState($[661]);
this._cellEditor.dispose();
this._cellEditor=null;
this._cellEditorFactory=null;
}}},
...
this._blocker.setAppearance($[1085]);
this.add(this._blocker);
this.setMaximum(0);
},
statics:{EVENT_DELAY:250},
properties:{value:{check:$[17],
init:0,
apply:$[459],
event:$[208],
transform:$[2371]},
...
_getScrollBarWidth:function(){if(qx.ui.basic.ScrollBar._scrollBarWidth==null){var $0=document.createElement($[78]);
$0.style.width=$[317];
$0.style.height=$[317];
$0.style.overflow=$[37];
$0.style.visibility=$[24];
document.body.appendChild($0);
...
destruct:function(){this._disposeObjects($[2365],
$[1069],
$[664]);
}});
...
$[23])){$0.attachEvent($[458],
this.__onscroll);
}else{$0.addEventListener($[37],
this.__onscroll,
false);
}}},
_onscroll:function($0){this.createDispatchEvent($[37]);
qx.event.handler.EventHandler.stopDomEvent($0);
}},
destruct:function(){var $0=this.getElement();
if($0){if(qx.core.Variant.isSet($[1],
$[23])){$0.detachEvent($[458],
this.__onscroll);
}else{$0.removeEventListener($[37],
this.__onscroll,
false);
...
destruct:function(){this._disposeObjects($[1982]);
}});
...
destruct:function(){this._disposeObjects($[1967],
$[263]);
}});
...
init:$[34]},
alignTabsToLeft:{check:$[2],
init:true,
apply:$[1904]},
placeBarOnTop:{check:$[2],
init:true,
apply:$[2327]}},
members:{_applyAlignTabsToLeft:function($0,
$1){var $2=this._bar;
$2.setHorizontalChildrenAlign($0?$[9]:$[12]);
...
destruct:function(){this._disposeObjects($[482]);
}});
...
if($2){$2.handleItemChecked(this,
$0);
}}$0?this.addState($[115]):this.removeState($[115]);
var $3=this.getPage();
...
_onmouseover:function($0){this.addState($[68]);
},
_onmouseout:function($0){this.removeState($[68]);
},
...
qx.Class.define($[2379],
{extend:qx.ui.pageview.AbstractButton,
events:{"closetab":$[4]},
properties:{appearance:{refine:true,
init:$[447]},
showCloseButton:{check:$[2],
init:false,
apply:$[1364],
event:$[1821]},
closeButtonImage:{check:$[8],
init:$[1425],
apply:$[1358]}},
members:{_onkeydown:function($0){var $1=$0.getKeyIdentifier();
if($1==$[90]||$1==$[122]){this.setChecked(true);
}},
_onkeypress:function($0){switch($0.getKeyIdentifier()){case $[85]:var $1=this.getPreviousActiveSibling();
if($1&&$1!=this){delete qx.event.handler.FocusHandler.mouseFocus;
$1.setFocused(true);
$1.setChecked(true);
}break;
case $[88]:var $2=this.getNextActiveSibling();
if($2&&$2!=this){delete qx.event.handler.FocusHandler.mouseFocus;
$2.setFocused(true);
$2.setChecked(true);
}break;
}},
_ontabclose:function($0){this.createDispatchDataEvent($[2081],
this);
$0.stopPropagation();
},
_applyChecked:function($0,
...
if($0){this._closeButtonImage.addEventListener($[91],
this._ontabclose,
this);
this.add(this._closeButtonImage);
}else{this.remove(this._closeButtonImage);
this._closeButtonImage.removeEventListener($[91],
this._ontabclose,
this);
}},
...
_renderAppearance:function(){if(this.getView()){this.isFirstVisibleChild()?this.addState($[1966]):this.removeState($[381]);
this.isLastVisibleChild()?this.addState($[381]):this.removeState($[381]);
this.getView().getAlignTabsToLeft()?this.addState($[534]):this.removeState($[534]);
!this.getView().getAlignTabsToLeft()?this.addState($[603]):this.removeState($[603]);
this.getView().getPlaceBarOnTop()?this.addState($[192]):this.removeState($[192]);
!this.getView().getPlaceBarOnTop()?this.addState($[184]):this.removeState($[184]);
}arguments.callee.base.call(this);
}},
destruct:function(){this._disposeObjects($[1310]);
}});
...
return $0?$0.readyState==$[445]:false;
},
...
release:function(){if(this._blockerNode){this._blockerNode.style.display=$[14];
}},
_generateIframeElement:function($0){if(qx.core.Variant.isSet($[1],
$[23])){var $1=$0?$[1582]+$0+$[105]:$[402];
var $2=qx.ui.embed.Iframe._element=document.createElement($[1833]+$1+$[1495]);
}else{var $2=qx.ui.embed.Iframe._element=document.createElement($[198]);
...
$2.border=$[46];
$2.unselectable=$[73];
$2.allowTransparency=$[1226];
$2.style.position=$[74];
$2.style.top=0;
$2.style.left=0;
return $2;
},
_generateBlockerElement:function(){var $0=qx.ui.embed.Iframe._blocker=document.createElement($[78]);
var $1=$0.style;
if(qx.core.Variant.isSet($[1],
$[23])){$1.backgroundColor=$[62];
$1.filter=$[814];
}$1.position=$[74];
$1.top=0;
$1.left=0;
...
if($0==null||$0===$[0]){$0=qx.io.Alias.getInstance().resolve($[1116]);
}this._isLoaded=false;
...
_syncScrolling:function(){this.getIframeNode().setAttribute($[1159],
this.getScrolling());
},
...
return $1?$1.getElementsByTagName($[152])[0]:null;
}}});
...
qx.Class.define($[1185],
{extend:qx.log.appender.Abstract,
properties:{element:{check:$[706],
nullable:true,
apply:$[636]},
maxMessages:{check:$[7],
init:500},
...
init:false}},
members:{__backgroundColors:{0:$[62],
200:$[62],
500:$[2183],
600:$[1681],
700:$[556],
800:$[556],
1000:$[62]},
_prepare:function(){if(!this._frame){this._frame=document.createElement($[78]);
}},
_applyElement:function($0,
$1){this._prepare();
if($0){$0.appendChild(this._frame);
}else if($1){$1.removeChild(this._frame);
}},
clear:function(){if(this._frame){this._frame.innerHTML=$[0];
}},
appendLogEvent:function($0){this._prepare();
var $1=$0.logger.getName();
if($0.instanceId!=null){$1+=$[400]+$0.instanceId+$[108];
}
if($1!=this._lastGroup){var $2=document.createElement($[78]);
$2.style.fontWeight=$[261];
$2.innerHTML=$1;
this._frame.appendChild($2);
this._lastGroup=$1;
}var $2=document.createElement($[78]);
$2.style.backgroundColor=this.__backgroundColors[$0.level];
$2.innerHTML=this.formatLogEvent($0).replace(/&/g,
$[645]).replace(/</g,
$[450]).replace(/  /g,
$[1852]).replace(/[\n]/g,
$[654]);
...
if(this._removedMessageCount!=null){this._frame.firstChild.className=$[0];
this._frame.firstChild.innerHTML=$[114]+this._removedMessageCount+$[624];
}}},
destruct:function(){this._disposeFields($[393]);
}});
...
$1){var $2=this._bar;
var $3=this._pane;
switch($0){case $[16]:$2.moveSelfToBegin();
$2.setHeight($[3]);
$2.setWidth(null);
$2.setOrientation($[27]);
$3.setWidth(null);
$3.setHeight($[42]);
this.setOrientation($[34]);
break;
case $[19]:$2.moveSelfToEnd();
$2.setHeight($[3]);
$2.setWidth(null);
$2.setOrientation($[27]);
$3.setWidth(null);
...
$3.setHeight(null);
$3.setWidth($[42]);
this.setOrientation($[27]);
break;
case $[12]:$2.moveSelfToEnd();
$2.setWidth($[3]);
$2.setHeight(null);
$2.setOrientation($[34]);
$3.setHeight(null);
...
switch(this.getParent().getBarPosition()){case $[9]:case $[12]:$1*=-1;
}return $1;
},
_renderAppearance:function(){if(this.getParent()){var $0=this.getParent().getBarPosition();
$0===$[9]?this.addState($[250]):this.removeState($[250]);
$0===$[12]?this.addState($[257]):this.removeState($[257]);
$0===$[16]?this.addState($[192]):this.removeState($[192]);
$0===$[19]?this.addState($[184]):this.removeState($[184]);
}arguments.callee.base.call(this);
}}});
...
$0===$[16]||$0===$[19]?this.addState($[668]):this.removeState($[668]);
$0===$[9]||$0===$[12]?this.addState($[503]):this.removeState($[503]);
}arguments.callee.base.call(this);
}}});
...
appearance:{refine:true,
init:$[788]}},
members:{_onkeypress:function($0){switch(this.getView().getBarPosition()){case $[16]:case $[19]:switch($0.getKeyIdentifier()){case $[85]:var $1=true;
break;
case $[88]:var $1=false;
break;
default:return;
}break;
case $[9]:case $[12]:switch($0.getKeyIdentifier()){case $[133]:var $1=true;
break;
case $[146]:var $1=false;
break;
default:return;
}break;
default:return;
...
this._labelObject.setStyleProperty($[229],
$[11]);
this._labelObject.setMode($[172]);
arguments.callee.base.call(this);
...
}this._iconObject.setAppearance($[695]);
this._labelObject.setAppearance($[535]);
this.addEventListener($[15],
this._onmousedown);
this.addEventListener($[22],
this._onmouseup);
...
_applySelected:function($0,
$1){if($0){this.addState($[69]);
this._labelObject.addState($[69]);
}else{this.removeState($[69]);
this._labelObject.removeState($[69]);
}var $2=this.getTree();
if(!$2._fastUpdate||($1&&$2._oldItem==this)){this._iconObject.setSource(this._evalCurrentIcon());
if($0){this._iconObject.addState($[69]);
}else{this._iconObject.removeState($[69]);
...
destruct:function(){this._disposeObjects($[990],
$[378],
$[305]);
this._disposeFields($[1610]);
}});
...
$1){if(typeof $1==$[77]){$0.setAnonymous($1);
}this._fields.push($0);
},
getLabelObject:function(){return this._labelObject;
},
...
destruct:function(){this._disposeFields($[1029]);
this._disposeObjects($[798],
$[2336],
$[1142]);
this._disposeObjectDeep($[1424],
1);
}});
...
this._iconObject.setAppearance($[545]);
this._labelObject.setAppearance($[693]);
...
events:{"treeOpenWithContent":$[36],
"treeOpenWhileEmpty":$[36],
"treeClose":$[36]},
properties:{appearance:{refine:true,
init:$[394]},
icon:{refine:true,
...
if(this.hasContent()){if(this.getTree().hasEventListeners($[538])){this.getTree().dispatchEvent(new qx.event.type.DataEvent($[538],
this),
true);
}this.getTopLevelWidget().setGlobalCursor($[806]);
qx.client.Timer.once(this._openCallback,
this,
0);
}else{if(this.getTree().hasEventListeners($[530])){this.getTree().dispatchEvent(new qx.event.type.DataEvent($[530],
this),
true);
}this.setOpen(true);
}},
close:function(){if(this.getTree().hasEventListeners($[422])){this.getTree().dispatchEvent(new qx.event.type.DataEvent($[422],
this),
true);
...
}this.setVerticalChildrenAlign($[16]);
if(!this._horizontalLayout){this.setOrientation($[34]);
...
this._horizontalLayout.setAppearance(this instanceof qx.ui.tree.Tree?$[622]:$[394]);
this.setAppearance($[249]);
...
var $6=$5[$3-$1-1];
if($1==$2){if(this.hasContent()||this.getAlwaysShowPlusMinusSymbol()){if(!$0){return this.getOpen()?$[611]:$[453];
}if($4==1){var $7=this.getParentFolder();
if($7&&!$7._horizontalLayout.getVisibility()&&this.isFirstChild()){if(this.isLastChild()||$6===true){return this.getOpen()?$[385]:$[351];
}else{return this.getOpen()?$[1577]:$[1233];
}}}
if($6===true){return this.getOpen()?$[385]:$[351];
}else if(this.isLastChild()){return this.getOpen()?$[1508]:$[1672];
}else{return this.getOpen()?$[2006]:$[1881];
}}else if($0&&!($6===true)){return this.isLastChild()?$[527]:$[559];
...
destruct:function(){this._disposeFields($[925]);
this._disposeObjects($[860],
$[2282]);
}});
...
this._iconObject.setAppearance($[927]);
this._labelObject.setAppearance($[2202]);
this.setOpen(true);
this.addToFolder();
this.addEventListener($[45],
this._onkeydown);
...
tabIndex:{refine:true,
init:1},
excludeSpecificTreeLines:{check:$[355],
init:[],
apply:$[2201]},
hideNode:{check:$[2],
init:false,
...
getExcludeSpecificTreeLines:function(){return qx.lang.Array.clone(this[$[1576]]);
},
...
switch($0.getKeyIdentifier()){case $[90]:$0.preventDefault();
if(qx.ui.tree.Tree.isTreeFolder($2)){return $2.toggle();
}break;
case $[85]:$0.preventDefault();
...
getIndentSymbol:function($0,
$1,
$2){if($1==$2&&(this.hasContent()||this.getAlwaysShowPlusMinusSymbol())){if(!$0){return this.getOpen()?$[611]:$[453];
}else{return this.getOpen()?$[385]:$[351];
}}else{return null;
}}},
destruct:function(){this._disposeObjects($[482]);
}});
...
events:{"changeSelection":$[36]},
properties:{boundedWidget:{check:$[110],
nullable:true},
...
if(this._activeDragSession){this.getBoundedWidget().addEventListener($[22],
this._ondragup,
this);
this.getBoundedWidget().setCapture(true);
}},
_ondragup:function($0){this.getBoundedWidget().removeEventListener($[22],
this._ondragup,
this);
...
var $2=this.getFireChange();
this.setFireChange(false);
if($0.getKeyIdentifier()==$[188]&&$0.isCtrlPressed()){if(this.getMultiSelection()){this._selectAll();
...
}else if($0.getKeyIdentifier()==$[122]){if(this._selectedItems.contains($4)){this.renderItemSelectionState($4,
false);
...
}switch($0.getKeyIdentifier()){case $[180]:return this.getHome(this.getLeadItem());
case $[200]:return this.getEnd(this.getLeadItem());
case $[146]:return this.getDown(this.getLeadItem());
case $[133]:return this.getUp(this.getLeadItem());
case $[85]:return this.getLeft(this.getLeadItem());
case $[88]:return this.getRight(this.getLeadItem());
case $[159]:return this.getPageUp(this.getLeadItem())||this.getHome(this.getLeadItem());
case $[197]:return this.getPageDown(this.getLeadItem())||this.getEnd(this.getLeadItem());
case $[122]:if($0.isCtrlPressed()){return this.getLeadItem();
}}return null;
},
_dispatchChange:function(){if(!this.getFireChange()){return;
}
if(this.hasEventListeners($[168])){this.dispatchEvent(new qx.event.type.DataEvent($[168],
...
destruct:function(){this._disposeObjects($[1022]);
}});
...
var $5=$4[$3-$1-1];
if($0&&!($5===true)){if($1==$2){return this.isLastChild()?$[527]:$[559];
}else{return $[505];
}}return null;
},
...
this.setRequestHeader($[2035],
$[1148]);
this.setRequestHeader($[2221],
...
reset:function(){switch(this.getState()){case $[44]:case $[53]:this.error("Aborting already sent request!");
case $[231]:this.abort();
break;
}},
isConfigured:function(){return this.getState()===$[95];
},
isQueued:function(){return this.getState()===$[231];
},
...
isFailed:function(){return this.getState()===$[26];
},
_onqueued:function($0){this.setState($[231]);
...
_onfailed:function($0){this.setState($[26]);
this.dispatchEvent($0);
this.dispose();
},
...
$1){if($0){this.setParameter($[480],
new Date().valueOf());
this.setRequestHeader($[517],
$[502]);
this.setRequestHeader($[581],
$[502]);
}else{this.removeParameter($[480]);
this.removeRequestHeader($[517]);
this.removeRequestHeader($[581]);
}},
_applyMethod:function($0,
$1){if($0===qx.net.Http.METHOD_POST){this.setRequestHeader($[433],
$[1533]);
}else{this.removeRequestHeader($[433]);
}},
_applyResponseType:function($0,
$1){this.setRequestHeader($[1283],
$0);
},
...
init:5000}},
members:{_debug:function(){var $0=this._active.length+$[56]+(this._queue.length+this._active.length);
{};
},
...
destruct:function(){this._disposeObjectDeep($[1699],
1);
this._disposeObjects($[266]);
this._disposeFields($[1429]);
}});
...
statusCodeToString:function($0){switch($0){case -1:return $[1542];
case 200:return $[2175];
case 304:return $[782];
case 206:return $[828];
case 204:return $[1557];
case 300:return $[1884];
case 301:return $[1986];
case 302:return $[1150];
case 303:return $[922];
case 305:return $[2105];
case 400:return $[1671];
case 401:return $[2072];
case 402:return $[1964];
case 403:return $[1626];
case 404:return $[2054];
case 405:return $[2171];
case 406:return $[1035];
case 407:return $[1646];
case 408:return $[1842];
case 409:return $[1484];
case 410:return $[2068];
case 411:return $[2250];
case 412:return $[2188];
case 413:return $[1735];
case 414:return $[1031];
case 415:return $[2182];
case 500:return $[1096];
case 501:return $[776];
case 502:return $[947];
case 503:return $[2154];
case 504:return $[2211];
case 505:return $[976];
case 12002:return $[1341];
case 12029:return $[412];
case 12030:return $[412];
case 12031:return $[412];
case 12152:return $[1071];
case 13030:return $[1936];
default:return $[1537];
}}},
properties:{request:{check:$[701],
nullable:true},
...
break;
case $[20]:case $[40]:case $[41]:case $[26]:var $2=this.getImplementation();
if(!$2){break;
}
...
event:$[373],
apply:$[404]},
requestHeaders:{check:$[112],
nullable:true},
parameters:{check:$[112],
nullable:true},
formFields:{check:$[112],
nullable:true},
responseType:{check:$[8],
nullable:true},
useBasicHttpAuth:{check:$[2],
nullable:true}},
...
_applyState:function($0,
$1){{};
switch($0){case $[154]:this.createDispatchEvent($[154]);
break;
case $[95]:this.createDispatchEvent($[95]);
break;
...
break;
case $[26]:this.createDispatchEvent($[26]);
break;
...
if($8 instanceof Array){for(var $9=0;$9<$8.length;$9++){$6.push(encodeURIComponent($7)+$[38]+encodeURIComponent($8[$9]));
}}else{$6.push(encodeURIComponent($7)+$[38]+encodeURIComponent($8));
}}
if($6.length>0){$3+=($3.indexOf($[109])>=0?$[64]:$[109])+$6.join($[64]);
}var $a=function($b){var $c=$[1290];
var $d=$[0];
var $e,
$f,
$g;
...
$3,
$2);
$0.setRequestHeader($[1899],
$[1613]+$a(this.getUsername()+$[948]+this.getPassword()));
}else{$0.open($1,
$3,
$2,
this.getUsername(),
...
failedLocally:function(){if(this.getState()===$[26]){return;
}this.warn("Could not load from file: "+this.getUrl());
this.failed();
},
_onreadystatechange:function($0){switch(this.getState()){case $[20]:case $[40]:case $[26]:case $[41]:{};
return;
...
}catch(ex){}}if(typeof $0==$[39]&&$0!=null){if(!$0.documentElement){var $3=String(this.getRequest().responseText).replace(/<\?xml[^\?]*\?>/,
$[0]);
$0.loadXML($3);
}if(!$0.documentElement){throw new Error("Missing Document Element!");
}
if($0.documentElement.tagName==$[1062]){throw new Error("XML-File is not well-formed!");
...
"mshtml":qx.lang.Object.select(location.protocol!==$[602]&&window.XMLHttpRequest?$[1072]:$[2148],
...
__convertNumber:function($0){return isFinite($0)?String($0):$[294];
},
...
return $[1146]+Math.floor($2/16).toString(16)+($2%16).toString(16);
},
...
__convertDate:function($0){var $1=$0.getUTCFullYear()+$[21]+$0.getUTCMonth()+$[21]+$0.getUTCDate()+$[21]+$0.getUTCHours()+$[21]+$0.getUTCMinutes()+$[21]+$0.getUTCSeconds()+$[21]+$0.getUTCMilliseconds();
return $[1850]+$1+$[1410];
},
...
if($0 instanceof Array||$1==$[355]){return this.__convertArray($0);
}else if($0 instanceof Date||$1==$[1981]){return this.__convertDate($0);
}else if($0 instanceof Object||$1==$[112]){return this.__convertMap($0);
}return $[0];
}return $[294];
},
__convertUndefined:function($0){if(qx.core.Setting.get($[1721])){return $[294];
}},
...
}if(qx.core.Setting.get($[566])){qx.log.Logger.getClassLogger(qx.io.Json).debug("JSON request: "+$2);
}return $2;
},
parse:function($0){if(!(/[^,:{}\[\]0-9.\-+Eaeflnr-u \n\r\t]/.test($0.replace(/"(\\.|[^"\\])*"/g,
$[0])))){throw new Error("Could not parse JSON string!");
}
try{return eval($[114]+$0+$[65]);
}catch(ex){throw new Error("Could not evaluate JSON string: "+ex.message);
}},
parseQx:function($0){if(qx.core.Setting.get($[566])){qx.log.Logger.getClassLogger(qx.io.Json).debug("JSON response: "+$0);
}var $1=($0&&$0.length>0)?eval($[680]+$0+$[281]):null;
return $1;
}},
...
var $2=$[1583]+$0;
if(qx.core.Variant.isSet($[1],
$[23])){this._frame=document.createElement($[1112]+$1+$[2207]);
}else{this._frame=document.createElement($[198]);
}this._frame.src=$[746];
...
this._form=document.createElement($[1460]);
this._form.target=$1;
this._form.id=this._form.name=$2;
this._form.style.display=$[14];
document.body.appendChild(this._form);
this._data=document.createElement($[366]);
this._data.id=this._data.name=$[928];
...
if($5 instanceof Array){for(var $6=0;$6<$5.length;$6++){$3.push(encodeURIComponent($4)+$[38]+encodeURIComponent($5[$6]));
}}else{$3.push(encodeURIComponent($4)+$[38]+encodeURIComponent($5));
}}
if($3.length>0){$1+=($1.indexOf($[109])>=0?$[64]:$[109])+$3.join($[64]);
}var $7=this.getFormFields();
for(var $4 in $7){var $8=document.createElement($[366]);
$8.name=$4;
...
_switchReadyState:function($0){switch(this.getState()){case $[20]:case $[40]:case $[26]:case $[41]:this.warn("Ignore Ready State Change");
return;
...
}if($0.firstChild.tagName&&$0.firstChild.tagName.toLowerCase()==$[743]){return $0.firstChild.innerHTML;
...
if(qx.core.Variant.isSet($[1],
$[28])){this._frame.src=qx.io.Alias.getInstance().resolve($[224]);
}document.body.removeChild(this._frame);
}
if(this._form){document.body.removeChild(this._form);
}this._disposeFields($[393],
$[2193]);
}});
...
statics:{_uniqueId:0,
_instanceRegistry:{},
ScriptTransport_PREFIX:$[2046],
ScriptTransport_ID_PARAM:$[2350],
ScriptTransport_DATA_PARAM:$[787],
...
$0+=($0.indexOf($[109])>=0?$[64]:$[109])+qx.io.remote.ScriptTransport.ScriptTransport_ID_PARAM+$[38]+this._uniqueId;
...
if($4 instanceof Array){for(var $5=0;$5<$4.length;$5++){$2.push(encodeURIComponent($3)+$[38]+encodeURIComponent($4[$5]));
}}else{$2.push(encodeURIComponent($3)+$[38]+encodeURIComponent($4));
}}
if($2.length>0){$0+=$[64]+$2.join($[64]);
}var $6=this.getData();
if($6!=null){$0+=$[64]+qx.io.remote.ScriptTransport.ScriptTransport_DATA_PARAM+$[38]+encodeURIComponent($6);
}qx.io.remote.ScriptTransport._instanceRegistry[this._uniqueId]=this;
this._element=document.createElement($[2017]);
this._element.charset=$[1929];
this._element.src=$0;
{};
...
/* ID: demobrowser.TreeDataHandler */
qx.Class.define($[1521],
{extend:qx.core.Object,
construct:function($0){arguments.callee.base.call(this);
this.tmap=$0;
this.ttree=this.__readTestRep($0);
},
members:{__readTestRep:function($0){var $1=$0;
function $2($3,
$4){var $5=$4.classname;
var $6=$5.split($[32]);
var $7=$6.slice(0,
...
var $e=null;
var $f=$a.getChildren();
for(var $g=0;$g<$f.length;$g++){if($f[$g].label==$b){$e=$f[$g];
break;
...
$6);
if(!$d){throw new Exception($[2010]);
}$h.readTree($4,
$d);
}var $3=new demobrowser.Tree($[717]);
var $h=this;
for(var $g=0;$g<$1.length;$g++){$2($3,
$1[$g]);
}return $3;
},
readTree:function($0,
$1){var $2=arguments[1]||new demobrowser.Tree($0.classname);
var $1;
function $3($4,
$5){return ($4.name<$5.name)?-1:($4.name>$5.name)?1:0;
}$0.tests.sort($3);
for(var $6=0;$6<$0.tests.length;$6++){$1=new demobrowser.Tree($0.tests[$6].name);
$1.type=$[137];
$1.desc=$0.tests[$6].desc;
$2.add($1);
}if($0.children&&$0.children.length){for(var $6=0;$6<$0.children.length;$6++){$2.add(readTree($0.children[$6]));
}}return $2;
},
getRoot:function(){if(!this.Root){var $0={classname:$[0],
tests:[]};
var $1=this.tmap;
for(var $2=0;$2<this.tmap.length;$2++){if($0.classname.length>$1[$2].classname.length){$0=$1[$2];
}}this.Root=$0;
}return this.Root.classname;
},
getChilds:function($0){var $1=[];
var $2=this.tmap;
var $3=$[398]+$0+$[1493];
var $4=new RegExp($3);
for(var $5=0;$5<$2.length;$5++){if($2[$5].classname.match($4)){$1.push($2[$5]);
}}return $1;
},
getTests:function($0){var $1=this.tmap;
for(var $2=0;$2<$1.length;$2++){if($1[$2].classname==$0){return $1[$2].tests;
}}return [];
},
getPath:function($0){var $1=$0.pwd();
$1.shift();
if(this.isClass($0)){$1=$1.concat($0.label);
}return $1;
},
getChildren:function($0){if($0==$[717]){var $1=this.tmap;
var $2=[];
for(var $3=0;$3<$1.length;$3++){$2.push($1[$3].classname);
}return $2;
}else if(this.isClass($0)){return this.getTests($0);
}else{return [];
}},
isClass:function($0){if($0.type&&$0.type==$[137]){return false;
}else{return true;
}},
hasTests:function($0){if(!this.isClass($0))return false;
else{var $1=$0.getChildren();
for(var $2=0;$2<$1.length;$2++){if($1[$2].type&&$1[$2].type==$[137])return true;
}return false;
}},
classFromTest:function($0){var $1=$[0];
var $2=[];
classloop:
for(var $3=0;$3<this.tmap.length;$3++){for(var $4=0;$4<this.tmap[$3].tests.length;$4++){if(this.tmap[$3].tests[$4]==$0){$1=this.tmap[$3].classname;
break classloop;
}}}return $1;
},
getFullName:function($0){var $1=this.getPath($0);
if($0.type&&$0.type==$[137]){$1=$1.concat($0.label);
}return $1.join($[32]);
},
getPreviousNode:function($0){var $1=$0.getPrevSibling();
if($1){return $1;
}},
getNextNode:function($0){var $1=$0.getNextSibling();
if($1){return $1;
}},
testCount:function($0){if($0.type&&$0.type==$[137]){return 1;
}else{var $1=0;
var $2=$0.getIterator($[268]);
var $3;
while($3=$2()){if($3.type&&$3.type==$[137]){$1++;
}}return $1;
}}},
destruct:function(){this._disposeFields($[2127]);
this._disposeObjects($[1033]);
}});
...
getIterator:function($0){var $1=[this];
var $2=$0==$[268]?1:0;
function $3(){var $4;
if($1.length){$4=$1.shift();
var $5=$4.getChildren();
if($5.length){if($2){$1=$5.concat($1);
}else{$1=$1.concat($5);
}}}else{$4=null;
}return $4;
}return $3;
...
getSibling:function($0){var $1=this.parent.getChildren();
var $2=arguments.callee.self.indexOf($1,
this);
var $3=$2+$0;
if($1[$3]){return $1[$3];
}},
add:function($0){this.children.push($0);
$0.parent=this;
}},
statics:{indexOf:function($0,
$1){for(var $2=0;$2<$0.length;$2++){if($0[$2]==$1){return $2;
}}}},
destruct:function(){this._disposeObjects($[2317],
$[1122],
$[322]);
this._disposeObjectDeep($[2168],
1);
}});
...
if($i.match($4)){$f.push({type:$[708],
value:$i});
}else if($i.match($5)){$f.push({type:$[536],
value:$i});
}else if($i.match($a)){$f.push({type:$[688],
value:$i});
}else if($i.match($9)){$f.push({type:$[438],
value:$i});
}else if($1[$i]){$f.push({type:$[478],
value:$i});
}else if($2[$i]){$f.push({type:$[379],
value:$i});
}else if($3[$i]){$f.push({type:$[659],
value:$i});
}else if($i.match($6)){$f.push({type:$[465],
value:$i});
}else if($i.match($8)){$f.push({type:$[1637],
value:$i});
}else if($i.match($7)){$f.push({type:$[2178],
value:$i});
}else if($i.match($c)){$f.push({type:$[565],
value:$i});
}else if($i.match($d)){$f.push({type:$[926],
value:$i});
}else if($i.match($b)){$f.push({type:$[1076],
value:$i});
}else if($i==$[356]){$f.push({type:$[235],
value:$[356]});
}else if($i==$[405]){$f.push({type:$[235],
value:$[405]});
}else if($i==$[64]){$f.push({type:$[235],
value:$[64]});
}else{$f.push({type:$[235],
value:$i});
}}return $f;
},
...
switch($4.type){case $[465]:$2.add($[1133],
$5,
$[173]);
break;
case $[708]:case $[536]:$2.add($[1497],
$5,
$[173]);
break;
case $[688]:case $[438]:$2.add($[1552],
$5,
$[173]);
break;
case $[478]:case $[379]:case $[659]:$2.add($[2156],
$4.type,
$[640],
$5,
$[173]);
...
{"mshtml":function(){qx.core.Init.getInstance().addEventListener($[71],
this.__onload,
this);
},
"default":null}),
__onload:qx.core.Variant.select($[1],
{"mshtml":function(){this._frame=document.createElement($[198]);
this._frame.style.visibility=$[24];
this._frame.src=qx.io.Alias.getInstance().resolve($[1256]);
document.body.appendChild(this._frame);
},
"default":null}),
...
$1.add=$1.push;
$1.toString=$1.get=new Function($[1376]);
$1.clear=$1.init=new Function($[1086]);
$1.isEmpty=new Function($[2036]);
...
cldr_date_time_format_HHmm:$[2376],
cldr_date_time_format_HHmmss:$[347],
...
cldr_day_narrow_mon:$[1650],
cldr_day_narrow_sat:$[1173],
cldr_day_narrow_sun:$[1173],
...
cldr_month_narrow_10:$[1487],
cldr_month_narrow_11:"N",
cldr_month_narrow_12:"D",
cldr_month_narrow_2:"F",
cldr_month_narrow_3:$[1650],
cldr_month_narrow_4:$[188],
cldr_month_narrow_5:$[1650],
cldr_month_narrow_6:"J",
cldr_month_narrow_7:"J",
cldr_month_narrow_8:$[188],
cldr_month_narrow_9:$[1173],
...
cldr_number_decimal_separator:$[32],
cldr_number_group_separator:$[21],
cldr_pm:"pm",
cldr_quotationEnd:"’",
cldr_quotationStart:"‘",
