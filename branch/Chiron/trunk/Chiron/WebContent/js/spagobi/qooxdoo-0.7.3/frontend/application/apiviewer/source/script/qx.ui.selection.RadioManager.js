{type:"class",attributes:{"name":"RadioManager","hasWarning":"true","packageName":"qx.ui.selection","superClass":"qx.core.Target","fullName":"qx.ui.selection.RadioManager","type":"class"},children:[
  {type:"desc",attributes:{"text":"<p>Each instance manages vItems set of radio options: qx.ui.form.RadioButton, qx.ui.toolbar.RadioButton, ...</p>"}},
  {type:"constructor",children:[
    {type:"method",attributes:{"isCtor":"true","name":"ctor"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"vName"}},
        {type:"param",attributes:{"name":"vMembers"}}
        ]}
      ]}
    ]},
  {type:"constants",children:[
    {type:"constant",attributes:{"type":"String","name":"AUTO_NAME_PREFIX","value":"qx-radio-"}}
    ]},
  ...
  {type:"methods",children:[
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.selection.RadioManager#name","name":"_applyName"},children:[
      {type:"params",children:[
    ...
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.selection.RadioManager#selected","name":"_applySelected"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"value"},children:[
          {type:"desc",attributes:{"text":"<p>Current value</p>"}},
          {type:"types",children:[
    ...
    {type:"method",attributes:{"access":"protected","hasError":"true","name":"_selectByIndex"},children:[
      {type:"params",children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vIndex</code> is not documented.","column":"22","line":"355"}},
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"22","line":"355"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","name":"add"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>varargs</code> is not documented.","column":"11","line":"183"}},
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"11","line":"183"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","name":"getEnabledItems"},children:[
      {type:"return",children:[
        {type:"types",children:[
          {type:"entry",attributes:{"type":"var"}}
          ]}
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"23","line":"135"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","name":"getItems"},children:[
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"16","line":"124"}}
        ]}
      ]},
    ...
    {type:"method",attributes:{"hasError":"true","name":"handleItemChecked"},children:[
      {type:"params",children:[
        ...
        {type:"param",attributes:{"name":"vChecked"},children:[
          {type:"types",children:[
            {type:"entry",attributes:{"type":"var"}}
            ]}
          ]}
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vItem</code> is not documented.","column":"25","line":"158"}},
    ...
    {type:"method",attributes:{"hasError":"true","name":"remove"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"vItem"},children:[
          {type:"types",children:[
            {type:"entry",attributes:{"type":"var"}}
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vItem</code> is not documented.","column":"14","line":"221"}},
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"14","line":"221"}}
        ]}
      ]},
    ...
    {type:"method",attributes:{"hasError":"true","name":"selectNext"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"vItem"},children:[
          {type:"types",children:[
            {type:"entry",attributes:{"type":"var"}}
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vItem</code> is not documented.","column":"18","line":"293"}},
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"18","line":"293"}}
        ]}
      ]},
    {type:"method",attributes:{"hasError":"true","name":"selectPrevious"},children:[
      {type:"params",children:[
        {type:"param",attributes:{"name":"vItem"},children:[
          {type:"types",children:[
            {type:"entry",attributes:{"type":"var"}}
      ...
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Parameter <code>vItem</code> is not documented.","column":"22","line":"324"}},
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"22","line":"324"}}
        ]}
      ]},
  ...
  {type:"properties",children:[
    {type:"property",attributes:{"hasError":"true","name":"name","allowNull":"true","propertyType":"new","apply":"_applyName","check":"String"},children:[
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"3","line":"84"}}
        ]}
      ]},
    {type:"property",attributes:{"hasError":"true","name":"selected","check":"qx.core.Object","allowNull":"true","propertyType":"new","apply":"_applySelected","event":"changeSelected"},children:[
      {type:"errors",children:[
        {type:"error",attributes:{"msg":"Documentation is missing.","column":"3","line":"84"}}
        ]}
      ]}
