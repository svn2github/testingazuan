{type:"class",attributes:{"name":"RadioView","hasWarning":"true","packageName":"qx.ui.pageview.radioview","superClass":"qx.ui.pageview.AbstractPageView","fullName":"qx.ui.pageview.radioview.RadioView","type":"class"},children:[
  {type:"desc",attributes:{"text":"<p>One of the widgets which could be used to structurize the interface.</p>\n\n<p>qx.ui.pageview.radioview.RadioView creates a series of horizontal radio\n buttons at the top of the view.</p>"}},
  {type:"appearances",children:[
    {type:"appearance",attributes:{"type":"qx.ui.pageview.radioview.RadioView","name":"radio-view"}}
    ]},
  {type:"constructor",children:[
    {type:"method",attributes:{"isCtor":"true","name":"ctor"}}
    ]},
  {type:"properties",children:[
    {type:"property",attributes:{"name":"appearance","docFrom":"qx.ui.core.Widget","defaultValue":"\"radio-view\"","refine":"true","propertyType":"new","overriddenFrom":"qx.ui.core.Widget"}},
    {type:"property",attributes:{"possibleValues":"\"top\",\"bottom\"","hasError":"true","name":"barPosition","defaultValue":"\"top\"","propertyType":"new","apply":"_applyBarPosition","event":"changeBarPosition"},children:[
  ...
  {type:"methods",children:[
    {type:"method",attributes:{"access":"protected","apply":"qx.ui.pageview.radioview.RadioView#barPosition","name":"_applyBarPosition"},children:[
