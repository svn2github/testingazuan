...
**/
package it.eng.spagobi.geo.services.commons;
...
public class DelegatedHibernateConnectionListService extends DelegatedBasicListService {
	...
	public static ListIFace getList(ServiceIFace service, SourceBean request, SourceBean response) throws Exception {
		...
		// filter the list 
		String valuefilter = (String) request.getAttribute(Constants.VALUE_FILTER);
		if (valuefilter != null) {
			String columnfilter = (String) request
					.getAttribute(Constants.COLUMN_FILTER);
			String typeFilter = (String) request
					.getAttribute(Constants.TYPE_FILTER);
			String typeValueFilter = (String) request
					.getAttribute(Constants.TYPE_VALUE_FILTER);
   ...
   public static DataConnection getDataConnection(Connection con) throws EMFInternalError {
       ...
       try {
    	   ...
    	   TracerSingleton.log(Constants.LOG_NAME, TracerSingleton.CRITICAL,   "Error while getting Spago DataConnection " + e);           
	...
	public static void logException(Throwable t){
		TracerSingleton.log(Constants.LOG_NAME, TracerSingleton.MAJOR,   t.getMessage());
	}
