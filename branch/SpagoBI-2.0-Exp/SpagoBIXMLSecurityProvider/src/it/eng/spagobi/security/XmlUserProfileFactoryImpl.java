 ...
 */
public class XmlUserProfileFactoryImpl implements IUserProfileFactory {
	...
	public IEngUserProfile createUserProfile(Principal principal){
		...
		while(iterRoles.hasNext()) {
			...
			List functsSB = configSingleton.getFilteredSourceBeanAttributeAsList("AUTHORIZATIONS.RELATIONS.PRIVILEDGES.PRIVILEDGE", "roleName", roleName);
		...
		// build user profile 
		profile = new SpagoBIUserProfile(userName, functs, roles, new HashMap());
		return profile;
	}
