...
public class BirtReportRunner {
	...
	protected transient Logger logger = Logger.getLogger(BirtReportRunner.class);
	...
	protected HashMap prepareHtmlRendering (ServletContext servletContext, HttpServletRequest servletRequest) {
		...
		appContext.put(EngineConstants.APPCONTEXT_CLASSLOADER_KEY, BirtReportRunner.class.getClassLoader());
