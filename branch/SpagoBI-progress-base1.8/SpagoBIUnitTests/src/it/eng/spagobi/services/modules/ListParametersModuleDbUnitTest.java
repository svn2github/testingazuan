...
public class ListParametersModuleDbUnitTest extends DBConnectionTestCase {

	private SourceBean request = null, response = null, config = null;

	private ListParametersModule listParametersModule = null;

	private String className="it.eng.spagobi.services.modules.ListParametersModule";
	...
	protected void setUp() throws Exception {
		...
		listParametersModule = new ListParametersModule();
		listParametersModule.setRequestContext(defaultRequestContext);
		super.setUp();
		...
		listParametersModule.init(config);
	}
	...
	public void testGetList() {
		ListIFace list=null;
		try {
			list=listParametersModule.getList(request,response);
		} catch (Exception e) {
			e.printStackTrace();
