...
public interface ISbiGeoMapFeaturesDAO {
	 ...
	 * at input. For each of them, detail information is stored into an <code>feature</code> object. 
	 ...
	 * at input. For each of them, detail information is stored into an <code>map</code> object. 
	 ...
	 * @throws EMFUserError If an Exception occurred
	 */
	public void modifyMapFeatures(SbiGeoMapFeatures aObjParuse) throws EMFUserError;
	 ...
	 * @throws EMFUserError If an Exception occurred
	 */
	public void insertMapFeatures(SbiGeoMapFeatures aSbiGeoMapFeatures) throws EMFUserError;
	 ...
	 * @throws EMFUserError If an Exception occurred
	 */
	public void eraseMapFeatures(SbiGeoMapFeatures SbiGeoMapFeatures) throws EMFUserError;	
