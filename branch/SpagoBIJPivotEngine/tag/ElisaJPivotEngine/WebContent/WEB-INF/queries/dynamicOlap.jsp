...
//			byte[] template = bASE64Decoder.decodeBuffer(templateBase64Coded);
			...
			if(buttonCubeVisible!=null && (buttonCubeVisible.equalsIgnoreCase("true") || buttonCubeVisible.equalsIgnoreCase("false"))){
				Boolean buttonCubeVisibleB = new Boolean(buttonCubeVisible);
				session.setAttribute("buttonCubeVisibleB",buttonCubeVisibleB);
			}
			...
			if(buttonMDXVisible!=null && (buttonMDXVisible.equalsIgnoreCase("true") || buttonMDXVisible.equalsIgnoreCase("false"))){
				Boolean buttonMDXVisibleB = new Boolean(buttonMDXVisible);
				session.setAttribute("buttonMDXVisibleB",buttonMDXVisibleB);
			}
			...
			if(buttonOrderVisible!=null && (buttonOrderVisible.equalsIgnoreCase("true") || buttonOrderVisible.equalsIgnoreCase("false"))){
				Boolean buttonOrderVisibleB = new Boolean(buttonOrderVisible);
				session.setAttribute("buttonOrderVisibleB",buttonOrderVisibleB);
			}
			...
			if(buttonFatherMembVisible!=null && (buttonFatherMembVisible.equalsIgnoreCase("true") || buttonFatherMembVisible.equalsIgnoreCase("false"))){
				Boolean buttonFatherMembVisibleB = new Boolean(buttonFatherMembVisible);
				session.setAttribute("buttonFatherMembVisibleB",buttonFatherMembVisibleB);
			}
			...
			if(buttonHideSpansVisible!=null && (buttonHideSpansVisible.equalsIgnoreCase("true") || buttonHideSpansVisible.equalsIgnoreCase("false"))){
				Boolean buttonHideSpansVisibleB = new Boolean(buttonHideSpansVisible);
				session.setAttribute("buttonHideSpansVisibleB",buttonHideSpansVisibleB);
			}
			...
			if(buttonShowPropertiesVisible!=null && (buttonShowPropertiesVisible.equalsIgnoreCase("true") || buttonShowPropertiesVisible.equalsIgnoreCase("false"))){
				Boolean buttonShowPropertiesVisibleB = new Boolean(buttonShowPropertiesVisible);
				session.setAttribute("buttonShowPropertiesVisibleB",buttonShowPropertiesVisibleB);
			}
			...
			if(buttonHideEmptyVisible!=null && (buttonHideEmptyVisible.equalsIgnoreCase("true") || buttonHideEmptyVisible.equalsIgnoreCase("false"))){
				Boolean buttonHideEmptyVisibleB = new Boolean(buttonHideEmptyVisible);
				session.setAttribute("buttonHideEmptyVisibleB",buttonHideEmptyVisibleB);
			}
			...
			if(buttonShiftAxisVisible!=null && (buttonShiftAxisVisible.equalsIgnoreCase("true") || buttonShiftAxisVisible.equalsIgnoreCase("false"))){
				Boolean buttonShiftAxisVisibleB = new Boolean(buttonShiftAxisVisible);
				session.setAttribute("buttonShiftAxisVisibleB",buttonShiftAxisVisibleB);
			}
			...
			if(buttonDrillMemberVisible!=null && (buttonDrillMemberVisible.equalsIgnoreCase("true") || buttonDrillMemberVisible.equalsIgnoreCase("false"))){
				Boolean buttonDrillMemberVisibleB = new Boolean(buttonDrillMemberVisible);
				session.setAttribute("buttonDrillMemberVisibleB",buttonDrillMemberVisibleB);
			}
			...
			if(buttonDrillPositionVisible!=null && (buttonDrillPositionVisible.equalsIgnoreCase("true") || buttonDrillPositionVisible.equalsIgnoreCase("false"))){
				Boolean buttonDrillPositionVisibleB = new Boolean(buttonDrillPositionVisible);
				session.setAttribute("buttonDrillPositionVisibleB",buttonDrillPositionVisibleB);
			}
			...
			if(buttonDrillReplaceVisible!=null && (buttonDrillReplaceVisible.equalsIgnoreCase("true") || buttonDrillReplaceVisible.equalsIgnoreCase("false"))){
				Boolean buttonDrillReplaceVisibleB = new Boolean(buttonDrillReplaceVisible);
				session.setAttribute("buttonDrillReplaceVisibleB",buttonDrillReplaceVisibleB);
			}
			...
			if(buttonDrillThroughVisible!=null && (buttonDrillThroughVisible.equalsIgnoreCase("true") || buttonDrillThroughVisible.equalsIgnoreCase("false"))){
				Boolean buttonDrillThroughVisibleB = new Boolean(buttonDrillThroughVisible);
				session.setAttribute("buttonDrillThroughVisibleB",buttonDrillThroughVisibleB);
			}
			...
			if(buttonShowChartVisible!=null && (buttonShowChartVisible.equalsIgnoreCase("true") || buttonShowChartVisible.equalsIgnoreCase("false"))){
				Boolean buttonShowChartVisibleB = new Boolean(buttonShowChartVisible);
				session.setAttribute("buttonShowChartVisibleB",buttonShowChartVisibleB);
			}
			...
			if(buttonConfigureChartVisible!=null && (buttonConfigureChartVisible.equalsIgnoreCase("true") || buttonConfigureChartVisible.equalsIgnoreCase("false"))){
				Boolean buttonConfigureChartVisibleB = new Boolean(buttonConfigureChartVisible);
				session.setAttribute("buttonConfigureChartVisibleB",buttonConfigureChartVisibleB);
			}
			...
			if(buttonConfigurePrintVisible!=null && (buttonConfigurePrintVisible.equalsIgnoreCase("true") || buttonConfigurePrintVisible.equalsIgnoreCase("false"))){
				Boolean buttonConfigurePrintVisibleB = new Boolean(buttonConfigurePrintVisible);
				session.setAttribute("buttonConfigurePrintVisibleB",buttonConfigurePrintVisibleB);
			}
			...
			if(buttonFlushCacheVisible!=null && (buttonFlushCacheVisible.equalsIgnoreCase("true") || buttonFlushCacheVisible.equalsIgnoreCase("false"))){
				Boolean buttonFlushCacheVisibleB = new Boolean(buttonFlushCacheVisible);
				session.setAttribute("buttonFlushCacheVisibleB",buttonFlushCacheVisibleB);
			}
			...
			if(buttonSaveAnalysisVisible!=null && (buttonSaveAnalysisVisible.equalsIgnoreCase("true") || buttonSaveAnalysisVisible.equalsIgnoreCase("false"))){
				Boolean buttonSaveAnalysisVisibleB = new Boolean(buttonSaveAnalysisVisible);
				session.setAttribute("buttonSaveAnalysisVisibleB",buttonSaveAnalysisVisibleB);
			}
