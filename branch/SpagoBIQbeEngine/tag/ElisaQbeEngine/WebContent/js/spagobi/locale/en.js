...
Sbi.locale.ln['sbi.qbe.selectgridpanel.sortfunc.tt.hide'] = 'Hide all non visible fields';

Sbi.locale.ln['sbi.qbe.selectgridpanel.buttons.text.group'] = 'Group by entity';
Sbi.locale.ln['sbi.qbe.selectgridpanel.sortfunc.tt.group'] = 'Group fileds by parent entity';

Sbi.locale.ln['sbi.qbe.selectgridpanel.buttons.text.add'] = 'Add calculated';
Sbi.locale.ln['sbi.qbe.selectgridpanel.sortfunc.tt.add'] = 'Add an ad-hoc calculated field (i.e. valid only for this query)';

Sbi.locale.ln['sbi.qbe.selectgridpanel.buttons.text.delete'] = 'Delete';
Sbi.locale.ln['sbi.qbe.selectgridpanel.sortfunc.tt.delete'] = 'Delete selected filed';
