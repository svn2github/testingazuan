...
public class MapOlAction extends AbstractBaseServlet {
	...
	public static final String GEOSERVER_URL = "server";
	public static final String POS = "businessId";
	...
	public void doService( BaseServletIOManager servletIOManager ) throws SpagoBIEngineException {
		...
		try {
			...
			geoserverUrl = servletIOManager.getParameterAsString(GEOSERVER_URL);
			logger.debug("Parameter [" + GEOSERVER_URL + "] is equal to [" + geoserverUrl + "]");
			
			pos = servletIOManager.getParameterAsString(POS);
			logger.debug("Parameter [" + POS + "] is equal to [" + pos + "]");
			
			layer = servletIOManager.getParameterAsString(LAYER);
			logger.debug("Parameter [" + LAYER + "] is equal to [" + layer + "]");
			
			id = servletIOManager.getParameterAsString(GEOID);
			logger.debug("Parameter [" + GEOID + "] is equal to [" + id + "]");
			
			
			//DataSet
			dataSet = (IDataSet)servletIOManager.getHttpSession().getAttribute("dataSet");
			dataSet.loadData();
