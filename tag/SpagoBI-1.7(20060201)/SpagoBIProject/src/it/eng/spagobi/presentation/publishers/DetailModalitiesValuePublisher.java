...
public class DetailModalitiesValuePublisher implements PublisherDispatcherIFace {
	...
	public String getPublisherName(RequestContainer requestContainer, ResponseContainer responseContainer) {
		...
		if(!errorHandler.isOKBySeverity(EMFErrorSeverity.ERROR)) {
			if (detailMR != null) {
				String responseComplete = (String) detailMR.getAttribute(SpagoBIConstants.RESPONSE_COMPLETE);
				if ("true".equalsIgnoreCase(responseComplete)) return new String("detailModalitiesValue");
				else return "error";
