...
/**
 * Publishes the results of a list information request for  BI Object parameters 
 * into the correct jsp page according to what contained into request. If Any errors occurred during the 
 * execution of the <code>ListBIObjectParametersModule</code> class, the publisher
 ...
 * @author sulis
 */
public class ListBIObjectParametersPublisher implements PublisherDispatcherIFace {
	...
	public String getPublisherName(RequestContainer requestContainer, ResponseContainer responseContainer) {
		...
		if(!errorHandler.isOKBySeverity(EMFErrorSeverity.ERROR)) {
			...
			return new String("ListBIObjectParameters");
		}
	}
