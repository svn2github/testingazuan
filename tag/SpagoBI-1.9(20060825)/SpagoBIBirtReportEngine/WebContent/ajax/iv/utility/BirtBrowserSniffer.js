...
var BirtBrowserSniffer = new function ( )
{
	...
	this.is_ie5		= ( this.is_ie && ( is_major == 4 ) && ( agt.indexOf( "msie 5.0" ) != -1 ) );
	this.is_ie5_5	= ( this.is_ie && ( is_major == 4 ) && ( agt.indexOf( "msie 5.5" ) != -1 ) );
	this.is_ie5up	= ( this.is_ie && !this.is_ie3 && !this.is_ie4 );
	this.is_ie5_5up	= ( this.is_ie && !this.is_ie3 && !this.is_ie4 && !this.is_ie5 );
	this.is_ie6		= ( this.is_ie && ( is_major == 4 ) && ( agt.indexOf( "msie 6." ) != -1 ) );
	...
	if ( this.is_nav2 || this.is_ie3 )
		...
		this.is_js = 1.1;
	else if ( ( this.is_nav4 && ( is_minor <= 4.05 ) ) || this.is_ie4 )
		this.is_js = 1.2;
	else if ( ( this.is_nav4 && ( is_minor > 4.05 ) ) || this.is_ie5 )
		this.is_js = 1.3;
	...
	if ( this.is_mac && this.is_ie5up )
		this.is_js = 1.4;
	this.is_mac68k = ( this.is_mac && ( ( agt.indexOf( "68k" ) != -1 ) || ( agt.indexOf( "68000" ) != -1 ) ) );
	this.is_macppc = ( this.is_mac && ( ( agt.indexOf( "ppc" ) != -1 ) || ( agt.indexOf( "powerpc" ) != -1 ) ) );
