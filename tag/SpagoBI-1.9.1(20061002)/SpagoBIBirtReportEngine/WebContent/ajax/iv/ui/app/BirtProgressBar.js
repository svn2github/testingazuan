...
BirtProgressBar.prototype = Object.extend( new BirtAppUIComponentBase( ),
{
	__interval : 300,
	...
	__cb_bind : function( )
	{
		...
		{
			timer = window.setTimeout( this.__cb_bind_closure, this.__interval );
			birtProgressBar.__l_show( );
		}
		else
	  	{
			window.clearTimeout( timer );
			birtProgressBar.__l_hide( );
	  	}
	},
	...
	{
		timer = window.setTimeout( this.__cb_bind_closure, this.__interval );
		// TODO: remove it, this window won't shown up until after 1000ms
		//birtProgressBar.__l_show( );
	},
