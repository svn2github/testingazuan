/*
 * $Id: CompilerConfig.java 1708 2007-01-13 18:31:26Z jponge $
    ...
    * @throws CompilerException
    ...
    protected void addPacks(XMLElement data) throws CompilerException
    {
        ...
        while (packIter.hasNext())
        {
            ...
            //****************************START MODIFICATIONS BY DAVIDE ZERBETTO
            String remoteFile = el.getAttribute("remoteFile");
            String bytes = el.getAttribute("bytes");
            //****************************END MODIFICATIONS BY DAVIDE ZERBETTO
            ...
            PackInfo pack = new PackInfo(name, id, description, required, loose, excludeGroup, remoteFile, bytes);
            //****************************END MODIFICATIONS BY DAVIDE ZERBETTO
