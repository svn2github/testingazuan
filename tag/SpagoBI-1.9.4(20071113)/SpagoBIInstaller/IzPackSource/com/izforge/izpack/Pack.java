...
public class Pack implements Serializable
{
    ...
    /**
     * If this attribute is specified, the file is downloaded from remote site to the local repository
     */
    public String remoteFile = new String();
    
    /**
     * If this attribute is specified, it indicates the dimension of the file that is downloaded from remote 
     * site to the local repository
     */
    public String bytes = new String();
    ...
    */
    public Pack(String name, String id, String description, List osConstraints, List dependencies,
            boolean required, boolean preselected, boolean loose, String excludegroup,
            String remoteFile, String bytes)
    {
        this.name = name;
        this.id = id;
        this.description = description;
