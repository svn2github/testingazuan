...
CREATE SEQUENCE SBI_EVENTS_SEQ INCREMENT 1 START 1 ;
...
CREATE TABLE SBI_PARUSE (
       ...
       SELECTION_TYPE  VARCHAR(20) NOT NULL DEFAULT 'LIST',
       MULTIVALUE_FLAG  INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE SBI_EVENTS (
       ID                   INTEGER DEFAULT nextval('SBI_EVENTS_SEQ') NOT NULL,
