...
CREATE INDEX XIF3SBI_VIEWPOINTS ON SBI_VIEWPOINTS
(
       VP_NAME                 ASC
);
...
ALTER TABLE SBI_VIEWPOINTS ADD CONSTRAINT FK_viewpoints_1 FOREIGN KEY FK_viewpoints_1 (BIOBJ_ID) REFERENCES SBI_OBJECTS (BIOBJ_ID);
