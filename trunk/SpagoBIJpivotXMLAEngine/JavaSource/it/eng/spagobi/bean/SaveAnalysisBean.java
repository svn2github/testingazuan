...
public class SaveAnalysisBean {
	...
	public void saveSubObject(RequestContext reqContext){
		...
		String query = null;
		//System.out.println("Memento class: " + olapModel.getBookmarkState(0).getClass().getName());
		/*
		...
		*/
		...
		if (query != null) {
			...
			analysis = AnalysisAdapterUtil.createAnalysisBean(analysis.getCatalogName(), analysis.getCatalogUri(),
