 ...
 * 
 */
package it.eng.spagobi.bean.adapter;
...
public class AnalysisAdapterUtil {
     ...
     * @return
     */
    public static AnalysisBean createAnalysisBean(String catalogName,String catalogUri, ChartComponent chart,
                                          TableComponent table, OlapModel olapModel) {
        AnalysisBean analysis = new AnalysisBean();
        analysis.setCatalogName(catalogName);
