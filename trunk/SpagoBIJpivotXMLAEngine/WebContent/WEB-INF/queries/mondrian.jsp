...
<jp:mondrianQuery id="query01" jdbcDriver="com.mysql.jdbc.Driver" jdbcUrl="jdbc:mysql://localhost/foodmart?autoReconnect=true" jdbcUser="root" jdbcPassword="admin" catalogUri="/WEB-INF/queries/FoodMart.xml">
select
