<%@ page session="true" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1"
	import="com.tonbeller.jpivot.olap.model.OlapModel,
    		...
    		it.eng.spagobi.bean.adapter.AnalysisAdapterUtil,
   			...
   			it.eng.spagobi.engines.jpivotxmla.security.SecurityUtilities,
   			java.util.Map,
...
<%! 
	...
	public void jspInit() {
		...
		else if(!secAblePar.equalsIgnoreCase("true")) {
        	securityAble = false;
        }
        if(securityAble) {
...
<wcf:include id="include01" httpParam="query" prefix="/WEB-INF/spagobi/jsp/" suffix=".jsp"/>
<c:if test="${query01 == null}">
  <jsp:forward page="/busy.jsp"/>
</c:if>
