 ...
 * 
 */
package it.eng.spagobi.engines.jpivot;

import it.eng.spagobi.engines.jpivot.security.SecurityUtilities;
import it.eng.spagobi.util.SessionObjectRemoval;
...
public class JPivotServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if(!authorized) {
			String unauthorized = "";
			try {
				unauthorized = EngineMessageBundle.getMessage("Unauthorized", locale);
			} catch (Exception e) {
				e.printStackTrace();
