...
public class PamphletsManagementPublisher implements PublisherDispatcherIFace {
	...
	public String getPublisherName(RequestContainer requestContainer, ResponseContainer responseContainer) {
		...
		SourceBean moduleResponse = (SourceBean)serviceResp.getAttribute(PamphletsConstants.PAMPHLET_MANAGEMENT_MODULE);
		...
		if(errorHandler.isOKBySeverity(EMFErrorSeverity.ERROR)) {
			...
			if((pubName!=null) && !(pubName.trim().equals("")))
				return pubName;
			else return new String("PamphletsManagementPub");
		} else {
