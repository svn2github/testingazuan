	...
	<input type='hidden' value='true' name='modifyMap' />
	...
	<!-- GESTIONE TAB FEATURES -->
	 ...
	 <%
	  ...
	  <%	} //for
	  if (selectedFeatureId.equals ("-1") ) 
			linkClass = "tab selected";
		else 
			linkClass = "tab";
	  %>
						<div class='<%= linkClass%>'>
							<a href='javascript:changeFeature("-1")'
							   style="color:black;"> 
	    ...
	    <div class='div_detail_form'>    
	    	...
	    	&nbsp;
	    	 <% 
			if(subMessageDet.equalsIgnoreCase("NEW_MAP_FEATURE")){		
			%>
	...
	function checkMessage() {
	  ...
	  if (msg == "") return;	
		...
		if (!confirm (msg)){	 	
			document.mapForm.msgDelFeatures.value='NO_SAVE';			
		}
		document.mapForm.modifyMap.value='false';
		document.mapForm.modifyFeature.value='false';
	...
	function changeFeature(featureId) {
		...
		document.mapForm.msgDelFeatures.value = 'GET_TAB_DETAIL';
    	document.mapForm.modifyMap.value='false';
		document.mapForm.submit();
	}
