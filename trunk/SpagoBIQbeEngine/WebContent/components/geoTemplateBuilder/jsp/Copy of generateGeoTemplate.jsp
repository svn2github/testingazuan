...
<div id='queryDiv' style="width:90%;padding:10px 10px 10px 10px;margin:10px 0px 0px 0px;border:solid; border-width:0px">
...
<div id='fieldsDiv' style="width:98%;margin:10px 0px 0px 0px;border:solid; border-width:0px"></div>

<div id='hierarchyDiv' style="width:98%;margin:10px 0px 0px 0px;border:solid; border-width:0px"></div>

<div id='selectedHierarchyDiv' style="width:98%;margin:10px 0px 0px 0px;border:solid; border-width:0px"></div>

<div id='mapDiv' style="width:98%;margin:10px 0px 0px 0px;border:solid; border-width:0px"></div>

<div id='layerDiv' style="width:98%;margin:10px 0px 0px 0px;border:solid; border-width:0px"></div>
